...
simple_triggers = [
  ...
  (1.4,
    [
      ...
      (try_begin),
        (le, ":level", 0), #turning off and making always as if player were level 30 for objective world
      (else_try),
        (val_mul, ":base", 30),
        (val_div, ":base", 12),
      (try_end),
  ...
  #    (try_begin), # TWEAK FOR GARRISON  #This is active and overwriting operation of normal code in all games, disabling it
   #     (is_between, ":center_no", castles_begin, castles_end),
  ...
  (0.14,
    [
      ...
      (try_begin),
        ...
        (assign, ":num_hiring_rounds", 1),
   #     (store_random_in_range, ":random_value", 0, 1),
  ...
  (1.2, [
      ...
      (try_begin), #Disaster
        ...
        (try_begin),
          ...
          (display_log_message, "@You hear word that a livestock epidemic has killed as much as {reg4} cattle in {s4}."),
        (else_try),
          (eq, reg4, 0),
          (gt, reg5, 0),
          (party_slot_eq, ":village_no", slot_town_lord, "trp_player"),
          (str_store_party_name_link, s4, ":village_no"),
          (display_log_message, "@You hear word that a livestock epidemic has killed as much as {reg5} sheep in {s4}."),
        (else_try),
          (gt, reg4, 0),
          (gt, reg5, 0),
          (party_slot_eq, ":village_no", slot_town_lord, "trp_player"),
          (str_store_party_name_link, s4, ":village_no"),
          (display_log_message, "@You hear word that a livestock epidemic has killed as much as {reg4} cattle and {reg5} sheep in {s4}."),
        (try_end),
  ...
  (1.1, [
      ...
      (else_try),
        ...
        (else_try),
          ...
          (store_random_in_range, ":conv", 0, 600), #lord will convert on average n = log(.5)/log(1.00 - 1/150) = 103 weeks = 2 years
          #		(assign, reg33, ":conv"),
      ...
      (try_begin),
        (le, reg0, -40),
        (call_script, "script_troop_change_relation_with_troop", ":troop_no", ":faction_leader", 10),
      (try_end),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_end),
          (call_script, "script_troop_change_relation_with_troop", ":troop_no", ":faction_leader", -2),  #three months for neutral lord to start considering defection (see below)
        ...
        (else_try),
          ...
          (try_end),
          (call_script, "script_troop_change_relation_with_troop", ":troop_no", ":faction_leader", -1),  #six months for neutral lord to start considering defection (see below)
      ...
      (try_begin),
        ...
        (this_or_next|le, reg0, -70), #was -75
      ...
      (try_for_range, ":active_npc", active_npcs_including_player_begin, active_npcs_end),
        ...
        (else_try),
          ...
          (store_random_in_range, ":random", 90, 900),
          (lt, ":random", ":chance_of_convergence"),
          (call_script, "script_troop_change_relation_with_troop", ":troop_no", ":active_npc", -1),
          (val_add, "$total_relation_changes_through_convergence", -1),
        (else_try),
  ...
  (6,
   ...
   #   (is_currently_night), # closing off an exploit of dropping into camps at nightfall, or at least making it more difficult to use
      (try_begin),
   #     (neq, "$fortified_camp", 1), # turning off, people who want to escape will just wait for when they aren't fortified after all
        ...
        (display_log_message, "@{reg1} {s1} {reg2?have:has} escaped from your party.", color_bad_news), #moto chief
      (try_end),
      ...
      (try_for_range, ":center_no", towns_begin, towns_end),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (display_message, "@{s1} has distinguished himself during the tournament at {s2}.", color_hero_news), #moto chief
            (call_script, "script_change_troop_renown", ":winner_troop", 10),
          (try_end),
        (try_end),
  ...
  # Spawn some bandits.
  (140,  #making respawns slower to account for new mechanics.
    [
  ...
  (24*14/5, [	#laired_spawn_points_end - laired_spawn_points_begin = 20
  ...
  (1, [(neg|map_free),
      ...
      (eq, ":book_read", 0),
      (val_add, ":book_reading_progress", 2),
  ...
  (1.12,
   ...
   #     (party_slot_eq, ":cur_village", slot_town_lord, "trp_player"),
        ...
        (lt, ":cur_relation", 20), # balancing with new relations decay formula, now raises to 20, then counters decay
      ...
      (try_begin),
		...
		(neg|party_slot_eq, ":center", slot_center_has_manor, 1),
        (neg|party_slot_eq, ":center", slot_center_has_prisoner_tower, 1),
  ...
  (0.62,
    [
	  ...
	  (try_begin),
        ...
        (gt, ":boost", 0),
        (str_store_party_name_link, s1, ":center_no"),
        (display_message, "@Better education in {s1} adds to its prosperity."),
      (try_end),
	  (try_begin),
	  ...
	  (try_begin),
        ...
        (gt, ":boost", 0),
        (str_store_party_name_link, s1, ":center_no"),
        (display_message, "@The mead hall in {s1} adds to its prosperity."),
      (try_end),
      ...
      (else_try),
        ...
        (store_random_in_range, ":rand", 0,100),
        (lt, ":rand", 5),
        (store_random_in_range, ":random", -5, 7),
      ...
      (try_end),  
	  (try_begin),
	    (party_get_slot, ":cur_relation2", ":center_no", slot_center_player_relation),
		(gt, ":cur_relation2", 20),
		(neg|party_slot_eq, ":center_no", slot_center_has_school, 1),
	    (store_random_in_range, ":rand2", 0,20),
		(gt, ":rand2", 17),
		(val_add, ":cur_relation2", -1),
		(party_set_slot, ":center_no", slot_center_player_relation, ":cur_relation2"),
	  (try_end),
	  #player center
      (try_begin),
        (party_slot_eq, ":center_no", slot_town_lord, "trp_player"),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (party_get_slot, ":faith", ":center_no", slot_center_faithratio),
            (try_begin),
              (gt, ":faith", 200), #turning off these, people expect to be ruled by own religion
              (store_random_in_range, ":rand", 0,1),
              (val_add, ":cur_relation", ":rand"),
            (else_try),
              (lt, ":faith", 30),
              (store_random_in_range, ":rand", -1,1),
              (val_add, ":cur_relation", ":rand"),
            (try_end),
          (else_try),
            (party_slot_eq, ":center_no", slot_center_religion, 2),#pagan
  ...
  (300, [ #default 8 hours
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (display_message, "@Due to the good words Christian clergymen spread about you, your relationship with the {s1} improves."),
        (else_try),
          ...
          (call_script, "script_change_player_relation_with_faction", ":faction_no", -1), #la q designemos
          (str_store_faction_name, s1, ":faction_no"),
          (display_message, "@Due to the bad words Christian clergymen spread about you, your relationship with the {s1} declines."),
          (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (call_script, "script_change_player_relation_with_faction", ":faction_no", 1), #la q designemos
          (str_store_faction_name, s1, ":faction_no"),
          (display_message, "@Due to the good words influential pagans spread about you, your relationship with the {s1} improves."),
        (else_try),
          (lt, ":player_relation", -50),
          (gt, ":faction_relation", -75),
          (store_random_in_range, ":rand", 0, 10),
          ...
          (call_script, "script_change_player_relation_with_faction", ":faction_no", -1), #la q designemos
          (str_store_faction_name, s1, ":faction_no"),
          (display_message, "@Due to the bad words influential pagans spread about you, your relationship with the {s1} declines."),
          (try_begin),
            (store_relation, ":player_relation", ":faction_no", "fac_player_faction"),
            (eq, ":player_relation", -1),
    ...
    [
      ...
      (try_for_range, ":center_no", centers_begin, centers_end),
        (try_begin),
		  ...
		  (faction_slot_eq,  "$players_kingdom", slot_faction_marshal, "trp_player"), #turning off warnings since disabled system
          (assign, ":at_war", 0),
  ...
  (30*24*5/(10*12), #MOTO randomize (see below). Idea faction revolt every month on average in end game
    ...
    [
      ...
      (val_div, ":charisma", 2),
      (store_add, ":playerlead", ":skill", ":charisma"),
      ...
      (try_begin),
        ...
        (try_for_range, ":cur_troop", active_npcs_begin, ":end_lord"),  #NPCs, kings, lords
          ...
          (else_try),
            ...
            (try_begin),
              (gt, ":relation_with_currentking", 9),
              (set_show_messages, 0), #use other message after lord loop
              
              (try_begin),
                (eq, ":current_leader", "trp_player"),
                (store_random_in_range, ":rand33", 10, 22), #player starting charisma 9
                (lt, ":playerlead", ":rand33"),
                (call_script, "script_troop_change_relation_with_troop", ":current_leader", ":cur_troop", -5),
              (else_try),
                (neq, ":current_leader", "trp_player"),
                (store_random_in_range, ":rand55", 10, 22), #player starting charisma 9
                (lt, 17, ":rand55"),
                (call_script, "script_troop_change_relation_with_troop", ":current_leader", ":cur_troop", -5),
              (try_end),
  ...
  (ti_on_switch_to_map, [
      ...
      (try_begin),
        ...
        (try_for_range, ":center_no", centers_begin, centers_end),
          ...
          (try_begin),
            ...
            (party_set_slot,":center_no",slot_center_religion, 2),
            (store_random_in_range, ":rand", 1, 2),	# ratio is christian/pagan
          ...
          (else_try),
            ...
            (store_random_in_range, ":rand", 95, 97), #valores de fe
            (party_set_slot, ":center_no", slot_center_faithratio, ":rand"),
          (try_end),
        (try_end),
      (try_end),
      ...
      (try_begin),
        ...
        (try_for_range, ":cur_troop", companions_begin,companions_end),
          (try_begin),
		    (this_or_next|eq, ":cur_troop", "trp_npc1"),
