...
##  ("none", "none"),
  ("noone", "no one"),
#nota Chief
#buscar Calradia (sustituir por Britannia, or Britannia and Hibernia), God (sustituir por Woden, Gods o lo que corresponda), denars (peningas), denar (pening)
##  ("nothing", "nothing"),
  ("s0", "{!}{s0}"),
  ("blank_s1", "{!} {s1}"),
  ("reg1", "{!}{reg1}"),
  ...
  ("tutorial_map1","Welcome to VC Balance Mod 13.0!^^Save-compatible patches (including 13.1 when ready) are posted to the Discord Server, as are optional add-ons (including the Happy Companions add-on and the Dark Age compatibility patch). You can google 'Hooded Horse' to find the Discord invite link at our website, or you can also find it at ModDB, Nexus, and Taleworlds."),
#chief
  ("tutorial_map11","You now have a strong party of men. Return to the jarl for further instruction."),
...
##  ("tutorial_item_equipped", "You have equipped a weapon. Move your mouse scroll wheel up to wield your weapon. You can also switch between your weapons using your mouse scroll wheel."),
 ...
 Press the Tab key to return to the menu where you can retry this tutorial."),

###main quest chief
  #tutorial barco
  ("tutorialmq_1_msg_1","In this tutorial, you will learn the basics of movement, interaction, and combat.\
 ^^In Viking Conquest, you use the mouse to control where you are looking, and the W, A, S, and D keys of your keyboard to move.\
 Your first task is...\
 ^^Goal: Go to the center of the boat."),
 # ("tutorialmq_1_msg_11","{!}"),
   ("tutorialmq_1_msg_2","Well done. Next, we will learn to interact with objects and persons.\
 Near you, there is a man called Bodo. To find out who a person is, walk toward him or her until the name pops up. In order to talk to Bodo once you find him, press the F key.\
 ^^Use the F key to interact with persons and scene props. It will open doors and chests, pick up items and more.\
 ^^Goal: Talk to Bodo."),
  ("tutorialmq_1_msg_3","Excellent. Next, we will cover attacking with weapons.\
 ^^You can draw different weapons from your weapon slots by scrolling forward with the wheel of your mouse or by pressing one of the first four numbers on your number pad.\
 ...
 ^^Scroll down or use the number pad to bring out your shield or put it away.\
 ^^Goal: Talk to Veteran to practice some combat."),
  ("tutorialmq_1_msg_4","Nice work! You know all the basic concepts to play Viking Conquest. Now you can explore, talk to NPCs, fight in sailors, or finally, when you are ready, talk to captain to continue your adventure."),
#chief mainquest acaba
 ...
 Move on to the next room when you're ready to face an archer."),
  ...
  ("tutorial_2_msg_5","{!}Excellent, you've put up a successful defence against the archer.\
...
#chief cambiados nombres UNUSED
 ...
 Shouting out his war cry, he spurs his horse forward, and leads his loyal men to a fierce battle."),
...
##  ("can_not_leave", "Can't leave. There are enemies nearby!"),
  ...
  ("s1_joined_battle_enemy", "{s1} would join your enemy in a battle."),
  ("s1_joined_battle_friend", "{s1} would join you in a battle."),
...
#  ("entrance_to_town_forbidden","It seems that the town guards have been warned of your presence and you won't be able to enter the town unchallenged."),
  ...
  ("attack_walls_continue", "A bloody battle ensues and both sides fight with equal valour. Despite the efforts of your troops, the place remains in enemy hands."),
  ...
  ("siege_defender_order_attack_success", "The men of the garrison hold their walls with skill and courage, breaking the enemy assault and skillfully turning a seemingly sure defeat into a full-fledged victory."),
  ...
  ("hero_freed", "{s1} of the {s3} has been freed from captivity by the {s2}."),
  ("center_captured", "The {s2} has taken {s1} from the {s3}."),
  ...
  ("faction_relation_increased", "Your relation with the {s1} has increased from {reg1} to {reg2}. {s2}"),
  ("faction_relation_detoriated", "Your relation with the {s1} has deteriorated from {reg1} to {reg2}. {s2}"),
...
##  ("your_debt_to_s1_is_changed_from_reg1_to_reg2", "Your debt to {s1} is changed from {reg1} to {reg2}."),
  ...
  #Alternatives
  ("town_alt_prosperity_0",   "The few wares sold in the market are expensive to the malnourished common man and his weakened livestock. Among ramshackle houses, children in rags are playing with sticks and pebbles."),
  ("town_alt_prosperity_20",   "Arguments over high prices are heard in the marketplace, where traders are running out of wares. In the streets, children are begging any passer-by for a little bread or anything of worth."),
  ("town_alt_prosperity_40",   "Wares in the market are of decent quality, and traders sometime bring luxury items for the few wealthy townspeople. Some houses could use repair, while others are in good shape."),
  ("town_alt_prosperity_60",   "The market is humming with activity as traders from far and wide come to do business and leave, while some migrants stay to seek their luck."),
  ("town_alt_prosperity_80",   "The thatch and shingles of roofs are well maintained throughout the town, and the people are dressed in quality clothing. Every day flocks of people arrive to find work and wealth in the blooming trading hub."),
  
  ("village_alt_prosperity_0",   "Able-bodied people are scarce, and fields are overgrown with weeds. Many have fled the settlement, and draft animals are eaten or dying at the outskirts of town, attracting wild animals."),
  ("village_alt_prosperity_20",   "A few farmers and animals work in the fields, but many have emigrated in search of a better life. Farms are worn down, and weeds have taken over some of the fields."),
  ("village_alt_prosperity_40",   "Fairly healthy villagers and animals move about the fields and pastures. However, some houses are in ill repair, and several fields are left unsown."),
  ...
  ("village_alt_prosperity_80",   "Fields and orchards are filled with able-bodied, well-fed villagers expanding the fields to feed the many farm animals. All the while, laborers are flocking to work and join the prosperity."),
#chief cambia texto
  ("oasis_village_alt_prosperity_0",   "Fruit groves lie virtually abandoned, and the few malnourished villagers that still remain seem worried. The draft animals have long since starved or been eaten."),
  ("oasis_village_alt_prosperity_20",   "Few villagers can be seen tending to the fruit groves, and in some places, the forest is engulfing them. Shrubs and weeds invade all the orchards. The cattle have turned wild, and a few of their carcasses lie on the outskirts, their bones gnawed by wolves."),
  ("oasis_village_alt_prosperity_40",   "Men and women work in the orchards and cut back the heather that invades the pasture areas. The herds look healthy, but many of the farms could use some maintenance."),
  ("oasis_village_alt_prosperity_60",   "In the groves and orchards roam the busy farmers, who happily greet each other while trimming trees, shearing sheep and milking the cows. The echo of the carpenter’s building new livestock fences evokes the prosperity of the site."),
  ("oasis_village_alt_prosperity_80",   "The fruit groves are humming with activity, as farmers load up baskets of apples and sacks of wheat for sale to the market. Men and women are hard at work clearing the forest and plowing new fields to create new farmland."),
#chief cambia texto acaba  
  
  
  ("acres_grain",       "acres of grain fields"),
  ("acres_orchard",     "acres of fruit groves"),
  ("acres_oasis",       "acres of orchards"),
  ...
  ("master_miller",  "Foreman miller"),
  ("master_brewer",  "Foreman brewer"),
  ("master_presser", "Foreman presser"),
  ("master_smith",   "Foreman smith"),
  ("master_tanner",  "Foreman tanner"),
  ("master_weaver",  "Foreman weaver"),
  ("master_dyer",    "Foreman dyer"),
 ...
 but none of your arguments seems to come out right. Every time you start to make sense,\
...
# meet_spy_in_enemy_town quest secret sentences
  ...
  ("secret_sign_2",  "I am selling these fine tapestries from Constantinople. Would you like to buy some?"),
...
# Retirement Texts: s7=village name; s8=castle name; s9=town name
 ...
 It doesn't take you long to fritter away what little you bothered to save.\
 Once every pening has evaporated in your hands you are forced to start a life of crime in the back streets of {s9},\
 ...
 There you become a free farmer, and you soon begin to attract potential {reg59?husbands:wives}.\
 ...
 so that the children may keep a memory of you forever and ever."),
 ...
 they soon accept you into their midst. In time, your growing tavern becomes a popular feast hall and meeting place.\
 ...
 and you soon become a wealthy {reg59?woman:man} known as much for your trading empire as your exploits in battle."),
 ...
 and a ripple of shock passes through the realm when he names you to the hereditary title of {reg59?ducessa:dux} of {s9}.\
 Vast fiefs and fortunes are now yours to rule. You quickly become your liege's most trusted advisor,\
 almost his equal. You are charged with much of the running of his realm,\
...
# humanitarian
  ("loot_village", "attack innocent people"),
  ("steal_from_villagers", "steal from poor people"),
...
# honest
  ("fail_quest", "fail a quest that we undertook on word of honour"),

#Non used Free for addons
  ("treason_one", "honour"),
  ("missed_npc", "fail."),
#Non used end
...
# strings for opinion
  ...
  ("not_happy", "not at all happy with"),
...
#NPC strings
#the number of strings in each section must match the number of NPCs AND be in order!
#npc1 = Caio, roman-angle, male
#npc2 = Egil, danish, male
#npc3 = Brunhild- frisian, female 
#npc4 = Donnchadh, scot, male
#npc5 = Morgant, male, briton
#npc6 = Bodo, cantabrian, male
#npc7 = Dwywei, pict, woman
#npc8 = Reginhard - frisian, male
#npc9 = Clovis, warrior, frank, male
#npc10 = Ceawlin, saxon, hate welsh, male 
#npc11 = Solveig, female, Norwegian
#npc12 = Asbjorn, danish, male
#npc13 = Helgi, swedish, male
#npc14 = Ailchu, warrior, male, irish
#npc15 = aghatinos, greek, male
#npc16 = #Beda, male, saxon

#chief dialogo companeros   
  ("npc1_intro", "Salve, Warlord. My name is Caio. My father sent me."), #Caio
  ("npc2_intro", "Heill! My name is Egil."), #Egil
  ("npc3_intro", "{reg59?Who sent you? I'll never go back!:Do not come close to me. I am tired of being abused by every person that crosses my path!}"), #Brunhild
  ("npc4_intro", "Yes?"), #Donnchadh
  ("npc5_intro", "Hello, traveler. Would you join me for a drink?"), #Morgant
  ("npc6_intro", "I have things to tell you. Listen carefully."), #Bodo
  ("npc7_intro", "Yes? Keep your distance, by the way."), #Dwywei
  ("npc8_intro", "What do you want?"), #Reginhard , frisio
  ("npc9_intro", "You there, good {reg59?woman:man}. Be so kind as to fetch me another drink, eh?"), #Clovis
  ("npc10_intro", "God thee mid sie, {reg59?madame:sir}! Here's to the doom and downfall of all Welsh!"), #Ceawlin
  ("npc11_intro", "Heill, {reg59?my pretty:handsome}. I've been watching you a while."), #Solveig
  ("npc12_intro", "Heill, {reg59?madame:sir}. Nice to meet you."), #Asbjorn
  ("npc13_intro", "Yes? What do you need?"), #Swedish, Helgi
  ("npc14_intro", "Hail, traveller. I am Ailchu, a Gael warrior. No doubt you've heard of me."), #Ailchu
  ("npc15_intro", "Yeia sou! Yeia sou! To your health, {reg59?madame:sir}. My name is Agathinos. Are you by any chance heading out of this place any time soon?"), #Agathinos
  ("npc16_intro", "Ah... you... I..."), #Beda

#                           "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"
  ("npc1_intro_response_1", "Yes, I know. Tell me about yourself."), #Caio
  ("npc2_intro_response_1", "Speak, Egil."), #Egil
  ("npc3_intro_response_1", "Calm down. I intend you no harm. Why are you so afraid?"), #Brunhild
  ("npc4_intro_response_1", "You're not very talkative, are you?"), #Donnchadh
  ("npc5_intro_response_1", "Certainly. With whom do I have the pleasure of drinking?"), #Morgant
  ("npc6_intro_response_1", "Continue, friend."), #Bodo
  ("npc7_intro_response_1", "My apologies. I was merely going to say that you look a bit down on your luck."), #Dwywei
  ("npc8_intro_response_1", "Merely to pass the time of day, foreigner, if you're not otherwise engaged."), ##Reginhard , frisio
  ("npc9_intro_response_1", "You must have me confused with another person, sir."), #Clovis
  ("npc10_intro_response_1", "Why do you say that, man?"), #Ceawlin
  ("npc11_intro_response_1", "Who are you, and why are you watching me?"), #Solveig
  ("npc12_intro_response_1", "So nice to meet you."), #Asbjorn
  ("npc13_intro_response_1", "To pass the time of day with a fellow traveler, if you permit."),  #Swedish, Helgi
  ("npc14_intro_response_1", "Um... I don't think so."), #Ailchu
  ("npc15_intro_response_1", "I am. What concern is it of yours, may I ask?"),#Agasicles
  ("npc16_intro_response_1", "Are you tongue-tied?"), #Beda

  ("npc1_intro_response_2", "Yes, I know that he wants you to join me, but I do not need you. Farewell."), #Caio
  ("npc2_intro_response_2", "I have better things to do."), #Egil
  ("npc3_intro_response_2", "Run along now, girl. I have real work to do -- not whatever it is you fear I'll do."), #Brunhild
  ("npc4_intro_response_2", "No."), ##Donnchadh
  ("npc5_intro_response_2", "I have no time for that."), #Morgant
  ("npc6_intro_response_2", "I have better things to do."), #Bodo
  ("npc7_intro_response_2", "Right. I'll not bother you, then."), #Dwywei
  ("npc8_intro_response_2", "Nothing at all, from one so clearly disinclined to pleasantries. Good day to you."), ##Reginhard , frisio
  ("npc9_intro_response_2", "Fetch it yourself!"), #Clovis
  ("npc10_intro_response_2", "That's arrogant talk, and I'll hear none of it. Good day to you."), #Ceawlin
  ("npc11_intro_response_2", "Oh, I have no time for this!"), #Solveig
  ("npc12_intro_response_2", "Sorry, I am afraid that I am otherwise engaged right now."), #Asbjorn
  ("npc13_intro_response_2", "Nothing at all. My apologies."), # #Swedish, Helgi
  ("npc14_intro_response_2", "No, and I can't say that I much want to make your acquaintance."), #Ailchu
  ("npc15_intro_response_2", "I'd be obliged if you minded your own business, sir."), #Agathinos
  ("npc16_intro_response_2", "I'm going. When you learn to talk, let me know."), #Beda

#backstory intro
  ("npc1_backstory_a", "Warlord, I am the youngest son of the man known as the old Roman. As you know, my family is a legend in this area. We preserve the history of our ancestors, who patrolled Hadrian's Wall."), #Caio
  ("npc2_backstory_a", "I crave a little of your time, {reg59?madame:sir}. Listen to my story. I am important to you."), #Egil
  ("npc3_backstory_a", "I... I am sorry, but please understand. My life has been a living hell since I became a maid in the house of the jarl of Kennemer."), #Brunhild
  ("npc4_backstory_a", "I am a man of action. If you want a man of words, find a priest."), #Donnchadh
  ("npc5_backstory_a", "I am Morgant from Bosvenegh. However, I am exiled from my homeland for now..."), #Morgant
  ("npc6_backstory_a", "{reg59?Madam:Sir}, I should be dead, but I still live while others who should be alive are dead. \
I came to consider the ship that brought me north, the Woden Ric, as a home, with its crew as my family. So when the Vikings attacked, I grabbed my sword and my shield and prepared to defend them to the death.^^\
The Cantabrians are Christians, but some of us still remember the old gods. One in particular, Erudino, guides us in battle, and I shout his name while attacking with my sword."), #Bodo
  ("npc7_backstory_a", "My luck? You could say that."), #Dwywei
  ("npc8_backstory_a", "Ah. Well, if you must know, I shall tell you. Not many people around here will listen to good old Reginhard."), ###Reginhard , frisio
  ("npc9_backstory_a", "My most humble apologies. It is sometimes hard to recognize folk amid the smoke and gloom here. I still cannot believe that I must make my home in such a place."), #Clovis
  ("npc10_backstory_a", "It's a long story, but if you get yourself a drink, I'll be glad to tell it."), #Ceawlin
  ("npc11_backstory_a", "Calm down, {reg59?my pretty:handsome}. It is wiser to be grateful, but allow me to introduce myself. My name is Solveig Olafsdottir. I'm not just any woman. I'm a skjaldmo."), #Solveig
  ("npc12_backstory_a", "I think it's a good time to introduce myself officially, since it is likely that our paths are attached. I am Asbjorn from Odinsve, and I am a loeknir, a simple doctor who wasted some time in Frankia until I returned to Danmark some months ago."), #Asbjorn
  ("npc13_backstory_a", "Very well. I do not mind. My name is Helgi, killer of Danes and Slavs."),  #Swedish, Helgi
  ("npc14_backstory_a", "You have not? Then perhaps you have heard of my steed, which cuts across the plains like a beam of moonlight? Or of my sword, a connoisseur of the blood of the highest-born princes of Hibernia?"), #Ailchu
  ("npc15_backstory_a", "Well, let me tell you. I'm an engineer who specializes in the art of fortification. If you need a wall knocked down, I am your man. If you need a wall built back up, I am your man too -- but that will take a bit longer and cost you a lot more."), #Agathinos
  ("npc16_backstory_a", "Excuse me, {reg59?madame:sir}... I am a man of God, a priest of Christ. You are {playername}..."), #Beda

#backstory main body
  ("npc1_backstory_b", "I, personally, am a very fine tracker. Actually, I am the best tracker around, as my mission has always been to protect my family when we left the caves. Releasing me to your service, my father has done you a great favor."), #Caio
  ("npc2_backstory_b", "I am a son of King Horik, but not a legitimate one. The king likes pretty women, and, well, he met my mother among the handmaids of his wife. So that's how I got here, I guess. I was happy during my childhood in Ribe, but soon the king sent me to live with one of his huskarls.^^The man was tough and violent. He insisted on teaching me how to handle the spear, sword and shield. He didn't let me drink mead or frequent the company of girls. Can you believe someone would inflict such hardship?"), #Egil
  ("npc3_backstory_b", "I used to live in a small village, Doccinga. I was happy. My father, Thonkrik, cared a lot for me since my mother died. But, one day, the jarl of Kennemer stopped in our village, and he saw me. He, damn him, forced my father to send me to his house as a maid for his wife. He promised that he would respect me, but he lied. I don't like to speak of this... Well, since then I had really become a slave. I had to give myself to him and then to his men."), #Brunhild
  ("npc4_backstory_b", "What you ought to know is that my name is Donnchadh of Dal Riata and that I am a Scot."), #Donnchadh
  ("npc5_backstory_b", "For as long as anyone can remember, our family has feuded with another nearby clan. Many men have died in this fight, on both sides, including two of my brothers. The king of Cornubia ordered us to cease, but I know my rights, and my brothers' blood cries out for vengeance. I waylaid and killed an enemy on a mountain path, and I rode out of our hall the same night, without even having the chance to bid farewell to my father. I was later told that the king exiled me and revoked my noble rights. I am now condemned to roam the world, forever banished from my homeland and my kin."), #Morgant
  ("npc6_backstory_b", "I'm not an idiot. I knew that the battle was lost. We were outnumbered, and they were better armed, but I asked Erudino to let me kill as many as possible before my trip to paradise. I hoped my sacrifice would allow the others to flee or cause fear among the Vikings, \
but these Vikings were hardened men who knew their job well. Half a dozen of them surrounded me and beat me while their companions invaded the Woden Ric and killed whomever stood in their way..."), #Bodo
  ("npc7_backstory_b", "It was my bad luck to be ordered by a stupid Pictish warlord to scout the woods during the night. It was my bad luck that the enemy had laid a carefully planned ambush and considerably outnumbered our small war party. It was my bad luck that I was the only one who managed to escape from the bloodshed. It was my bad luck that the war council deemed me a traitor, and I had to flee from my tribe during the night. It is my bad luck to have you to tell all this to right now."), #Dwywei
  ("npc8_backstory_b", "I was born in Dorestad. My life has not exactly been easy, but I was happy until my wife and two children died of a plague two years ago. \
I had a farm, you know, and I sold it because everything in it reminded me of them. Now I'm a drunk and an idiot and no one wants to be with me... well, until you came along."), #Reginhard , frisio
  ("npc9_backstory_b", "I am a Frank, my father's first son, his heir and the bravest warrior in his hall, but when my mother died, my father remarried. His new wife thought that her son should inherit. She could not move against me openly, but the other day I fed a pot of suet that had been left out for me to one of my hounds, and it keeled over. I accused my stepmother, but my father, befuddled by her witchcraft, refused to believe me and ordered me to leave his sight."), #Clovis
  ("npc10_backstory_b", "I am a Saxon warrior. I have fought my whole life against the Welsh, and Angles too. The fate of West Seaxe is to govern Englaland. It is the arrogance and hatred of our neighbors that prevents this land from being unified under a single king. The way I see it, only a Saxon ruler or at least a man that does not accept the arrogance of those peoples can truly bring peace to this land."), #Ceawlin
  ("npc11_backstory_b", "By your face, I see you do not know what I'm talking about. Well, I must admit that there are not many like me, and here even less than in my own land, Northvegr. So you can understand, a skjaldmo is a virgin who takes the way of weapons. Also poetry, since poetry and war come from the same impulse."), #Solveig
  ("npc12_backstory_b", "On my way back to Odinsve, I landed in Ribe and ended up staying here for a few months, serving the local elites -- and not so elites. I guess my services earned me enough prestige to be summoned as althing in the Assembly held a few days ago."), #Asbjorn
  ("npc13_backstory_b", "I am the second son of a hersir from the land east of Northvegr. I am a Svia Viking. I traveled west to seek my fortune in Englaland, unlike many of my compatriots who seek their fortunes in the East with the Rus. I am good at leading assaults and training men in the art of war. Unfortunately, the jarl here has no taste for the disciplinary methods needed to turn that rabble of his into soldiers. I told him it was wiser to flog them now than bury them later, but he would not listen. Instead, he told me to take my services elsewhere."), #Helgi
  ("npc14_backstory_b", "I have always been a warrior, not a farmer or anything else; only a warrior. I admit a modest affection for these lands, and for the past several years, I have visited their towns, forts, and villages, making the most of my particular talents."), #Ailchu
  ("npc15_backstory_b", "I am also an unfortunate man. I am originally from Konstantinoupolis, far away from here... Maybe you have heard of it. The Varangians call it Mikligard. \
A few years ago, a group of them kidnapped me and brought me here, to the far north. They made me a slave and sold me to the jarl of Hordaland. I worked for him until a few days ago, when I finally earned enough money to buy my freedom."), #aghatinos
  ("npc16_backstory_b", "Sorry... I am an idiot. Let me introduce myself. I am Beda. I joined the Holy Church when I was but a boy and eventually became a priest. I believe that even the toughest warrior has a place for Christ in his heart and that I can better fulfill the mission God gave to me in a shield wall than in a sacristy."), #Beda

#backstory recruit pitch
  ("npc1_backstory_c", "For my part, I can only say that I was willing to travel and see the world. You have given me this opportunity. I am glad that, when my father asked my brothers and me who would pay his debt, I volunteered."), #Caio
  ("npc2_backstory_c", "Now I serve in the royal guard. I'm not particularly happy, since I'm in the shadow of hardened men who won the job by their efforts, while I was granted my position only by the virtue of being a bastard son of the king."), #Egil
  ("npc3_backstory_c", "I so desperately wanted to escape. If only I could start a new, free life...^^I know! You could take me with you! I could help mend the wounds of your warriors. I could even learn to be a warrior myself, if that's what it takes to be free again. Will you take me with you, {reg59?madame:sir}?"), #Brunhild
  ("npc4_backstory_c", "Another important thing is that I do not like Picts. Yes, I know my people are ruled by the kings of Alban, but that does not mean they have become one people. We are Gaels, and not those rats."), #Donnchadh
  ("npc5_backstory_c", "So, as a man robbed of his heritage, any opportunities to earn a living with my sword would be most welcome."), #Morgant
  ("npc6_backstory_c", "I saw everyone down: the captain, the sailors, the archers that protected the boat... and I thought I myself was dead until I woke up in the Viking ship, tied hand and foot. I was a prisoner, but thank God, I escaped.^^\
Now, I am a miserable man before Erudino. I should be dead and the others alive. Now, I just live for redemption."), #Bodo
  ("npc7_backstory_c", "But I do not count myself unlucky, stranger, no more than any other woman in this world. This fetid backwater is populated by apes and jackals that do not see that it is worth it to live another day just to kill the hated enemy, and that the way of the tracker and the hunter is better than the way of the ignorant warrior. "), #Dwywei
  ("npc8_backstory_c", "'Reginhard the Fool,' some call me here. Shit, I shouldn't even be here."), ###Reginhard , frisio
  ("npc9_backstory_c", "I hope to offer my sword to some worthy warlord, as it is the only honorable profession for a man of my birth apart from owning land, but in the meantime, I am condemned to make my bed among thieves, vagabonds, merchants, and the other riff-raff of the road."), #Clovis
  ("npc10_backstory_c", "Now, if I ever find such a man, I would happily serve in his shield wall."), #Ceawlin
  ("npc11_backstory_c", "The main thing is that I have followed and studied you the past few days. I will join you now. You have a great future ahead, if my intuition serves me well, and I want to share your luck."), #Solveig
  ("npc12_backstory_c", "The truth is, I was not interested in coming back to Odinsve so soon, for I am still young and have the opportunity to travel to other places and learn more. The Norns must have noticed and tied together our fates. You need someone who can dress the wounds of your warriors, and I need someone with your fortune, that shines above the rest of the men I've known."), #Asbjorn
  ("npc13_backstory_c", "So, if you know of any warlord whose goal is to win battles rather than pamper his soldiers, please direct me to him."), #Helgi
  ("npc14_backstory_c", "Which reminds me -- somewhere out there in the town, an enemy lurks in shadow trying to imprison my free destiny. Namely, an angry, foul, unhappy husband. Not to mention the father, as well. I think there is also a mother, and an uncle. I don't suppose you might consider helping me leave town, would you?"), #Ailchu
  ("npc15_backstory_c", "But after all the years that have passed since I was taken from Konstantinoupolis, I planned simply to stay in the home of the jarl. The truth is that I had formed a relationship with his son. The jarl did not like that and kicked me out.^^So what say you? I see you lead warriors. If you let me join you, I can help when you have a siege."), #aghatinos
  ("npc16_backstory_c", "I am of Angle origin, from Mierce, but I lived most of my life in Witan Ceaster, the center of West Seaxe. I served for some years in the court of King Aethelbehrt. Honestly, he retained no great men of letters, unlike his brother, Aelfred. I ended up in Dommoc in East Engle, near where I was born, but then the Danish came, and the kingdom ceased to be safe for men of faith. I am an honest and helpful man who always gets along with everyone. What do you think? "), #Beda


### use these if there is a short period of time between the last meeting 
  ("npc1_backstory_later", "What do you think? A good tracker is always important, right?"), #Caio
  ("npc2_backstory_later", "Have I ever told you that I cannot stand men being served sour milk when there's mead hidden in the pantry?"), #Egil
  ("npc3_backstory_later", "Kennemer life was terrible for me. Is that why you are here, {reg59?madame:sir}? To abuse me like every other person that has crossed my life after I became a slave?"), #Brunhild
  ("npc4_backstory_later", "Things got a little clearer. Now if you are interested in recruiting me, I'm interested in anything that would take me away from this dunghill and let me earn a living."), #Donnchadh
  ("npc5_backstory_later", "I've been wandering through this war-torn land, looking for a leader who is worth following. Worthier than the king I am now ashamed of once obeying."), #Morgant
  ("npc6_backstory_later", "I have been wandering, but have yet to find redemption. Maybe in war, which I love above all else, I can forget my sin..."), #Bodo
  ("npc7_backstory_later", "I have been wandering, looking for work as a tracker, but it has not been easy. Britons and Saxons are mostly ill bred, lice-ridden, and ignorant, and it is not easy to work with such people. Not that we Picts are much better... Anyway, I am by far an exception, as you must have already perceived."), #Dwywei
  ("npc8_backstory_later", "I am still seeking a war leader in whose shield wall I would fight. I need to feel myself between brothers, with the deaths behind me, to forget the family I lost a couple of years ago."), ###Reginhard , frisio
  ("npc9_backstory_later", "I've offered my sword to a few lords in these parts, but I find, more often than not, that they ask me to run messages, or train peasants, or some other job not fit for a gentleman."), #Clovis
  ("npc10_backstory_later", "I have travelled through Englaland, but I've had no luck yet in finding a man worthy of being my king. At least I got to kill some Britons the other day..."), #Ceawlin
  ("npc11_backstory_later", "What do you think? Do you have any idea how lucky you are that I want to join your cause?"), #Solveig
  ("npc12_backstory_later", "People are in dire need of medical services, but I know my fate is not here."), #Asbjorn
  ("npc13_backstory_later", "I have gone from court to court, but I have not yet found a lord who is to my liking."), #Helgi
  ("npc14_backstory_later", "I have been wandering through the towns, leaving a string of lovesick women and cuckolded husbands in my wake. But I grow weary of such simple challenges. I have been thinking of turning to pastimes that are more martial."), #Ailchu
  ("npc15_backstory_later", "The years in Northvegr were not easy. I used to construct pretty stone buildings in Konstantinoupolis, but in Northvegr, everything was made from wood. Eventually, I discovered that wood can also be beautiful. The Varangians have their own style for their dwellings that bears an intimate relationship to their boats."), #aghatinos
  ("npc16_backstory_later", "My mission still goes on. Every day, I bring more sheep to the flock of Christ."), #Beda
  

  ("npc1_backstory_response_1", "I appreciate him giving me a skilled tracker."), #Caio
  ("npc2_backstory_response_1", "Well, perhaps I could offer you work. Can you fight?"), #Egil
  ("npc3_backstory_response_1", "Well, I take pity on you, and your healing abilities could be useful."), #brunhild
  ("npc4_backstory_response_1", "No Picts in my shield wall, and I might be able to hire an extra hand."), #Donnchadh
  ("npc5_backstory_response_1", "That's the spirit! I might be able to offer you something."), #Morgant
  ("npc6_backstory_response_1", "You must join us. Our way should remain united."), #Bodo
  ("npc7_backstory_response_1", "Hmm... Are you by any chance looking for work?"), #Dwywei
  ("npc8_backstory_response_1", "I can offer you opportunities and a future."), ####Reginhard , frisio
  ("npc9_backstory_response_1", "Perhaps you would like to join my shield wall for a while."),#Clovis
  ("npc10_backstory_response_1", "If you're looking for work, I can use experienced fighters."), #Ceawlin
  ("npc11_backstory_response_1", "So you wish to join for luck? Why... of course! Plenty of luck to go around!"), #Solveig
  ("npc12_backstory_response_1", "A doctor, eh? Yes, you are welcome."), #Asbjorn
  ("npc13_backstory_response_1", "I might be able to use you in my shield wall."), #Helgi
  ("npc14_backstory_response_1", "I might be able to use an extra sword."), #Ailchu
  ("npc15_backstory_response_1", "I suppose I can use such help."), ##aghatinos
  ("npc16_backstory_response_1", "What precisely can you do?"), #Beda

  ("npc1_backstory_response_2", "I cannot accept responsibility for you. Go back to him."), #Caio
  ("npc2_backstory_response_2", "Hard luck, friend. Good day to you."), #Egil
  ("npc3_backstory_response_2", "Go back to your master, lass. Forget your old life and accept your destiny as a slave."), #Eithne
  ("npc4_backstory_response_2", "No, sorry."), #Donnchadh
  ("npc5_backstory_response_2", "I do not wish to be a new weapon in your feud."), #Morgant
  ("npc6_backstory_response_2", "Your destiny is certainly not with me. So sorry."), #Bodo
  ("npc7_backstory_response_2", "What I perceive is errant bigotry. Good day to you, madam."), #Dwywei
  ("npc8_backstory_response_2", "Well, good luck, you drunk. You should look for a new wife or something."), ####Reginhard , frisio
  ("npc9_backstory_response_2", "Some of my best friends are riff-raff. Good day to you, sir."), #Clovis
  ("npc10_backstory_response_2", "Well, good luck on finding your Saxon king before finding your death. Good day, sir."), #Ceawlin
  ("npc11_backstory_response_2", "Well, I still don't know what a skjaldmo is, but at least now I know I don't like it!"), #Solveig
  ("npc12_backstory_response_2", "Sorry, I can't take on any new hands."), #Asbjorn
  ("npc13_backstory_response_2", "I'll let you know if I hear of anything. Good day."), #Helgi
  ("npc14_backstory_response_2", "No, sorry. There is nothing I can do for you."), #Ailchu
  ("npc15_backstory_response_2", "I'm sorry. I've got all the men that I can manage right now."), #aghatinos
  ("npc16_backstory_response_2", "Sorry, priest. You sound like you might be trouble. I respect whatever faith."), #Beda

  ("npc1_signup", "I will serve with loyalty and dedication, I will become worthy of your trust."), #Caio
  ("npc2_signup", "I was trained by Thorgil. Look at me well, because unlike many who are with you, I'm a warrior. I could beat anyone here with spear or sword. I'm worth perhaps five men like yours."), #Egil
  ("npc3_signup", "I am? Will you really help me escape and protect me? Well, I am in no position to be picky! I would be pleased to join you in exchange for my freedom."), #Brunhild
  ("npc4_signup", "Then I'm your man. Do not ask me to talk too much, but give me an axe and a shield and let me do my job."), #Donnchadh
  ("npc5_signup", "Why, that is a most generous offer."), #Morgant
  ("npc6_signup", "Fate is written with blood and steel, and my redemption weaves through them both."), #Bodo
  ("npc7_signup", "I might be. I'm not really happy to be here. At first, I thought this would be a safe place, filled with people looking to get away from it all and draw closer to the old gods, but that man, the high druid, is crazy! He kills people for fun, saying that invokes the gods, but the truth is that he knows them very little."), #Dwywei
  ("npc8_signup", "Thank you, my friend! I know I'm rough. Thank God for people like you giving me a chance."), ####Reginhard , frisio
  ("npc9_signup", "I would very much like that, {reg59?madame:sir}."), #Lothar
  ("npc10_signup", "Well, I guess I can give you the chance to prove your worthiness. I shall fight for you."), #Ceawlin
  ("npc11_signup", "Oh, luck can't be valued too much. This is a harsh, harsh world. The timid die young, {reg59?my pretty:handsome}, and the bold quickly follow."), #Gwenllian
  ("npc12_signup", "I am glad. I am young, and my thirst for knowledge knows no limits. I hope our travels will help increase my experience."), #Asbjorn
  ("npc13_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."), #Helgi
  ("npc14_signup", "Indeed? You would do well to enlist me."), #Ailchu
  ("npc15_signup", "Glad to hear that! I'd be happy to travel, for a change. I'd like to know more about the North beyond this place."), #aghatinos
  ("npc16_signup", "Well, {reg59?madame:sir}, let me tell you. Inasmuch as my main mission is spiritual, I shall bring peace to every soul in this shield wall."), #Beda

  ("npc1_signup_2", "I've ridden over a fair amount of rough country in my time, more often than not in a hurry. I'm a tracker, so I have a good eye for terrain. So what do you say?"), #Osmund
  ("npc2_signup_2", "I can also be a great drinker, and I have been praised many times as a skald."), #Egil
  ("npc3_signup_2", "I think you would find that I would be a most valuable addition to your ranks. I am well versed in the old traditions of the land and can declaim several of the epic poems of my people. I will also use everything my grandma taught me to keep my new companions healthy."), #Brunhild
  ("npc4_signup_2", "If you are clever, you will give me a position of command and keep me far from any Pict."), #Donnchadh
  ("npc5_signup_2", "I shall not betray you -- so long, of course, as you do your duty to me by feeding me, paying me, and not dragging my miserable hide into a battle that there is no chance of winning. Vow to respect me, and I shall be your best warrior."), #Morgant
  ("npc6_signup_2", "Erudino has answered my prayers, bringing you to me! You will not find a more loyal companion or closer friend."), #Bodo
  ("npc7_signup_2", "But let your followers know that I do not tolerate louts and brutes. Anyone who misbehaves around me will quickly find an arrow in their gullet."), #Dwywei
  ("npc8_signup_2", "I will earn your respect. You will discover that you can trust me."), ###Reginhard , frisio
  ("npc9_signup_2", "I am a gentleman, and I prefer to fight with sword and spear. I recognize that you are of lower birth than I am, but there is no shame for me to serve under an experienced warlord -- presuming, of course, that your followers do not become too familiar with me, nor too jealous of my bravery. I assume that will not be a problem?"), #Clovis
  ("npc10_signup_2", "You won't regret taking me on, {reg59?milady:sir}. I'm a very experienced warrior, deadly against those damn Welsh. And I've probably trained more raw recruits than you've had hot dinners."), #Ceawlin
  ("npc11_signup_2", "But I am a skjaldmo. I fight like a Valkyrjar and sing as Balder sang before that cunning Loki finished him off mid-stanza. The jarls of Northvegr and Danmark would pay a fortune and their left thumb for me to join them, but the one I choose is you, {reg59?my pretty:handsome}!"), #Solveig
  ("npc12_signup_2", "It is very interesting how the Norns spin their yarn. Until a few days ago, before the Assembly, I thought I would return home to Odinsve, to end my days remedying wounds and sniffles. Then I met you, and I knew that all this would change."), #Asbjorn
  ("npc13_signup_2", "I am a skilled swordsman. I can also instruct your men in fighting, but I warn you that I do not care to fight for a leader who is lax in discipline with {reg59?her:his} men, for in the long run they will not respect a soft hand. "),#Helgi
  ("npc14_signup_2", "Sword, spear, the bow -- my skill in all such martial pursuits is the stuff of epic verse.  Together we will perform feats that will be recounted in festivals and campfires, in filthy taverns and in the halls of kings, for many generations to come."), #Ailchu
  ("npc15_signup_2", "And you'll be glad to have me. Although siege work is my specialty, I reckon I can handle myself well enough in an open battle. As for besieging, I can truly help you take any place you might want. The fortresses here are rudimentary; they do not compare to the ones in my homeland."), #aghatinos
  ("npc16_signup_2", "I will be useful in every kind of battle, be it mundane or be it spiritual -- be it against the very hordes of Hell."), #Beda

  ("npc1_signup_response_1", "Good. You can be useful to us."), #Caio
  ("npc2_signup_response_1", "I need no more information, Egil. Just do not give me problems."), #Egil
  ("npc3_signup_response_1", "Hum, that's a start. We can teach you the rest. Hurry, I am rescuing you right now."), #Brunhild
  ("npc4_signup_response_1", "Very well. I'll be glad to have you with us."), ##Donnchadh
  ("npc5_signup_response_1", "Certainly. Those are my obligations to every man under my command."), #Morgant
  ("npc6_signup_response_1", "Grab your things. We've lots to do."), #Bodo
  ("npc7_signup_response_1", "You are welcome."), #Dwywei
  ("npc8_signup_response_1", "OK, get your stuff. The way awaits us."), ###Reginhard , frisio
  ("npc9_signup_response_1", "Well, it shouldn't be. I'll have a talk with them."), #Clovis
  ("npc10_signup_response_1", "Good man, but beware! You will not put down any Briton in my shield wall."), #Ceawlin
  ("npc11_signup_response_1", "Very well, you are hired, but stop calling me '{reg59?my pretty:handsome}.'"), #Solveig
  ("npc12_signup_response_1", "Then welcome to my shield wall, loeknir."), #Asbjorn
  ("npc13_signup_response_1", "Good. I'll be happy to hire someone like you."), #Helgi
  ("npc14_signup_response_1", "Good. Make yourself ready, and we'll be on our way. "), #Ailchu
  ("npc15_signup_response_1", "That works for me. I will be pleased to hire you."), #aghatinos
  ("npc16_signup_response_1", "It sounds like you can do the job. I will hire you."), #Beda

#11
  ("npc1_signup_response_2", "I'd prefer not to have you in my army. Good day, sir."), #Caio
  ("npc2_signup_response_2", "No, I prefer a different sort of companion. Good day to you."), #Egil
  ("npc3_signup_response_2", "Actually, I think you are pretty useless. Go back to your master, slave."), #Brunhild
  ("npc4_signup_response_2", "Actually, we are not in the habit of hiring men like you. Good day, sir."), #Donnchadh
  ("npc5_signup_response_2", "Actually, on second thought, I prefer not to hire a banished man."), #Morgant
  ("npc6_signup_response_2", "Sorry, but I do not need you. I prefer not having you around."), #Bodo
  ("npc7_signup_response_2", "Actually, on second thought, you sound like you might be trouble. Good day to you. "), #Dwywei
  ("npc8_signup_response_2", "Mm, maybe you'd best seek your fortune elsewhere."), ##Reginhard , frisio
  ("npc9_signup_response_2", "You assume wrong, sir. In my shield wall, we respect courage and skill, rather than birth."), #Clovis 
  ("npc10_signup_response_2", "I will not see any of my men killed because they are not Saxon. Good day to you."), #Ceawlin
  ("npc11_signup_response_2", "Sorry, milady. Now I remember that we've already got as many singers as we can handle."), #Solveig
  ("npc12_signup_response_2", "A battle is not a place for men of science. Perhaps you should look elsewhere for work."), #Asbjorn
  ("npc13_signup_response_2", "My warriors are already disciplined enough without the likes of you. Good day, sir."), #Helgi
  ("npc14_signup_response_2", "Actually, on second thought, a fighter overeager for glory and women is dangerous to have."), #Ailchu
  ("npc15_signup_response_2", "You know, now that I think about it, I won't need your expertise for the foreseeable future."), #aghatinos
  ("npc16_signup_response_2", "To be honest, I'd prefer someone who is not a religious fanatic."), #Beda
 
  ("npc1_payment", "I will be very useful to you, {reg59?madame:sir}, you can bet on that. Just one more thing before we leave, would you mind lending me {reg3} peningas? I am ashamed to say it, but I have made myself a bit of debt here, staying in this tavern over the last few weeks, and the tavern owners no longer believe that I am loaded with silver as I used to tell them. You know, things could get ugly here if they see me leaving with you before paying them."), #Caio
  ("npc2_payment", "Before I sign up, I will need 300 coins here."), #Aleifr
  ("npc3_payment", "Then I will fight your enemies for you!"), #Brunhild
  ("npc4_payment", "Before we depart, would you be so kind as to lend me {reg3} peningas? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."), #Donnchadh
  ("npc5_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} peningas from you, so I can adequately equip myself with armor and weapons necessary to fill my new obligations to you."), #Morgant
  ("npc6_payment", "Before I sign up, I need 300 coin as pay."), #Bodo
  ("npc7_payment", "All right, then. I will come with you, but I want a payment of {reg3} peningas first. You aren't expecting me to work for free, are you?"), #Dwywei
  ("npc8_payment", "Then I will fight your enemies for you!"), ##Reginhard , frisio
  ("npc9_payment", "That's very good of you, but before I join, can you lend me {reg3} peningas, so that I can buy some proper clothing that befits a gentleman of noble birth like me? The coat on me has worn badly due to my recent bad fortune, and I cannot let common soldiers mistake me as one of their own."), #Clovis
  ("npc10_payment", "That's good news, but I'll ask for one last thing, warlord. I have a woman here in {s20}, a happy widow, and she says she has my child in her belly. Damn, she is a Brythonic wench, but I want to give her some money before I leave... for the child, you know. Even if the child's only half-Saxon, it still deserves some future. Do you think you can spare {reg3} peningas?"), #Ceawlin
  ("npc11_payment", "Sure, {reg59?my pretty:handsome}, but before joining you, I would like a payment of {reg3} peningas. You know, as back pay for watching over you all this time."), #Solveig
  ("npc12_payment", "Before I sign up, I need to settle some agreements I entered into for lodging and the like. Would you be able to cover them? Just 300 coins ought to do it."), #Asbjorn
  ("npc13_payment", "Ah, one last thing. I would like an initial bounty of {reg3} peningas before I join your command. It's my principle never to enter someone's service without receiving the payment I deserve."), #Helgi
  ("npc14_payment", "Before I sign up, there is the small matter of some expenses I have incurred while staying here -- {reg3} peningas. Do you think that you could cover those for me, as a gesture of our already legendary friendship?"), #Ailchu
  ("npc15_payment", "Good. By the way, as a skilled engineer, I expect a payment up front. A signing bonus of {reg3} peningas would be fair, I think."), #aghatinos
  ("npc16_payment", "Before I sign up, I will need 200 coins here."), #Aedh
  
  ("npc1_payment_response", "Very well, here's {reg3} peningas. Now, fall in with the rest."), #Caio
  ("npc2_payment_response", "Very well. Your loss."), #Egil
  ("npc3_payment_response", "Very well."), #Brunhild
  ("npc4_payment_response", "Certainly. Here's {reg3} peningas."), #Donnchadh
  ("npc5_payment_response", "Well... here's {reg3} peningas, then. Your first payment."), #Morgant
  ("npc6_payment_response", "Very well."), #Bodo
  ("npc7_payment_response", "No, of course not. Here's {reg3} peningas."), #Dwywei
  ("npc8_payment_response", "Oh, I am no pauper, great warrior. Here's {reg3} peningas for you."), #Siwi
  ("npc9_payment_response", "Very well, here's {reg3} peningas."), #Clovis
  ("npc10_payment_response", "Ha ha, of course. Here, {reg3} peningas."), #Ceawlin
  ("npc11_payment_response", "Very well, here's {reg3} peningas. Now let's get back on our way. And stop... ah, well, forget it."), #Solveig
  ("npc12_payment_response", "Very well."), #Asbjorn
  ("npc13_payment_response", "All right, here's {reg3} peningas. You are most welcome in our shield wall."), #Helgi
  ("npc14_payment_response", "Of course, here's {reg3} peningas. Make ready to leave soon."), #Ailchu
  ("npc15_payment_response", "All right, here's {reg3} peningas. Glad to have you with us."), #aghatinos
  ("npc16_payment_response", "Very well."), #Beda



  ("npc1_morality_speech", "Oy -- Warlord. Please don't take this the wrong way, but it's a hard life, and it's a bit much that we {s21}. Take a little more care in the future, warlord, if you don't mind my saying."),
  ("npc2_morality_speech", "I do not care to {s21}. No one with a reputation for blatant cowardice will be properly respected and obeyed by his shield wall."),
  ("npc3_morality_speech", "Perhaps it is not my place to say so, {reg59?madame:sir}, but I confess that I am somewhat shocked that we {s21}. Of course I realize that war is cruel, but there is no need to make it more cruel than necessary."),
  ("npc4_morality_speech", "The Scots do not care to {s21}. I will not be pleased if you continue to take this course."),
  ("npc5_morality_speech", "Pardon me, warlord. It is not good to {s21}. Your first duty is to the men who form your shield wall. The least they can expect is food, pay, the opportunity to loot, and that you not waste their lives needlessly."),#Morgant
  ("npc6_morality_speech", "Listen to me, {playername}. As you know, I am a loyal man, with strong values. I will get my redemption. I did not expect to {s21}."), #bodo
  ("npc7_morality_speech", "Warlord, I do not like to see us {s21}. Such are the actions of a common bandit chief, with no regard for his followers."),#Dwywei
  ("npc8_morality_speech", "I was not pleased that you decided to {s21}. To fall in battle is an honor, but to fight in a shield wall led by a coward is a disgrace."),
  ("npc9_morality_speech", "{reg59?Madame:Sir}, it is not my way to {s21}. Men of my house will accept death but not dishonor. Please do not make me ashamed to serve under you."),#Clovis
  ("npc10_morality_speech", "Begging your pardon, warlord. I can't say that I'm happy to see us {s21}. Those are just simple people, trying to make a living. If we could try to go easy on the poor wretches, warlord, I'd feel much better."),#ceadlyn
  ("npc11_morality_speech", "Excuse me, {reg59?my pretty:handsome}. It's not good that we {s21}. The least the soldiers expect of a leader is to feed them, pay them, and do {reg59?her:his} best to keep their sorry skins intact as best {reg59?she:he} can."),
  ("npc12_morality_speech", "Warlord, I do not like to see us {s21}. I am prepared to be your hirdman, but not a brigand. Pray let us try to show a little more compassion."),
  ("npc13_morality_speech", "I do not care to {s21}. No one with a reputation for cowardice will be properly feared by his men."),#Helgi
  ("npc14_morality_speech", "Warlord, if we can avoid it, I'd prefer not to {s21}. This world is a small place, and one's reputation is precious. You would have me ignore much to respect you."),#Ailchu
  ("npc15_morality_speech", "{reg59?Madame:Sir}, just so you know my opinion, any commander with sense will not let his shield wall {s21}. I hope you don't mind me speaking so bluntly."),#aghatinos
  ("npc16_morality_speech", "Warlord, I don't like to {s21}. God does not approve of this kind of behavior. It will surely cause you to fall if left unchecked by my holy teachings."), #Beda

  ("npc1_2ary_morality_speech", "Warlord, just so you know, I have no problem if we {s21}. Living to fight another day makes good sense to me."),
  ("npc2_2ary_morality_speech", "You know, friend {playername}, it's none too reassuring to see how you just {s21}. If you can break your word to them, you can break your word to me. That's how I figure it."),
  ("npc3_2ary_morality_speech", "{reg59?Madame:Sir}, I can't say I like to see us {s21}. There is no shame in finding a way to avoid the spilling of blood."),
  ("npc4_2ary_morality_speech", "I think nothing of it that you {s21}. You should adopt whatever ruse you need to survive in these troubled times."),
  ("npc5_2ary_morality_speech", "I think it was a brave decision you took to {s21}. There is no shame in finding a way to avoid the spilling of blood."),#Morgant
  ("npc6_2ary_morality_speech", "{playername}, you may choose to {s21}, but I would prefer to have no part in it. Such is not the path to my redemption."), #bodo
  ("npc7_2ary_morality_speech", "I think it was a brave decision you took to {s21}. There is no shame in finding a way to avoid the spilling of blood."),#Dwywei
  ("npc8_2ary_morality_speech", "I think it was a brave decision you took to {s21}. There is no shame in finding a way to avoid the spilling of blood."),
  ("npc9_2ary_morality_speech", "Warlord, I am dismayed that you {s21}. A {reg59?gentlewoman:gentleman} such as you should exhibit the highest standards of honor at all times."),
  ("npc10_2ary_morality_speech", "{reg59?Sister:Brother}, I can't say I like to see us {s21}. If you treat your men well, they'll repay you with interest."),
  ("npc11_2ary_morality_speech", "I'm not very convinced about the decision you took to {s21}. I was taught that this is a dishonorable solution. I'm confused, but maybe it was just an isolated incident, right?"), #Solveig
  ("npc12_2ary_morality_speech", "I think it was a brave decision you took to {s21}. You have my support in this, as it does no damage to one's reputation to live to fight another day."), #asbjorn
  ("npc13_2ary_morality_speech", "Warlord, you should not let it bother you that you {s21}. Armies are made to do their leaders' bidding, and hardships are part of a soldier's life."),#Helgi
  ("npc14_2ary_morality_speech", "Captain, just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),#Ailchu
  ("npc15_2ary_morality_speech", "You know, strategos, it's none too reassuring to see how you just {s21}. If you can break your word to them, you can break your word to me. That's how I figure it."),
  ("npc16_2ary_morality_speech", "I think it was a brave decision you took to {s21}. There is no shame in finding a way to avoid the spilling of blood."), #Beda


####Pausa - conflitos chief

  ("npc1_personalityclash_speech", "Warlord, no offense, but I'm a bit tired of {s11}. She puts on airs like she's something better than your humble servant, Caio."), #Caio-Dwywei
  ("npc2_personalityclash_speech", "{reg59?Madame:Sir}, as you recall, I was living in Ribe. I respect men who like mead and girls, but not men so strict and unbearable. I am talking about {s11}."), #Egil#Morgant
  ("npc3_personalityclash_speech", "Warlord, in my opinion, {s11} is a terrible man. He has tried to seduce me into his bed many times, and I have already seen him following me during the night, when I am alone. I tell you, I am pretty scared of him."), ##Brunhild-Brian
  ("npc4_personalityclash_speech", "{s11} openly shows me disrespect. If things continue along this path, I'll kill him. Be warned, in case you want to take some action beforehand."), ##Donnchadh-Ceawlin
  ("npc5_personalityclash_speech", "A moment of your time, warlord. {s11} seems to think I'm a common bandit, just because I have rewarded myself in the past to the legitimate spoils of war from caravans passing through my family's lands."), #Morgant-Aleifr
  ("npc6_personalityclash_speech", "Your pardon, {playername}, but I cannot keep my tongue still any longer. That harlot, {s11} -- every time she sees me, she points the five fingers of her hand at me -- a peasant's sign to ward off evil."), #Bodo-Gwenllian
  ("npc7_personalityclash_speech", "Warlord, I have done my best to put up with your followers' rude talk and filthy habits, but that one who calls himself {s11} is beyond tolerance."), ##Dwywei-Caio
  ("npc8_personalityclash_speech", "Just so you know, I cannot abide that insolent {s11}, who likes to call himself a 'philosopher.' That southern rat loves to speak in that awful gibberish he calls 'Latin' and laugh at me behind my back because I do not understand what he is saying."), #Reginhard-Orosio
  ("npc9_personalityclash_speech", "{reg59?Madame:Sir}, {s11} is a base braggart, a man with as much respect for the bravery of other men as a Svia. I am tired of hearing how he and his fellow warriors could defeat anyone in the battlefield, just because he is a master of military discipline."), #CLovis-Liuva
  ("npc10_personalityclash_speech", "Excuse me, warlord. I hate to trouble you with such things, but I just wanted to let you know that I can't abide that fellow {s11}. He likes to say he is some sort of squire to kings or something."), #Ceawlin-Athwrys
  ...
  ("npc12_personalityclash_speech", "My {reg59?lady:lord}, that ignoramus, {s11}, has been spreading lies that I am nothing more than a cowardly rascal, unfit for the battlefield."), #Asbjorn-Siwi
  ("npc13_personalityclash_speech", "Excuse me, warlord. I am very close to killing with my bare hands that insect that calls himself {s11}. That joke of a warrior does not understand how bravery without discipline can only result in defeat and shame."), #Helgi-Clovis
  ("npc14_personalityclash_speech", "Captain, you must be aware that the ugly girl known as {s11} is a disruptive influence to our men. She complains that I have been trying to seduce her. Nothing is farther from the truth, for I cannot stand even her smell."), #Ailchu-Brunhild
  ("npc15_personalityclash_speech", "Excuse me. I hope you don't mind me telling you, but, in my opinion, {s11} is a danger to the party. He only cares about religion and Hell and is disrespectful of authority and the basic principles of the military art."), #aghatinos-Aedh
  ("npc16_personalityclash_speech", "Just so you know, there's something demonic about {s11}. He scrawls strange things in the dirt and mutters to himself the entire time before battle."), #Beda - Egil

  ("npc1_personalityclash_speech_b", "She's not somebody special, and she has no right to tell me to keep my distance from her, as she did just now."),  #Caio-Dwywei
  ("npc2_personalityclash_speech_b", "I don't much care to hear {s11} gloat about the righteousness of the chaste and pure life. I am a warrior who aspires to Walhalla, not one of {s11}'s saints."), #Egil-Morgant
  ("npc3_personalityclash_speech_b", "I know that an army is usually a man's place, but I believe I deserve some respect as well. I am no one's whore. I hope you do not mind me saying so."), ##Brunhild-Brian
  ("npc4_personalityclash_speech_b", "This Saxon, {s11}, is looking for death. That is all."), #Donnchadh-Ceawlin
  ("npc5_personalityclash_speech_b", "I told him that if the warrior's way bothers him so much, he should become a priest or a beggar so as not to have to worry about such things. I hope you do not mind that I say such things."), ##Morgant - Egil
  ("npc6_personalityclash_speech_b", "I know I'm not the best of men, but I am seeking repentance, and I deserve better than to be the object of some witch's superstition. I think she has some devil's blood in her possession. I just thought you should know."), #Bodo-Gwenllian
  ("npc7_personalityclash_speech_b", "I do not care for how he stares at me around the camp fire after a meal, picking his teeth and slurping his slimy beer. What I cannot accept is how he keeps saying that he is a much better tracker than I am, which is obviously false. He is base, ignorant, and a completely idiotic youth. He could never compare to me in tracking, nor in anything else. I do not care to travel with such people."), #Dwywei - Caio
  ("npc8_personalityclash_speech_b", "It is true I do not know how to read and write, nor how to speak Latin, but I know much more of life and battle than {s11}. A great warrior like me should not be mocked by some weak-minded schoolboy. It was only out of respect for you that I refrained from cutting his throat when I overheard his jokes about me. I thought it only fitting that I should warn you."), #Reginhard-Orosio
  ("npc9_personalityclash_speech_b", "So I asked him, if he and his men were so much more disciplined than even the Franks, how did he fail to conquer his Danish enemies and instead ran to hide among the Saxons, a people that he despises? He gave me no reply; his face just turned red. Then he cursed me and all of my ancestors and almost challenged me to a duel. He says he is so disciplined, but I think maybe you should discipline him a little more."), #Clovis-Liuva
  ("npc10_personalityclash_speech_b", "Everyone knows there is no noble blood among his people; the two things are antithetical. Any of them who pretends to be of noble blood is simple, foolish, and intolerable. Anyway, I might have said something that was a bit sharp to him a moment ago - something like 'if he is truly a noble, then his father must really be a Saxon.' He seemed to take offense. Anyway, I just thought you should know."), #Ceawlin-Athwrys
  ("npc11_personalityclash_speech_b", "He'll bring us nothing but misfortune and sorrow, that's for certain. I don't like being around him, and I don't think he should be with us. I have also instructed him that a skjaldmo must be a virgin, but he stupidly keeps speaking of love. I cannot abide him any longer, that's all. Sorry to have to trouble you with this, {reg59?my pretty:handsome}."), #Solveig-Egil
  ("npc12_personalityclash_speech_b", "It is not my fault that this stupid barbarian is incapable of understanding the beautiful world of medicine, nor that he prefers to die with an infected wound than to be helped by my knowledge of nature and human body. Warlord, I am deeply tired of tolerating such an ungrateful and ignorant lot."),#Asbjorn-Siwi
  ("npc13_personalityclash_speech_b", "That schit {s11} saw fit to mock the war-like nature of my people, and even suggested that I am in Englaland only because I was defeated in the battlefield fighting against the Danish, which, of course, has never happened. I will not have my methods nor my beliefs questioned in front of the men, and I will not serve any warlord who tolerates such insubordination and stupidity in his shield wall. Thank you for allowing me to speak my piece."),#helgi-Clovis
  ("npc14_personalityclash_speech_b", "She is the one that has already tried many times to sneak into my tent during the night! She uses every opportunity to be alone with me, trying to provoke me into something I do not dare to say out loud. Please, explain to that impudent girl that I only care for beautiful women and would have no business with the likes of her."), #Ailchu - Brunhild
  ("npc15_personalityclash_speech_b", "I heard him preaching to the warriors that our preparations before a battle or a siege are completely useless, because victory can only be achieved if it befits God's will. Even though I also believe in Christ, I know for sure that a pure Christian soul alone never guaranteed victory to any army. I think you should tell him to stop this kind of preaching right now."), #Agasicles-Aedh
  ("npc16_personalityclash_speech_b", "Fearing witchcraft, I asked {s11} about it, and he told me that I should mind my own business. So I had a look in his baggage and found a heretical Odin amulet. I am sure that this amulet is evil, a thing of the Devil, surely. We should definitely get rid of {s11} for the sake of our immortal souls."), #Beda - Egil


 
### set off by behavior after victorious battle
  ("npc1_personalityclash2_speech",  "Warlord, no offense, but I'm a bit tired of {s11}. He keeps saying that I am a crazy, idiotic youth that is surely doomed to go to Hell."), #Caio-Beda
  ("npc2_personalityclash2_speech", "{reg59?Madame:Sir}, if you don't mind, I'd prefer not to be deployed anywhere near {s11}, lest I be tempted to sacrifice him to my gods."), #Egil-Lothar
  ("npc3_personalityclash2_speech", "{reg59?Madame:Sir}, since I joined your shield wall, I have tried hard to learn how to live like a soldier -- which is much better than being a slave -- and how to honor the warrior's code, but some of your men do not respect me as an equal."), ##Brunhild-Siwi
  ("npc4_personalityclash2_speech", "I told you I hate Picts, yet you invited {s11} to join us. Well, inform her that when she speaks to me, she should remember that she is nothing more than a Pictish servant, whereas I am a Scot."), #Donnchadh-picts
  ("npc5_personalityclash2_speech", "Warlord, {s11} needs to have her tongue cut out and her back whipped hard."), ##Morgant-Solveig
  ("npc6_personalityclash2_speech", "Did you see {s11} during that last battle? He taunts the fallen foe as they lie stricken and helpless on the battlefield, mocking their parentage and their foolishness for having fought us. He is becoming completely depraved and weak, just like all his race are."), #Bodo-Liuva
  ("npc7_personalityclash2_speech", "Warlord, I have grown tired of the insolence of the man that answers to the name of {s11}. He thinks I am less a warrior than he just because I am a tracker and, even more, a woman. Yes, I know it's not common for a woman to leave her home and her husband, but where I come from, among the Picts, women have few options, but definitely more than in other, ignorant lands."), #Dwywei-Athwrys
  ("npc8_personalityclash2_speech", "Warlord. {s11} is a most insolent girl. I have tried to be polite, even friendly, only to have her rebuff me. The little chit thinks she is a warrior, and not just a camp slave."), #Reginhard-Brunhild
  ("npc9_personalityclash2_speech", "{reg59?My lady:Sir}, I hope you do not mind me telling you this, but in my opinion {s11}, the bastard, does not know his place. During that last battle, he cut in front of me to engage a foe whom I had marked as my own."), #Clovis-Egil
  ("npc10_personalityclash2_speech", "Warlord, a question for you. Are you in charge of this shield wall, or is it {s11}?"), #Ceawlin-solveig
  ("npc11_personalityclash2_speech", "{reg59?My pretty:Handsome}, I do not think we should keep the company of that fellow {s11}. Please, hear what I feel in my heart."), #Solveig-Reginhard
  ("npc12_personalityclash2_speech", "Warlord. I can no longer abide the rank ignorance of {s11}. As I was treating the wounded during our last battle, he saw fit to disparage my use of laudanum in relieving the pain while I conducted surgery and of treating wounds with a poultice of honey."), #Asbjorn-Agasicles
  ("npc13_personalityclash2_speech", "I must say that the presence of {s11} offends me. He, a Dane, mocks one of the confrontations between my people and his. We were completely defeated that time, and he knows I fought there."), #helgi-egil
  ("npc14_personalityclash2_speech", "{reg59?Madame:Sir}, {s11} is a terrible companion. He does not deserve the honor of being part of the glorious saga of our shield wall, which shall be sung for generations to come and forever more."), #Ailchu-Ceawlin
  ("npc15_personalityclash2_speech", "Strategos, I must tell you that I question {s11}'s medical credentials. As he was tending to our wounded after that last battle, I saw fit to remind him that the peerless Hippocrates often advocated administering a distillation of beetroot, to restore the humor imbalance brought by loss of sanguinity."), #aghatinos-Orosio
  ("npc16_personalityclash2_speech", "If you have any fear of God, pay heed to the warnings I am about to speak. The demon called {s11} must be put to death right now."), #Beda - Solveig
   
  ("npc1_personalityclash2_speech_b", "I have no interest in becoming a Christian. In my opinion, this priest only can only bring us bad luck. Maybe we should burn him."), #Osmund-Aedh 
  ("npc2_personalityclash2_speech_b", "The enemy was bearing down on us, and he says, 'A great warrior does not drink mead in battle.' Next time I will step aside, and let him take a spear in the gut."), #Egil-Lothar
  ("npc3_personalityclash2_speech_b", "After our last victory, I was picking through the slain, and that Frisian called Reginhard pushed me aside, saying that looting was not for me, a simple slave girl that has just been permitted to travel with the army. However, I believe that if I battle in the shield wall, I deserve my share of the loot, just like any other warrior. Even though I might be less experienced than the others, I also risked my life."), ##Brunhild-Reginhard
  ("npc4_personalityclash2_speech_b", "Finally, you will have to deal with that northern woman. She must remember her place or be whipped."),#Donnchadh-Dwywei
  ("npc5_personalityclash2_speech_b", "As far as I understand, she is but a woman. Yet, when I ordered her to fetch me a bowl of that fine stew last night, she refused and said that I should get it myself. I was too tired to slap her properly for her impudence, so I let it go, but I will not tolerate such disrespect in the future."), #Morgant-Solveig
  ("npc6_personalityclash2_speech_b", "We should not tolerate that bastard in our shield wall. The battle is no place for mockers; no true warrior insults a fallen foe. Please, let me kill this idiot. Allow me to appease my tortured soul with this sinner's blood."), #Bodo-Liuva
  ("npc7_personalityclash2_speech_b", "He also insists that I should address him as 'my lord,' instead of his ridiculous name. I tell you, one day, when I have my own band of warriors, I will hunt him down and ask him how much better a warrior he is with my axe buried in his skull."), #Dwywei-Athwrys
  ("npc8_personalityclash2_speech_b", "As we were cleaning our weapons after that last battle, I remarked that I thought her a handsome girl and that I would happily find her a place with one of my renters. I explained to her that, although I, myself, am looking for a wife, I will marry only a free woman. I thought it was a very generous offer, a man and land. An army slave is hardly going to find herself awash in prospects, but rather than thank me, she simply turned her back without a word. It was only out of respect for your leadership that I did not immediately try to teach her some manners. I really think you should discipline your slaves better."), #Reginhard-Eithne
  ("npc9_personalityclash2_speech_b", "I appreciate that he is willing to risk his life in battle, but that alone does not make a warrior. He is not of noble birth. He may fight with us as an auxiliary, as a favor, but he should not attempt to steal glory from his betters."), ##clovis-egil
  ("npc10_personalityclash2_speech_b", "In that last battle, as always, he kept singing and praising himself as the glorious commander that lead us all to victory, fame, and fortune. I am sorry, but if he is our leader instead of you, I am ready to go find my fortune somewhere else."), #Ceawlin-Ailchu
  ("npc11_personalityclash2_speech_b", "As far as I know, he is an exiled man that will never find peace nor truly be allowed to return to his homeland. All because he was unable to obey his jarl. Well, if he can't obey even his rightful jarl, what says that he shall obey you? Please, don't take me wrong, {reg59?my pretty:handsome}, but I think he is a danger to us all. I think you had best be rid of him."), #Solveig-Reginhard
  ("npc12_personalityclash2_speech_b", "Warlord, if that man knew the slightest thing about medical matters, he would know that one should never undermine a patient's confidence in his doctor, particularly not during a complicated operation. He should stick to military matters only. If you would be kind enough to dismiss him from this shield wall, you would be doing all of us a great service."), #Asbjorn-Agasicles
  ("npc13_personalityclash2_speech_b", "He keeps saying that I'd better watch my back, for someday he will stick his spear deep into my dark Svia heart. He has sworn to kill me in the next battle. You had better keep a close eye on this fool."), #helgi-egil
  ("npc14_personalityclash2_speech_b", "In our last battle, while I was singing about the many battles that your leadership, alongside my courage, allowed us to turn into victories, he spat on the ground and told me to keep my 'arrogant yapper' shut. If this man does not understand the legendary nature of our feats, then he should not be allowed to share our future glory and fortune."), ##Ailchu-Ceawlin
  ("npc15_personalityclash2_speech_b", "{s11} responded that Hippocrates was an 'antiquated know-nothing,' incomparable to the knowledgeable Galenus. Strategos, no true medic would have such disrespect for the great masters of the past. I do not believe you should employ such an obvious impostor."), #aghatinos-Orosio
  ("npc16_personalityclash2_speech_b", "This awful woman has openly declared that she follows the pagan gods Odin and Thor, and that the teachings of Christ are nothing more than the babblings of weak men. She even made an absurd remark suggesting that I, a holy priest, brought us all bad luck with my 'gibberish preaching.' If you have no intention of leading all of your men to Hell, this Norse woman should be immediately sent to her afterlife by fire."), #Beda - Solveig


  ("npc1_personalitymatch_speech", "Warlord, {s11} didn't do badly in that last fight at all. He's a good egg, that one."), #Caio - Egil
  ("npc2_personalitymatch_speech", "{reg59?Madame:Sir}, I just wanted to tell you that {s11} may be a rough sort, and I'll venture a complete drunkard as well, but I'm proud to call him my companion."), #Egil-Reginhard
  ("npc3_personalitymatch_speech", "Hello, {reg59?madame:sir}! I had just wanted to tell you that {s11} is a most gallant and brave warrior. Did you see him in our last battle?"), ##Brunhild-Lothar
  ("npc4_personalitymatch_speech", "I just wanted to say a word in praise of {s11}. He did well in that last battle."), #Donnchadh-Morgant
  ("npc5_personalitymatch_speech", "That was a fine battle, {playername}! {s11} is a good companion to have by our side in a fight."), #Morgant-Athwrys
  ("npc6_personalitymatch_speech", "Sometimes I am troubled by all this bloodshed, but I know that proud warlords must be humbled and cruel bandits tamed if we are to restore peace."), #Bodo-Beda
  ("npc7_personalitymatch_speech", "Warlord, I was just talking to {s11}. He might be an outspoken man, but he holds no prejudice for me being a woman or a Pict."), #Dwywei-Beda
  ("npc8_personalitymatch_speech", "A fine battle that was, warlord. I have to say, I greatly enjoy the company of {s11}, for he is a fine commander of men."), #Reginhard-Liuva
  ("npc9_personalitymatch_speech", "Warlord, {s11} acquitted herself well in that fight back there. A fine, modest maiden she is, if I dare say so myself."), #CLovis-Brunhuild
  ("npc10_personalitymatch_speech", "Dryhten! I wish you joy in your victory! Say, I really like the company of that Solveig. I see that she is extremely devoted to the safety of our shield wall."), #Ceawlin-Solveig
  ("npc11_personalitymatch_speech", "Oh {reg59?my pretty:handsome}, I could not praise you more for having women of such quality as {s11} within our shield wall. I do not care that she is a Frisian, supposedly weak and once a slave to the Danish."), #Solveig - Brunhild
  ("npc12_personalitymatch_speech", "A bloody business, warlord, a bloody business -- although a necessary one, of course. {s11}, I believe, shares my ambivalence about this constant fighting, at least against non-Visigoths, as he always insists on saying."), #Asbjorn-Bodero
  ("npc13_personalitymatch_speech", "It is a pleasure going into battle with a fine Frisian noble like {s11} by my side."), #helgi-reginhard
  ("npc14_personalitymatch_speech", "You have earned your name today, oh valorous one! And {s11}, too! I like that one. He knows the great poems and plays of the ancient Greeks, which appeals to an artistic soul like my own."), ##Ailchu-Agathinos
  ("npc15_personalitymatch_speech", "Strategos. I was just having a word with {s11} after our last battle, and it strikes me that the man has a good head on his shoulders."), #aghatinos-Brian
  ("npc16_personalitymatch_speech", "I must tell you that, even though {s11} behaves in a rough, unmannered way, I can see that, in his heart, he has, maybe unknown to himself, a good Christian soul."), #Beda - Agathinos
   
  ("npc1_personalitymatch_speech_b", "{s11} is awesome! He is always joking, proud and brave, and knows how to seduce girls, I'll warrant. I'm glad to have him with us."), #Caio - Egil
  ("npc2_personalitymatch_speech_b", "Based on how he did in that last fight, I'd say that I'd trust my back to him any day. He also knows how to share tales and legends by the camp fire after a fine battle. I already promised to take him to a Nordic mead hall someday."), #Egil-Reginhard
  ("npc3_personalitymatch_speech_b", "I also confess that I find him a truly delightful companion, a man of both wit and manners. Perhaps, perhaps... Ah, but I say too much. Good day, {reg59?madame:sir}."), ##Brunhild-Lothar
  ("npc4_personalitymatch_speech_b", "You chose well to enlist him in our shield wall. He knows a thing or two about a fight."), #Donnchadh-Morgant
  ("npc5_personalitymatch_speech_b", "It is clear from his battle prowess that he is a true descendant of a brave warrior. He honors, in the battlefield, the greatness of his lineage."), #Morgant-Athwrys
  ("npc6_personalitymatch_speech_b", "I must say that {s11} is a source of great comfort to me. I told him of my sin, and he said to me that Christ would forgive my transgression, if I repent and truly desire such forgiveness. He is wise, and I am glad that he is with us."), #Bodo-Beda
  ("npc7_personalitymatch_speech_b", "He preaches to me just like to anyone else, and told me that even if my body is covered by war tattoos, God can still see the good intentions within my heart. I am not sure I completely liked what he said, for I am a warrior, not a simple housemaid, but, still, I feel I can trust that priest and his teachings."), #Dwywei-Beda
  ("npc8_personalitymatch_speech_b", "We are both veterans, and, as such, can both easily perceive the many tactical flaws the warriors of this land commit during battle. Our shield wall is much stronger with him in it."), #Reginhard-Liuva
  ("npc9_personalitymatch_speech_b", "Were she not a mere slave, I might ask for her hand. It is a pity that she is not a free, pure woman, but speaking with her is a pleasant way to pass time on the march."), #Clovis-Brunhild
  ("npc10_personalitymatch_speech_b", "Actually, I see that she is extremely devoted to you. Please, Dryhten, don't let it embarrass you! A devoted woman like that can be more valuable than a hundred warriors."), #Ceawlin-Solveig
  ("npc11_personalitymatch_speech_b", "She is clearly a survivor that has profound respect and obedience to you. This, of course, makes me extremely happy. If only all of our people were like her, someone who has overcome a troubled past in the house of the jarl of Kennemer. Those experiences, the difficult ones, are those that bring out the best in people, don't you think?"), #Gwenllian-Ceawlin
  ("npc12_personalitymatch_speech_b", "It saddens him deeply to take the lives of his fellow men, however just the cause. He and I have talked together of a brighter future, of the need to unite these petty warring kingdoms of Englaland, so that we may bring this time of troubles to an end."), #Asbjorn-Bodero
  ("npc13_personalitymatch_speech_b", "He has a warrior's heart, even though it requires much more to learn the art of war. Though he may not be as fast on his feet as some, he knows the wisdom of holding together in a disciplined battle-line. You showed good sense in bringing him into this shield wall."), #Helgi-Reginhard
  ("npc14_personalitymatch_speech_b", "The tales from his homeland that he likes to recite by the campfire also teach a lot about battles and warfare in general. I especially enjoy the heroic deeds that happened during the war with Troy. Soon, our shield wall will be a legend as glorious and famous as the heroes of Agamemnon's time."), ##Ailchu-Agathinos
  ("npc15_personalitymatch_speech_b", "Even though he seems to be nothing more than a proud leader of men, he understands that war, like any other affair, requires careful planning and preparation and a firm grasp of strategic principals. A fine proof of that is how interested he got in the military aspects of the siege of Troy, as I was telling him that tale the other day."), #aghatinos-Brian
  ("npc16_personalitymatch_speech_b", "{s11} is an intelligent man with great wisdom. I like to listen to him at the camp fire, and he listens to me when I speak of Christ. The truth is that we have very interesting discussions. You should join us someday."), #Beda - aghatinos

  
  ("npc1_retirement_speech", "I'm a bit tired of marching up and down the land, shedding my blood for someone else's cause. The loot is good, but I think I've got enough of that, now. I'm going to head back to my father's cave, near Hadrian's Wall. Sorry, but this life of adventure and danger is over for me."), #Caio
  ("npc2_retirement_speech", "I'm getting a bit tired of the warrior's life. I'm going to invest my share of our loot in mead and women. I would like to thank you again for taking me on, and wish you the best of luck."), #Egil
  ("npc3_retirement_speech", "I am afraid I have something to tell you. I have decided that the warrior's life, even if better than a slave's one, is not for me. One final time, I thank you for freeing me, but it is time for me to find myself a more peaceful way of life. I think I have enough money to return to my father, Thonkrik, to start a new life as a merchant. I hope you will not be angry, {reg59?madame:sir}."), #Brunhild
  ("npc4_retirement_speech", "I have fought with you honorably, but I am not altogether satisfied with your leadership. Farewell."), #Donnchadh
  ("npc5_retirement_speech", "{reg59?Madame:Sir}, since I joined your shield wall, I have fought for you fiercely and loyally, but you have not rewarded my service with the kind of leadership position that I deserve. So I will hope that my exile sentence has somehow been revoked and go home."), #Morgant
  ("npc6_retirement_speech", "I joined this shield wall in the hope that you would lead me out of darkness, and indeed, I have found a measure of peace here, but I have some qualms about your leadership. Mostly, I have begun to suspect that my path to redemption can be found elsewhere."), #Bodo
  ("npc7_retirement_speech", "I am tired of this squalid life of endless warfare, seeing weak men debased by fear, greed, lust, and a hundred other faults. I have money in my purse. I am going north, back to Alban, to assemble my own raiding party of Scots and Picts. I shall give rest to neither Briton nor Saxon, but you shall still have my peace."), #Dwywei
  ("npc8_retirement_speech", "I have fought in your shield wall and done well by it, but your decisions are not always to my liking. Anyway, I have another task. I will take what plunder I have won and raise a shield wall of my own. Then I will sail to Friese, where I shall recover my land. I wish you well."), #Reginhard
  ("npc9_retirement_speech", "We have fought well together and earned much glory, but I have some reservations about your leadership. At any rate, I have to kill that witch-snake spouse of my father. I will be leaving you. Perhaps we will meet again."), # Clovis
  ("npc10_retirement_speech", "I've had enough of tramping up and down the length and breadth of these lands. I've earned enough to buy a small bit of land somewhere far from the hateful Welsh, so I think I'll give that a try. So long, and best of luck to you."), #Ceawlin
  ("npc11_retirement_speech", "You have been very kind to me this whole time, but I... I am unable to endure the pain of {reg59?envy:love}. I beg your pardon, but I can no longer have you in my sight, since I know I forever can be nothing more than a lesser light before you. {reg59?:Moreover, as I am a skjaldmo, I have to preserve my virginity. }So I'll be off, although I don't know to where. Farewell, {reg59?my pretty:handsome}."), #Solveig
  ("npc12_retirement_speech", "I've done all right in your shield wall. I've filled my belly, put some silver in my purse, and broadened my knowledge of wounds and injury. I can't complain about that, but I think right now that service in this shield wall is holding me back. I have a duty to share my findings with other doctors, and for that, I need to hire scribes that have an excellent understanding of Latin. These are rare in Englaland, so I will be going to Rome."), #Asbjorn
  ("npc13_retirement_speech", "I would like to inform you that I wish to sever our relationship. I intend to seek alternative employment; perhaps join my fate to that of the Rus."), #Helgi
  ("npc14_retirement_speech", "As the lustre of your name grows ever brighter, I fear that my own reputation will pale in comparison, as the moon is outshone by the sun. I have decided to strike out on my own. The very best of luck to you!"), #Ailchu
  ("npc15_retirement_speech", "I appreciate that you took me on, but I'm not altogether happy about how things have worked out. I'm going to head off elsewhere -- maybe go home to Konstantinoupolis, maybe find another job. I haven't quite decided yet."), #aghatinos
  ("npc16_retirement_speech", "You and your men are a lost cause to the faith. I see that your souls are already taken by the Devil, since many of you uphold the ways of the old false pagan gods. Even my word was unable to change you and your evil ways, so I can only hope that God will have mercy upon you despite your terrible sins. I leave now."), # Beda

  ("npc1_rehire_speech", "Warlord, it's good to see you again. I know we had our differences, but now I recognize that those were some of the best days I've known. And, to tell you the truth, I've had a bit of difficulty finding work. Listen, if you're willing to have me back, I'd be willing to sign up with your shield wall again."), #Caio
  ("npc2_rehire_speech", "{reg59?Madame:Sir}! It's good to see you again! Actually, I confess, I've been looking for you. I spent all my money and need more. I guess I'm just destined to fight for a living. People tell me that you, on the other hand, have done very well for yourself. So tell me, {reg59?madame:sir}, will you have me back?"), #Egil
  ("npc3_rehire_speech", "Well, hello {reg59?madame:sir}! It is very good to see you again. I have not fared so well since we parted, I am afraid. My savings from the time we travelled together, which I hoped would give me a start in trading, have not been enough to start a decent business. And, I must say, I fear being turned again into a slave. Perhaps I am better suited to war than to commerce, to share a meal over a campfire with rough fellows than to drink mead. {reg59?Madame:Sir}, I must ask you -- will you take me back?"), #Brunhild
  ("npc4_rehire_speech", "It's been a while. You've done well for yourself, I hear. I know there's been some bad blood between us, but I'd be honored to fight in your ranks once again."), #Donnchadh
  ("npc5_rehire_speech", "{playername}! Your fame grows ever greater -- even as far as my homeland, beyond the mountains. I'd returned there, hoping that my exile would have been forgotten. Well, it hadn't. Even before I set foot in my valley, I received word from my family that there were warriors looking for me in case I crossed the kingdom's border. So I've returned, hoping you might forget any harsh words I may have spoken, to see if I could fight with you once again."), #Morgant
  ("npc6_rehire_speech", "It is good to see you, {playername}. Everywhere I go, men are in awe of your deeds. I have not had it so well since I left. Wherever I go, I feel my former demons returning. My soul is in turmoil. For reasons that I cannot fully explain, I had found peace in your company. Will you allow me to serve with you once again?"), #Bodo
  ("npc7_rehire_speech", "Warlord! It is good to see you. Unfortunately, even with all the money I saved from my share of the loot, the absurd taunt of being a traitor and a woman was still directed at me. No Pictish warrior would consider joining a war band lead by me. Dammit, that's just the way life goes, I guess. Will you have me back?"), #Dwywei
  ("npc8_rehire_speech", "Greetings to you, {playername}. I was wondering if the harsh words between us in the past could be forgotten. I could not find thirty men to crew a ship, and those whom I gathered quickly got bored and wandered off -- not, I will add, before they drank away such silver as I had accumulated. Then I thought back to the battles we fought together. Those were good days, and profitable ones, too."), #Reginhard
  ("npc9_rehire_speech", "My dear, dear {reg59?lady:man}! It is so good to see you! I sought service with the lords of this land, but was grievously disappointed. Half of them ask me to carry gifts to fellow lords, as if I were a simple errand boy, or to beat down lazy peasants, as if I were a farm overseer. One even asked me to murder one of his rivals! Those are no kind of activities for a brave warrior like me! So I have been seeking you, to see if you might wish me to join you again."), #Clovis
  ("npc10_rehire_speech", "Dryhten! It's good to see you again! It turns out I'm not much of a farmer. Too soft on the hired hands, I figure. I let them rob me blind. I guess fighting is what I know best, even if accompanied by Britons and Mercians. So tell me, Dryhten, are you still looking for good men?"), #Ceawlin
  ("npc11_rehire_speech", "{reg59?My pretty:Handsome}, I've thought a lot since we parted. Now I know in my heart that, even if sometimes we cannot get what we most desire, it is better to live close by than far away from it. Perhaps there is hope left, after all, that your company will be good for me. So, {reg59?my pretty:handsome}, will you take me back?"), #Solveig
  ("npc12_rehire_speech", "Warlord! It's a fine thing to see an honest face like yours, for this world is so full of lies! I went Rome to publish my findings, hired some scribes and made a handful of codices. Then I waited for the commissions, but it turns out that the philosophers don't care about real medical knowledge and instead prefer to discuss quasi-magical theories. I'll keep trying, but first need to replenish the money in my bag. Are you looking for a physician?"), #Asbjorn
  ("npc13_rehire_speech", "It is so good to see you. When last we parted, I practically swore that I would not serve you again. Perhaps I judged you too harshly. I have tried serving in other jarls' armies. Believe me; what I have seen of them restores my opinion of your leadership. If you will have me in your shield wall, I will fight for you again."), #Helgi
  ("npc14_rehire_speech", "Well, hello there, valorous one! I have been hoping to see you again. Everywhere I go, I hear tales and songs of your deeds. I admit that I felt a twinge of regret that we had parted ways and, I'll confess it, a twinge of jealousy as well. I thought that I might once more fight by your side and thus bask in the reflection of your glory. Perhaps we might ride together again for a little while."), #Ailchu
  ("npc15_rehire_speech", "Why hello, strategos! I can't say I'm displeased to see you again. You see, I could not find a ship to take me to the continent, and so I took on another contract before I left, and, sure enough, when it came time to collect the pay, the lord had nothing but talk and excuses and petty little complaints about my handiwork. I can't say I was always happy in your shield wall, but at least you put silver directly into my purse after every battle. Are you still offering work?"), #aghatinos
  ("npc16_rehire_speech", "I am here to offer another chance to you and your men. An angel came to me in a dream, and told me the future of your immortal soul. The angel said that your only chance of eventually going to Heaven lies entirely upon my work as a preacher. You are my responsibility. So, I beg you to accept me again in your shield wall. Maybe this time you will pay heed to the word of God."), #Beda
  
#local color strings
  ("npc1_home_intro", "Warlord, perhaps you didn't know this about Hadrian's Wall. Near here is a cave where I was born eighteen years ago. This is a special place that we should stop and visit, for it has long history. Romans, those legendary warriors, dwelt here."), #Caio - Hadrian Wall
  ("npc2_home_intro", "Ribe! That's where I was born twenty years ago. Son of a king and yet a slave, but the best skald in all Danmark."), #Egil - ribe
  ("npc3_home_intro", "Can you smell that? It is the smell of evil. It is the smell of Kennemer. How I hate that place! I spent the worst years of my life there. Just being around this site makes me nauseous."), #Brunhild - kennemer
  ("npc4_home_intro", "Perhaps you didn't know about Dun Onlaigh, a magnificent Dal Riata fortress."), #Donnchadh - Dun_Onlaigh
  ("npc5_home_intro", "Oh, perhaps you didn't know this about Din Tagell, one of the mightiest forts of Cornubia. I served in the shield wall of its lord, as a dryhten, long before I was forced into exile."), #Morgant - Dol Is
  ("npc6_home_intro", "Perhaps you don't know about Cantwareburh, in the kingdom of West Seaxe. This is the city where the ship, the Woden Ric, should have brought me, but the Viking attack near the coast of Friese changed all that. Changed my fate forever."), #Bodo - Cantwareburh
  ("npc7_home_intro", "Pay attention, and be careful. We are now in Alban, near Dun Taruo. The kingdom of Alban is the most powerful in the north."), #Dwywei - Dun Taruo
  ("npc8_home_intro", "We are in the kingdom of Friese, where Dorestad is the main town. Years ago, we Frisians were subjects of the Franks, but later, a Dane became king. Well, really, Frisians do not recognize these kings, but have to accept their power. We prefer to live."), ##Reginhard , frisio, dorestad
  ("npc9_home_intro", "Behold the horizon, for there lies the fortress of Rendlaesham, seat of power of the kings of East Engle."), #Clovis - Rendlaesham
  ("npc10_home_intro", "Look, the trading town of Lundenwic, home to the Saxons of East Seaxna. This beautiful site has a glorious past and, I might bet, a bright future."), #Ceawlin - Lundenwic
  ("npc11_home_intro", "That smell is of salt and the sweat of the people that work the sea. It is the warmth of home... Tunsberg."), #Solveig - Tunsberg
  ("npc12_home_intro", "Perhaps you don't know about Heidabyr, if that interests you."), #Asbjorn - Heidabyr
  ("npc13_home_intro", "East, past the land of the Norwegians, are my people, the Sviar, a warlike and strong people. Our destiny is to rule others."), #Helgi - Svia
  ("npc14_home_intro", "Ah, Caiseal! Such a lovely spot, at the foot of the Eriu. The region of Mhumhain, or Munster, is certainly the most poetic and beautiful part of what Romans called Hibernia."), #Ailchu - Caiseal
  ("npc15_home_intro", "Do you see that small settlement over there? It is Hordaland."), ##aghatinos - #Hordaland
  ("npc16_home_intro", "Oh my God! That is Witan Ceaster. I lived near here, in a village. My parents, travelers, could not take care of me and gave me to the monks of Witan Ceaster."), #Beda - Witan Ceaster


  ("npc1_home_description", "My name, Caio, has passed from generation to generation. The first who had it was an ancestor of mine, descended from a man named Virio, who was the grandson of a man who had served defending the wall."), #Caio
  ("npc2_home_description", "People say that the Danish are a bunch of bloodthirsty men, but they have a good head for trade, if you ask me. People up and down the coast produce pottery, textiles and leather. Ribe is also famous for its women, if you understand what I mean."), #Egil
  ("npc3_home_description", "Kennemer is a Danish fort now, but it was not always so. In fact, before the Danish, the Franks ruled from there. We Frisians did not like the Franks as much. They imposed their religion, Christianity, and their lords are very controlling. So when the Danish first came, we did not mind. These masters are a little more indulgent, allowing use more freedom as long as we pay tribute."), #Brunhild
  ("npc4_home_description", "You know I do not talk much, but I would say that I am proud to be a Scot of the Dal Riata. You've heard many stories about the Scots, or maybe none. People thought we were just pirates who looted the coast, and cursed us for it. Then came the Norwegians, who are worse."), #Donnchadh
  ("npc5_home_description", "Cornubia used to be a strong kingdom called Dumnonia. People from Dumnonia usually call themselves 'Defnas,' which simply means 'men of Dumnonia.' Our land was famous for the high quality of tin extracted from its many mines. Now our kingdom is small and poor."), #Morgant
  ("npc6_home_description", "You know that Cantwareburh was the capital of the kingdom of Cent until very recently. I read about this before I came here, and I talked to a Saxon scholar who had been invited to Asturias. In my kingdom, we call everybody here 'Saxons,' but, really, in Cent lived Jutes, people who preceded the Saxons from across the sea."), #Bodo
  ("npc7_home_description", "The Kingdom of Alban is simply a merger of two people: the Dal Riata, people who migrated generations ago from Hibernia, and us Picts. Our nobles and kings have become so mixed that we are now one kingdom. The common people have their differences yet, for there are many years of war between us."), #Dwywei
  ("npc8_home_description", "Frisians are a reserved people. They like to be left alone to their affairs, and the Danish are better lords than the Franks. As long as we pay taxes and accept their authority, they leave us alone."), #Reginhard
  ("npc9_home_description", "The kings of East Engle are from the Wuffing dynasty, descended from the legendary king Wuffa. Their origins lie with the Geats, as in the tale of Beowulf. They were the most powerful of the Anglo-Saxon kingdoms back in the day, but not any more. Now they are just servants of the Danish."), #Clovis
  ("npc10_home_description", "Here once stood Londinium, the Roman capital of Britannia. Lundenwic lies very close to the ruins of Londinium, of which now remains a fort usually called Lundenburh. Its name means 'trading town of Londinium,' or simply, as we Saxons say, 'London.'"), #Ceawlin
  ("npc11_home_description", "I'm from here, you know. I think I have managed to become such a fine warrior by your side because war runs thick in the blood of every man and woman of Northvegr. These are times of war in this land. The jarls fight each other constantly."), #Solveig
  ("npc12_home_description", "Heidabyr is not the oldest site in Danmark, but it is becoming important. Actually, it was founded a few generations ago by Rerik merchants. The fled here when their city was destroyed by King Gotrik."), #Asbjorn
  ("npc13_home_description", "While the Danes and Norwegians focus on the west, the Svia look east to the land of the Slavs and beyond, even to the rich trading city of Mikligard."), #Helgi
  ("npc14_home_description", "This is the home of the best bards from these lands. Even small boys and girls from this kingdom sing better than the bards from the rest of world. Many of the people also respect the old traditions and gods, and thus Munster is the most prosperous land in all of Eriu."), #Ailchu
  ("npc15_home_description", "Hordaland is one of the small kingdoms in Northvegr. It is led by Eirik Konungr, who was my master. I know him well. He's a tough man, violent and loving nothing more than the independence of his kingdom. So he doesn't like the vow of Harald Tanglehair to unify Northvegr under one king."), #aghatinos
  ("npc16_home_description", "Witan Ceaster is the capital of the Saxons of West Seaxe. West Seaxe is now the most powerful kingdom in Britannia or Englaland, as our land is called. With Mierce weakened, West Seaxe is the only kingdom that can stop the Danish."), #Beda

  ("npc1_home_description_2", "Since then, it has passed from father to son. My father, the old Roman that you met, is called Caio. The name will not be lost, for all my brothers are also called Caio. My mother called us Caio Maior, Caio Secundo, and Caio Minor in order to distinguish us."), #Caio
  ("npc2_home_description_2", "Someday I'll buy a farm near Ribe. I will marry two or three women and dedicate myself to making children. Or maybe not. I may soon get bored of it..."), #Egil
  ("npc3_home_description_2", "But now it seems that the Danish may be worse, in fact, than the Franks. Many Frisians have rebelled against their dominion. The Danish are people who take what they want, regardless of who is harmed, and they value their strength above our laws. I hate them! They made me a slave!"), #Brunhild
  ("npc4_home_description_2", "The truth is that, for many Gaels, to become Scots was a way out of poverty, especially in such a closed society like Eriu. We joined a brotherhood and threw ourselves to the dangers of the sea. Looting and robbery were our ways. It was not very different from what others are doing today, but we were never as bloody as the Norwegians."),#Donnchadh
  ("npc5_home_description_2", "We only have the memories and history. Do you know that Din Tagell was the place where they say the man, Arthur, whom the bards sing about, was born?"), #Morgant
  ("npc6_home_description_2", "The Jutes conquered this land from the Britons after Rome left Britannia. Curiously, the Danish, who are the Jutes' relatives, or perhaps their descendants, are now their enemies and attack this land. I remember long afternoons with the Saxon scholar, an old man named Bedda, who informed me of this part of the world and prepared me for my trip."), #Bodo
  ("npc7_home_description_2", "The Picts are fine shepherds and hunters, but these Dal Riata are a clan of pirates, Scots. But I should not say that, since we are now fighting on the same side and for the king himself."), #Dwywei
  ("npc8_home_description_2", "Many of us prefer our own government, without the interference from either the Franks or Danish, but this is impossible as long as we are divided and unable to raise an army. Our aethelings, our noblemen, prefer to serve the Danish. Without an aetheling to lead us, the frilings, the freemen, are unable to organize. Perhaps our fate is to be dominated by other people forever."), #Reginhard
  ("npc9_home_description_2", "They harbor a great hatred against the rival kingdoms. Curiously enough, their territory is one of the few parts of Britannia where rainfall is sparse and the climate is dry. I am not really sure if you will ever want to fight their warriors for such a piece of land. I don't think it'd be worth it."), #Clovis
  ("npc10_home_description_2", "The mouth of the river Fleet serves Lundenwic as a harbour for both trade and fishing. Merchants from all the nations of Europe are slowly flocking to Lundenwic in search of good commercial opportunities. And here, the old gods are still very well respected, but I should not say any more about that..."), #Ceawlin
  ("npc11_home_description_2", "A young lord from Tunsberg, Harald Tanglehair, intends to rule over all Northvegr. He is smart and ruthless -- like you, {reg59?my pretty:handsome}! Then, he says, he will finally comb his head and marry Gyda Eiriksdottir, but of course he'd have to kill her father first. Anyway, Tunsberg is an important center of commerce, and I'm sure you'll find many trade goods and news from all over the world. Shall we go?"), #Solveig
  ("npc12_home_description_2", "I am sure that King Gotrik's name sounds familiar to you, no? He was a famous man because, fearing an invasion of the Franks from the south, he built an enormous structure to defend Danmark. We called it the Danavirki. It is an important linear defensive earthwork constructed across the neck of the Danmark peninsula."), #Asbjorn
  ("npc13_home_description_2", "Anyway, I will not bore you with long talks. We could talk until the time that Midgardr ends and Ragnarok comes, ha!"), #Helgi
  ("npc14_home_description_2", "Their nobility, of which I am also part, I must admit, is also the noblest of the nobilities. This is because all of us have at least one drop of the blood of the nine goddesses that bless our homeland within us. These goddesses are: Anann, Aine, Grian, Cliodhna, Aimend, Mor Muman, Bebinn, Aibell, and the infamous, but extremely beautiful Queen Mongfind. Settle here, oh valorous one, and someday one of those goddesses might come to your bed in the dark of the night, just as Mongfind came to me twelve winters ago."), #Ailchu
  ("npc15_home_description_2", "Eirik is the father of Gyda, the beautiful girl who put the thought of unifying Northvegr in Harald's head. Now the silly boy will not allow comb to touch his head until he wins her hand. She's a regular Helen of Troy. Perhaps you should go there to see her for yourself."), #aghatinos
  ("npc16_home_description_2", "I grew up in Witan Ceaster, played in its muddy streets when not forced to study, and I loved running around the stalls when we went to the market. Witan Ceaster was an important town in Roman times, I read, but it was almost abandoned later until King Cenwalh built its first church. He was also the king who brought Christianity to West Seaxe, for which he repudiated his first wife, the sister of pagan King Penda of Mierce."), #Beda

  ("npc1_home_recap", "I'm from near Hadrian's Wall, where I lived in a cave."), #Caio
  ("npc2_home_recap", "I was born in Ribe, in Danmark. I'm a warrior, the son of a king and a slave."), #Egil
  ("npc3_home_recap", "I used to live as a slave in {s20}, but I spent my childhood in Doccinga, where I was really happy. I just hope my father, Thonkrik, does not think badly of me, as I have had to live as a slave... They would have killed me if I had not obeyed the jarl's orders. A parent should never know how low his children have fallen."), #Brunhild
  ("npc4_home_recap", "I am a Scot and a Dal Riata."), #Donnchadh
  ("npc5_home_recap", "I was born in Cornubia, but have been forever exiled from my homeland. Only with your shield wall am I allowed to travel there -- without, that is, using a disguise."), #Morgant
  ("npc6_home_recap", "I am from Cantabria, in the Kingdom of Asturias, as you know. It is in the north of Hispania. We are warlike people who, when not killing Muslims, are dedicated to killing each other, supporting one king or another. Our current king is Aldefonsus, son of Ordonius. Ordonius was a good king, but he died recently. I hope his son is a worthy successor."), #Bodo
  ("npc7_home_recap", "I was born in Dun Taruo, in the Kingdom of Alban."), #Dwywei
  ("npc8_home_recap", "I was born in Friese and never thought I would leave it. My father was a friling, a free man with a plot of land. I inherited the land but sold it when my family all died. Now I have nothing but the strength of my hands."), #Reginhard
  ("npc9_home_recap", "I am from the continent, and my people call themselves Franks."), #Clovis
  ("npc10_home_recap", "I am a Saxon, not an Angle, from Lundenwic."), #Ceawllin
  ("npc11_home_recap", "Why, {reg59?my pretty:handsome}? I am from Tunsberg, in Northvegr."), #Solveig
  ("npc12_home_recap", "I am the younger son of a hersir in Odinsve. I traveled to Frankia and Rome in search of medical lore."), #Asbjorn
  ("npc13_home_recap", "I am a Svia. My people are destined to reign over all the east. The Danish will be destroyed quickly if their kings still covet our land."), #helgi
  ("npc14_home_recap", "Oh, from the most magnificent region of Mhumhain, in the southern part of Hibernia, land of bards and goddesses."), #Ailchu
  ("npc15_home_recap", "I come from Konstantinoupolis, the most beautiful and largest city in the world. The largest towns here are but small villages compared to Konstantinoupolis. Heck, one could practically fit in the Hagia Sofia, the main church there. You should travel there someday."), #aghatinos
  ("npc16_home_recap", "I lived in Witan Ceaster for many years. That city brings back great memories, but I know my place is not there."), #Beda

  ("npc1_honorific", "Warlord"), #Osmund
  ("npc2_honorific", "{reg59?Madame:Sir}"), #Aleifr
  ("npc3_honorific", "{reg59?Madame:Sir}"), #Eithne
  ("npc4_honorific", "{reg59?Madame:Sir}"), #Donnchadh
  ("npc5_honorific", "{reg59?Madame:Sir}"), #Morgant
  ("npc6_honorific", "Dux"), #Bodero
  ("npc7_honorific", "Leader"), #Dwywei
  ("npc8_honorific", "{playername}"), ##Reginhard , frisio
  ("npc9_honorific", "My good {reg59?lady:sir}"), #Clovis
  ("npc10_honorific", "Dryhten"), #Ceawlin
  ("npc11_honorific", "{reg59?My pretty:Handsome} -- I mean warlord"), #Solveig
  ("npc12_honorific", "Warlord"), #Asbjorn
  ("npc13_honorific", "Warlord"), #Helgi
  ("npc14_honorific", "Captain"), #Ailchu
  ("npc15_honorific", "Strategos"), #aghatinos
  ("npc16_honorific", "{reg59?Madame:Sir}"), #Beda
   
  ("npc1_kingsupport_1", "That's a great idea, Warlord. All these men and landed nobles who rule now, with their prisons and gibbets and scaffolds, whip, brand or hang any man who might be driven by the crying of his children to steal a loaf of bread, or maybe a horse. This land deserves something better."), #Caio
  ("npc2_kingsupport_1", "Well, warlord, I'd support you. I think you'd give this world the kind of enlightened rule that it has long needed."), #Egil
  ("npc3_kingsupport_1", "Well, my {reg59?lady:lord}, I would worry for you. Our histories tell us that power tends to corrupt, but in the end, I am comforted by the mercy and judgment you have shown as lord of this shield wall."), #Brunhild
  ("npc4_kingsupport_1", "I think that you would be the kind of {reg59?queen:king} that well-born warriors such as I would be proud to follow into battle."), #Donnchadh
  ("npc5_kingsupport_1", "A fine idea! You have shown that you know how to govern men. Mind that you govern them justly, though..."), #Morgant
  ("npc6_kingsupport_1", "I cannot judge the legal merits of your claim. However, I think that, unlike the other kings here, you have the capacity to unify this land. That would put a stop to these endless wars between kingdom and kingdom, noble and noble, and brother and brother, that have brought us all into disgrace in the eyes of the gods."), #Bodo
  ("npc7_kingsupport_1", "Aye, you'll do well. You know how to treat trackers, Picts, and women."), #Dwywei
  ("npc8_kingsupport_1", "The Saga of Beowulf tells us that a man who does deeds greater than those of the other men of his time may claim a throne for himself. I'd say that you could make that claim."), #Reginhard
  ("npc9_kingsupport_1", "Very good, Dryhten. I'm a Frank by blood, but Dagobert didn't support me when I was cheated of my inheritance. So I don't owe him anything, and I would be more than happy to have you as my {reg59?queen:king}."), #Clovis
  ("npc10_kingsupport_1", "Well, warlord, I suppose Englaland really needs a powerful king. The Welsh and Angles are but weaklings and idiots, while the Saxons, incomprehensibly, can't seem to unite to conquer the whole land."),#Ceawlin
  ("npc11_kingsupport_1", "Why, that's a fine idea, {reg59?my pretty:handsome}! I suppose I shall have to learn to call you 'King' or 'Konungr,' then... Which I'd be more than happy to do if you called me 'Royal {reg59?Companion:Consort}.'"), #Solveig
  ("npc12_kingsupport_1", "I am sure that you would make a fine king, warlord. I flatter myself that I am a good judge of character, and you have demonstrated a capacity for compassion that far exceeds that of these others who call themselves monarchs."), #Asbjorn
  ("npc13_kingsupport_1", "Well, {reg59?madame:sir}, the heavens have instituted a hierarchy in this world. Normally, I would have no truck with usurpation, but I also think that the kings of this land are a weak and sorry lot, not worthy the name of king. Circumstance leaves the crown free to be taken by a better ruler, such as you."), #Helgi
  ("npc14_kingsupport_1", "That would be a fine thing, {reg59?my lady:sir}! Many are the tales of kings that proved their worthiness to wear a crown through valor and courage. Perhaps you know the tale of Cu Chulainn, whose bravery and feats of arms are unparalleled in Hibernia and Britannia. A splendid tale!"), #Ailchu
  ("npc15_kingsupport_1", "Well, you pay your men on time, when you can, generally speaking. That's the best qualification for kingship there is, in my book. You also show some respect for the rights of others."), #aghatinos
  ("npc16_kingsupport_1", "It seems to me that you hear my words and that your soul stirs before Christ's teachings. Yes, I am sure that God not only approves but is planning your ascension as a rightful king over the sinful people of these lands."), #Beda
  
  ("npc1_kingsupport_2", "Sure would, warlord, but let me tell you what might bring others to your cause -- particularly us poor folk. They tell us that in the old days, the great Roman lords -- they were called governors, or maybe senators, I can't remember -- would, upon ascending to power, issue amnesty for all but the worst prisoners in the land's dungeons, giving people a second chance to make something of themselves."), #Caio
  ("npc2_kingsupport_2", "Most of the lords of this land, well, let's just say that they never held a pening that they didn't keep as rent or loot. You, on the other hand, have some experience of commerce and trade, due to acting as warlord and managing your domains. If you like, warlord, I reckon I could find some support for you among the men of this realm."), #Egil
  ("npc3_kingsupport_2", "I would, my {reg59?lady:lord}, but I would ask you to establish at least a minimal amount of rights for slaves. They need to be protected from further abuse. You know I was a slave, and we are the most abused people in the land. Slaves really need to be protected by a rightful and fair ruler."), #Brunhild
  ("npc4_kingsupport_2", "Of course, warlord. The trick is now to get others to follow you. As you know, one's lineage is a great determinant of one's worthiness. Perhaps you have a long-lost ancestor of whom you have not told me..."), #Donnchadh
  ("npc5_kingsupport_2", "I would, but there is something I should say on behalf of men that have been wronged like I have. There must be a way for feuding nobles to have their disputes resolved without bloodshed. I lost everything I cherished in life because the only honorable option my king had left me was to murder my enemies. There should be some kind of law, some kind of... common law, to settle this kind of feud, or, maybe, any kind of dispute. That law would be based on the uses and customs of the land."), #Morgant
  ("npc6_kingsupport_2", "I would. I would tell anyone who listens of your deeds on behalf of the weak and helpless and of your ability to lead men against great odds and triumph. I would tell them that, if you were to become {reg59?queen:king}, there would be one law and one peace -- from the Pictish highlands to the Goidelic woods, from the lowlands to the southern shore. But you must have the goal to go further and reunite what was once a glorious empire, to rival that of Rome."), #Bodo
  ("npc7_kingsupport_2", "Yes, warlord, I would. A {reg59?queen:king}'s duty is to adequately respect all men and women that serve under {reg59?her:his} banner. You have proven more than able to do this, for, to you, the hunter and the tracker, the woman and the Pict, are as important as the warrior and the soldier, as the man and the Briton."), #Dwywei
  ("npc8_kingsupport_2", "I would -- on one condition. You'd be king wherever you want to rule, but after you are installed in your hall and your rule is unchallenged throughout the land, you will help me to free Friese."), ##Reginhard , frisio
  ("npc9_kingsupport_2", "I would, warlord, and others would, too. But here's what I think -- you need to show the noble lords that you'll uphold their ancient rights. Right now, these lands are a mess. A lord owns the land, except it's the king who owns the forest, but the city has the right to levy tax at its gates, yet any commoner can use the pastures on odd Tuesdays, except in Pictland, where there is not so much as a notion of order at all. So I say you make things simple, like it was in the old days before even the Romans conquered Britannia. First the {reg59?sovereign:king}, then the lords, then everyone else."), #CLovis
  ("npc10_kingsupport_2", "Certainly, dryhten, but I'd ask that you consider an idea of mine. If you became {reg59?queen:king}, then I'd ask you to open your court to Saxon nobility only. The others are weak, fragile and cowardly, and their only place in your kingdom should be as peasants, servants or slaves."), #Ceawlin
  ("npc11_kingsupport_2", "Of course I would! I am sure, by the way you act, command and fight, also by the way you walk, and speak and love... that you are the only person worthy enough to become Brytenwalda."), #Solveig
  ("npc12_kingsupport_2", "Of course, warlord, but if I have learned anything in my travels in this land, it is that Vikings, Saxons, Franks, and all else are sticklers for tradition. These traditions vary from one to the other, but they all remember something of the old Roman Empire, especially the Franks, who are said to be its heirs."), #Asbjorn
  ("npc13_kingsupport_2", "I would indeed, {reg59?madame:sir}. I think you can unite this land, and then we'll be able to raise an army such as Englaland has never seen -- Saxons, Angles, Picts, Norse, Goidels and even Britons, all together in one strong and invincible shield wall. We will travel to the continent in strong sea vessels to subdue all the lands of the Franks!"), #Helgi
  ("npc14_kingsupport_2", "Of course, my {reg59?lady:lord}. Also, when claiming a throne, it does not hurt to be the subject of an epic poem, recited around camp and hearth fires, describing one's heroic deeds. As you no doubt know, I fancy myself a fair crafter of couplets. You could be as famous as Cu Chulainn, if only you let me sing of your deeds."), #Ailchu
  ("npc15_kingsupport_2", "I would. People might say that perhaps you don't have royal blood in your veins, but from what I've seen, royal blood makes one essentially a beggar. Kings and nobles take out loans or commission building projects without half a thought to how they're ever going to pay back all those commoners who expect little more than to eat after an honest day's work. If you ask me, an honest tongue makes a {reg59?woman:man} a {reg59?queen:king}, not a fancy pedigree."), #aghatinos
  ("npc16_kingsupport_2", "Of course! I know that you plan to search out and burn any remnant of heresy and paganism in these lands. I know that you will only rest when there is no trace of the Devil in the hearts of your subjects, when every man, woman and child will have only the Holy Bible as their guide, as properly interpreted by a priest. Is your soul so pure as to do as I say?"), #Beda
  
  ("npc1_kingsupport_2a", "Please go on..."), #Caio
  ("npc2_kingsupport_2a", "Please continue..."), #Egil
  ("npc3_kingsupport_2a", "I'm interested in hearing it..."), #Brunhild, frisia
  ("npc4_kingsupport_2a", "Of course! Let me tell you all about him..."), #Donnchadh
  ("npc5_kingsupport_2a", "Please go on..."), #Morgant
  ("npc6_kingsupport_2a", "Splendid! That was exactly what I was thinking."), #Bodo
  ("npc7_kingsupport_2a", "Well, yes, I try to be fair to everyone..."), #Dwywei
  ("npc8_kingsupport_2a", "Fair enough."), ##Reginhard , frisio
  ("npc9_kingsupport_2a", "That seems sensible enough..."), #Clovis
  ("npc10_kingsupport_2a", "Of course! Everyone knows only Saxons are fit to be nobles."), #Ceawlin
  ("npc11_kingsupport_2a", "Tell me more."), #Solveig
  ("npc12_kingsupport_2a", "Interesting. Please go on..."), #Asbjorn
  ("npc13_kingsupport_2a", "Please go on..."), #helgi
  ("npc14_kingsupport_2a", "Very good, captain."), #Ailchu
  ("npc15_kingsupport_2a", "Well spoken, Strategos!"), #aghatinos
  ("npc16_kingsupport_2a", "Of course I am. We are nothing but instruments of God."), #Beda
   
  ("npc1_kingsupport_2b", "Forget it."), #Caio
  ("npc2_kingsupport_2b", "I do not ask for their support, as they would no doubt wish to make a profit on the transaction."), #Egil
  ("npc3_kingsupport_2b", "I have no intention of helping any more slaves, sorry."), #Brunhild
  ("npc4_kingsupport_2b", "I don't have any, unfortunately."), #Donnchadh
  ("npc5_kingsupport_2b", "No, I believe the lords should resolve their disputes by blood, and blood only. Laws are only useful to the weak."), #Morgant
  ("npc6_kingsupport_2b", "I am sorry, but my future kingdom will not meddle with continental affairs."), #Bodo
  ("npc7_kingsupport_2b", "Sorry. I respect you for your abilities, but warriors, men, and Britons are much more deserving than others."), #Dwywei
  ("npc8_kingsupport_2b", "That's a pretty tall condition. By the time I am {reg59?queen:king}, Friese will probably have freed itself from the Danish."), ##Reginhard , frisio
  ("npc9_kingsupport_2b", "I'm not sure that implementing your idea would be as 'simple' as you think"), #CLovis
  ("npc10_kingsupport_2b", "You are out of your mind. There are valorous and noble men from every nation."), #Ceawlin
  ("npc11_kingsupport_2b", "I do not want to be a Brytenwalda. Forget it."), #Solveig
  ("npc12_kingsupport_2b", "Enough, sir. I will not have you mock our traditions."), #Asbjorn
  ("npc13_kingsupport_2b", "Actually, I was looking forward to a bit of rest after becoming king. I want nothing to do with the rest of Europe!"), #Helgi
  ("npc14_kingsupport_2b", "Hmm. I'm not sure about that. Cu Chulainn had a tragic and early death. I don't want to be linked to him."), #Ailchu
  ("npc15_kingsupport_2b", "{reg59?Queen:King} of the weak and the poor, maybe. Enough of such talk."), #aghatinos
  ("npc16_kingsupport_2b", "No disrespect, but I'm not as sure that's what I'd do. Perhaps God would not like that at all."), #Beda
  
  ("npc1_kingsupport_3", "If I could go about this land for a few weeks, I'd tell the common folk that you would give amnesty to their kinfolk like the Roman -- um, consuls, I think -- of old. Well, soon they would start talking of you as a rightful king, and that would pave your way to the throne. Shall I do that, warlord?"), #Caio
  ("npc2_kingsupport_3", "If you like, warlord, I can take a few weeks to visit the areas where I have contacts. I'll explain to them that, in you, they will have a {reg59?ruler:king} who will check the rapacious nobles, who, with their tariffs and taxes, strangle commerce for the sake of a few extra peningas to spend on their wars and their feasts. What do you say to that, warlord?"), #Egil
  ("npc3_kingsupport_3", "If you were to protect the poor slaves, even slave girls, I am sure most of the common people would see you as a kind and just {reg59?queen:king}. So, if you can give me a few weeks, I will travel the countryside, telling every poor man and woman that fears enslavement due to debt or war that, under your rule, they would still have protection and rights."), #Brunhild
  ("npc4_kingsupport_3", "I shall travel about the villages and forts over the next several weeks and spread word of your rights. Of course, I hope that you will remember your faithful subject when it comes to distributing lands after you are a crowned and powerful monarch."), #Donnchadh
  ("npc5_kingsupport_3", "Anyway, {reg59?lady:lord}, if I could take a few weeks, I'd let men know that, when you are {reg59?queen:king}, you will institute a common law, based on tradition and customs, to resolve the disputes within the realm, be they about nobles or commoners. I am pretty sure they will all be more than happy to support your claim, since you will bring justice consistently to all the lands under your rule."), #Morgant
  ("npc6_kingsupport_3", "Very well. Although I am now a stranger to my family, I have entered many a noble's hall in your train, and I reckon I would be welcome again. I shall go about this land and tell the nobles that, when you are {reg59?queen:king}, you will strive your hardest to protect the weak and crush discord, so that no man will raise his hand against another with impunity, and one day, perhaps, Britannia will rule over all the world."), #Bodo.
  ("npc7_kingsupport_3", "I'll tell you what, warlord. Give me a few weeks and I'll go to some of the villages -- stinking hovels that they are, but, anyway, I'll tell the people there that once you unify this land, every man and woman, of every profession and business, will be equally treated and respected when in your service. This way, all will reckon you as a {reg59?woman:man} whose claim to the throne is supported by fairness and justice."), #Dwywei
  ("npc8_kingsupport_3", "Good! Then give me a few weeks. I'll go about the courts of this land, letting it be known that you're like the legendary warriors of old, and that your strength, courage, prowess and ability alone are more than enough to back up your claim to the throne. Everyone shall speak of you as the new Beowulf, the successor of Arthur himself, the only one capable of bringing peace to this troubled land."), ##Reginhard , frisio
  ("npc9_kingsupport_3", "It's perfectly sensible, {reg59?madame:sir}. We'll be free of those cursed merchants' audiences and petitions and scrolls that take up all of my time and yours, when we should both be out fighting for the glory of your kingdom. Give me leave, and I shall spread word among the noble lords of this land that you're here to restore the old ways. I bet, after that, there will plenty who will follow you into battle."), #Clovis
  ("npc10_kingsupport_3", "Well then, Dryhten, give me leave for a few weeks, and I can go about this land to let every Saxon noble know that Englaland will belong to them, and to them only, when you are their king. I am certain many of them will be more than happy to join your cause, to support a man with such good judgment of people and nobility."), #Ceawlin
  ("npc11_kingsupport_3", "Then, even though it will hurt me more than anything else, let me be apart from you for a little while. I will travel the land singing of your great conquests, both in war and in love. I will tell how you are like Thor himself, and no one else than you deserves to be Brytenwalda. There's many where I come from who are waiting for a worthy ruler, and I can give the rest a little taste of my spear. Give me a few weeks -- even though it will hurt you too, I know -- and I'll have quite a few expecting you to be their next {reg59?queen:king}."), #Solveig
  ("npc12_kingsupport_3", "The crown should go to the one most fit to govern -- which would be you, naturally. Give me a couple of weeks, and I'll write a tract that will prove it. Then I'll find a copyist to post a version in every mead hall in the land. What do you say to that idea, warlord?"), #Asbjorn
  ("npc13_kingsupport_3", "Give me leave for a few weeks, {reg59?madame:sir}, and I will let all the worthy men of this land know that you are the one to unite not just Englaland but all the world. For, according to my thinking, no one should be {reg59?king or queen:king} here unless they have the capacity to rule the entire world, and you alone have demonstrated such a capacity, {reg59?madame:sir}."), #Helgi
  ("npc14_kingsupport_3", "Allow me to leave you for a few weeks, oh gallant one, and I will spin such a tale as would stir even the dullest heart. It will inspire admiration for your virtues, compassion for your hardships, and indignation at those who would stand in your way. I will show that you are a new Cu Chulainn, ready to make the whole world bend to your will. I assume, of course, that I would be able to take a certain amount of poetic license with the details, like when you single handedly defeated that lost Fomorian army the other day?"), #Ailchu
  ("npc15_kingsupport_3", "I'm glad you think so. Here's what I suggest. I know men that depend on their silver, men like me, who've been picked up and shaken down until they can't take it anymore. Here's what I'll tell them -- you're honest. You respect the merchants. You'll pay your debts. You won't beggar your subjects."), #aghatinos
  ("npc16_kingsupport_3", "Give me leave for a few weeks, and I'll do a little tour of every church, abbey and monastery in these lands. The whole Church will know that you plan to exterminate, once and for all, the darkness that still lingers around, outside the light of Christianity. Every man that truly fears God, every good Christian, will then support you as God's legitimately appointed ruler. What do you say to that?"), #Beda
  
  ("npc1_kingsupport_objection", "Warlord, have you given leave to someone else to go tell the nobles that they will have rights over pasture, market, and forest? I can't say I like that. Give him his way, and he'll set up gibbets in every village in the land. On every one of them will dangle some poor sod like me who thought he might pick up a bow, head to the woods and put a bit of meat on his table."), #Caio-Lothar
  ("npc2_kingsupport_objection", "Hmm, warlord. I believe you told someone else that, after you are king, you will help him with something he has in mind. I don't think that his is a good idea at all. He isn't a good man. I do not trust men who drink alone and in silence. They obviously seek to hide what the honesty of mead would reveal."), #Egil-Beda
  ("npc3_kingsupport_objection", "Warlord, that dump has set off on some sort of expedition that he says you approved. He says that he will go about the villages of this land and tell the poor villagers that once you are {reg59?queen:king}, you will treat every man and woman, of any profession, as equals. I was happy for the sake of slaves, but when he heard me, he said that slaves are not equal to anyone but deserve nothing more than whippings and beatings. I really hope you did not say that to him, did you?"), #Brunhild vs Reginhard
  ("npc4_kingsupport_objection", "I have the feeling that you are playing with me! Why else would you send someone else on the same king support issue, no less than that lunatic?"), #Donnchadh-Agathinos
  ("npc5_kingsupport_objection", "Warlord, I overhead what you told, but I think, if you give too many rights and protections to slaves, no one will want to own them any more. Of course, it is possible to live without one, but most rich people really enjoy having one or two slaves to help with the housework and prestige. Nobles also have many, many uses for slaves -- especially the girls. So, you had better not expect rich people and nobles to support you in this matter. It is an inconvenient position for someone that would be {reg59?queen:king}, in my opinion."), #Morgant-Brunhild
  ("npc6_kingsupport_objection", "I understand that you have dispatched Egil to fabricate a claim of royal descent. I have to tell you, I do not think that the Heavens will smile on such an attempt to take the throne by fraud, even if it is with good intentions."), #Bodo-Reginhard
  ("npc7_kingsupport_objection", "I have heard what you told someone else about this issue. I was especially unhappy to hear the part where he said that Picts are only good as peasants or slaves. This is ridiculous. Pictish warriors will tear your kingdom apart in days if you refuse to share land with them. I really hope you have not agreed with this."), ##Dwywei-Ceawlin
  ("npc8_kingsupport_objection", "Warlord, you said that, once you are Brytenwalda, your first war will be against your enemies. This is not right. You should first help me liberate Friese from the Danish. Then both peoples could march against your enemy and share the spoils of the war. Our priority should be Friese."), #Reginhard-Bodero
  ("npc9_kingsupport_objection", "{reg59?Madame:Sir}, it is with great regret that I have learned that you have told another that you plan to institute some kind of common law to govern disputes in your kingdom-to-be. This makes no sense at all, since any enlightened ruler will recognize the perfection of Roman imperial law. Even weak Dagobert I, king of the Franks, tries to impose the Roman law whenever and wherever possible. You should follow his example."), #CLovis-5  
  ("npc10_kingsupport_objection", "I hear that you've told Agathinos that, once you are {reg59?queen:king}, you will assemble an army composed of warriors from every nation and attempt to recreate the old Roman Empire. This is complete nonsense! Just as only ethnic Romans filled the legions, only a true and pure Saxon army has any chance of recovering their glory. No army with Britonnic rabble in its ranks will ever be able to get off the island, much less conquer the continent. Don't expect me to help your wars if you sabotage yourself by putting Saxons and Britons side by side."), #Ceawlin-swedish
  ("npc11_kingsupport_objection", "I hear that another party member is off to sing and spin tales of your glory and fame. I think you're confusing that person with me, because I am plainly the one who sings best among all who are with you. My voice, along with my fame as a skjaldmo, would open halls that most others could only dream of entering."), #solveig - other
  ("npc12_kingsupport_objection", "Warlord, I hear that you've gone and made that monk, of all people, some sort of ambassador. This two-bit preacher is nothing more than a crazy man, a fanatic. He has already informed me that, once your kingdom is established, any kind of medical research will be forbidden. He claims that his scriptures contain all that one needs to know. If you follow his advice, the world will surely fall into a dark age of ignorance and fear. Enough! I have said my piece."), #Asbjorn-Aedh
  ("npc13_kingsupport_objection", "I understand that you've sent someone to proclaim that you intend to free all the miscreants of this land upon your accession to the throne. What a foul idea... Men must be governed with whips and chains -- and the noose, if necessary. You'll find that out the hard way if you become {reg59?queen:king}, I'll warrant."), #Helgi -
  ("npc14_kingsupport_objection", "I hear that you have given that pretty Norse sing-song girl leave to compose ditties that will offend everything the people of this land hold dear. They accuse the old emperors of murder and usurpation. Captain, I know, as a bard, that people must have heroes to emulate, and a golden age to restore. Will you create a kingdom in which cynics and scholars tell us what we must believe? If you teach them not to respect the great rulers of the past, what makes you think they will respect you?"), #Ailchu-Solveig
  ("npc15_kingsupport_objection", "I understand that you've given leave to another to spread some nonsense about you being the new 'Penteyrnedd yr Ynys hon.' I just want to say that, as an educated man, I find it disturbing that you would resort to legends and superstitions to back your claim. Village men and women will believe one thing one day, another thing the next. Now a horoscope, properly cast by an astrologer with a reputation to uphold, might tell you something worth knowing, but those are hard to find in our age of fear and ignorance."), ##aghatinos-Gwenllian
  ("npc16_kingsupport_objection", "I hear that Asbjorn's gone off to sing a pretty song to his people of how you'll hand them Englaland on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. Asbjorn is a pagan and something of a witch. It seems suspicious how he cures the sick. To associate with him can only make everyone think you're a witch, too."), #Beda-Asbjorn
   
#
  ("npc1_intel_mission", "Well, warlord, as it happens, I have a few cousins over in {s17}. Unlike others in my family, they can still stand the sight of me. They deal in furs --- I've even been able to supply them with stock from time to time -- and so they get to pick up a bit of the gossip round the great halls of the {s18}. I could go over there for a few days and tell you what I find out."), #Caio - Bebbanburh
  ("npc2_intel_mission", "{reg59?My lady:Sir}, if you're interested in events in the {s18}, I can make contact with my old friends in {s17}. They're usually well informed about political events."), #Egil - Ribe
  ("npc3_intel_mission", "Warlord, although it has been a long time since I lived in the countryside of {s17} with my father, I still might be able to make contact with some of its older and wiser residents, who enjoyed my father's advice. They are retired merchants, rich farmers, and owners of big herds, the kind of well-to-do people that have some knowledge of politics and affairs. That may tell us much about the state of the {s18}."), #Brunhild - Friese
  ("npc4_intel_mission", "If you could spare me for a few days, I would like to look up an old comrade-in-arms in {s17}, who has from time to time led a small shield wall in the pay of the {s18}. He is a good man, the kind who speaks little and listens much. I'm sure, over a drink or two, he might let me know which way the political winds are blowing in those parts."), #Donnchadh - Alban
  ("npc5_intel_mission", "If you like, warlord, I can try to contact some of my family members on the border of the {s18}. My own kin will not betray me and denounce me to the king, so I might be able to gather from them news from all across the {s18}. They may have some gossip about the feuds and rivalries of the great lords, if that is of interest to you."), #Morgant - Dumnonia
  ("npc6_intel_mission", "On the occasion of the preparations for my trip to West Seaxe, letters were sent to important people of {s17}. If you give me a few days, I may be able to collect some interesting information about the {s18} from those people, who are well aware of the political affairs of the realm."), #Bodo - Cantwareburh
  ("npc7_intel_mission", "Warlord, when I left my former home in {s17}, I promised myself that I would not return except to take vengeance on those who have wronged me. Even though rage burns within my heart, I am occasionally curious as to how my family is getting along. Perhaps I can bring them some gifts, to let them know that I have been successful despite them! Any rate, they are wretched people, but just as a cringing dog keeps its ear to the wind, so do they. They may have useful information about the {s18}, if you would give me a few days to pay them a visit."), ##Dwywei - Alban
  ("npc8_intel_mission", "If you have any interest in the events in the {s18}, a former shield-companion of mine retired and keeps a farm near {s17}. He stays in touch with a number of other old warriors. I could visit him for a few days and learn more about what is going on there."), #Reginhard - Friese
  ("npc9_intel_mission", "{reg59?My lady:Sir}, it has been some time since I sampled the delights of {s17}, where gentlefolk such as I are wont to partake of the hospitality of its most puissant and generous lord. If you wish, I could perhaps go there to learn something of the concerns that weigh on the minds of the great peers of the {s18}."), #Clovis - East Engle
  ("npc10_intel_mission", "Dryhten -- I was thinking that some of my old mates in the garrison at {s17} would be glad to see me. They are good lads that would never betray the city, but, like me, they are true Saxon warriors. They may be willing to slip a little political gossip about the incompetence of our lords in finally exterminating the Welsh. The gentry are always falling out over one little thing or the other instead of killing Britons, but the lads might know if there's real dissent brewing."), #Ceawlin - East Seaxna
  ("npc11_intel_mission", "{reg59?My pretty:Handsome}, I was thinking that it's been a while since I visited my kin in {s17}. They were among the few that supported me over the years, so I'd like to share with them some of my newfound fortune and news of our love. Then they will surely spill a few tidbits about events in the {s18}, if that would interest you."), #Solveig - norwey
  ("npc12_intel_mission", "If you wish, Warlord, I would not mind taking the time to pay a visit to a pupil of mine, now employed by the jarl of {s17}. I had great hopes for him, but I have heard that he has lately endorsed the use of muskmelon for the treatment of palsy, on the grounds that its cold essence offsets an abundance of yellow bile. This is a travesty of medicine, and I must journey there to correct him. While I am there, if you wish, I could question him on the latest trends within the {s18}, a topic which may interest you."), #Asbjorn - Ribe
  ("npc13_intel_mission", "As you may know, I helped train the garrison of {s17}. One of their numbers has lately been in touch with me, suggesting that if I were to visit, he could pass on to me information on events within the {s18}. I am willing to do this, if you can spare me. While it is a great disgrace to be a traitor, there is no dishonor in making use of one."), #Helgi - Norwey
  ("npc14_intel_mission", "With your permission, I was thinking that I might pay a visit to the dales near {s17}. I try not to revisit old pastures, but I must confess a certain curiosity as to how a comely young shepherdess of my former acquaintance is getting along. On the way, I may attempt to stop in at the castle. I suspect that it would not be terribly difficult for me to charm my way into the lord's hall, and I may be able to provide you with the latest news from the {s18}. The lord's wife has a big mouth, and she will surely tell me everything."), #Ailchu - Desmunu
  ("npc15_intel_mission", "Strategos, as you may know, I have for some time harbored a wish to go to {s17} to study woodworking. As it happens, one of my colleagues is currently engaged there doing repair work on the defenses. While his sense of professional obligation, I think, should prevent him from disclosing to me any weaknesses, I suspect that he would not be averse to offering up his opinion on the general state of the {s18}, if that is of interest to you."), #aghatinos - Noruega
  ("npc16_intel_mission", "I may pay a visit to the monastery close to {s17}, where I know some very wise monks and priests. As the defenders of a stronghold of the Church and exponents of God's will in the region, my brothers are well versed in the political situation within the {s18}. I am sure they will keep no secret from me, if that will help us spread the teachings of the Holy Bible throughout these lands."), #Beda - West Seaxe

  ("npc1_fief_acceptance", "You make me lord of {s17}, warlord? Well, that will be the kindest thing that anyone has done for me in a long time. Heh, I'll make the most of it. You can count on that! I have to say, though -- I'm not sure how the other lords of this realm will react when they find young Caio in their high company."), #Caio
  ("npc2_fief_acceptance", "{s17} as a fief? Well, I've always thought in terms of mead and women, not in terms of governing anything. But now that you mention it, I bet I could make that place turn a fair bit of revenue. I thank you, {reg59?my lady:my lord}! This is a very kind turn that you have done me."), #Egil
  ("npc3_fief_acceptance", "My {reg59?Lady:Lord}, it is most generous of you to offer me {s17}. Me, an ex-slave! I will be pleased to hold it and will dedicate myself to the moral and material uplifting of its inhabitants. And I will not tolerate any kind of slavery in my fief!"), #Brunhild
  ("npc4_fief_acceptance", "It is good of you to grant me {s17} as a fief -- and most appropriate."), ##Donnchadh
  ("npc5_fief_acceptance", "Warlord -- I will be most pleased to hold {s17}. I will send word to Cornubia, to my family, kinsmen, and former servants, and let them know that there is honorable silver and prestige to be earned serving under me in your armies. They will come flocking to fight for you rather than fleeing into Brittany!"), #Morgant
  ("npc6_fief_acceptance", "I am surprised that you find me worthy to govern men, as I am just beginning to learn to govern myself. But if you indeed wish it, I would be most honored to hold {s17} in your name. I hereby dedicate myself to the protection of those who live there."), #Bodo
  ("npc7_fief_acceptance", "Aye, I'll hold {s17} -- and prove to all that Picts are more than capable of ruling and governing land and men, as we did ages ago. Thank you, my {reg59?Lady:Lord}, for this opportunity."), #Dwywei
  ("npc8_fief_acceptance", "You'd make me a jarl? Well, I suppose that I can postpone other things for a little while longer and make my great hall at {s17}. Someday, I may travel over the seas to fulfill my destiny, but until then, I will be pleased to raise a shield wall of battle-hardened warriors to fight under your banner."), ##Reginhard , frisio
  ("npc9_fief_acceptance", "My {reg59?Lady:Lord}, I was cheated of my inheritance, but now, with this offer of an estate, you make right what was wrong. It would give me the greatest honor to serve you, to fight for you, and to hold this land in fief to you."), #clovis
  ("npc10_fief_acceptance", "You'd make me a lord? Well, I think you are right. Saxon warriors are destined to rule all of Britannia. If our current lords are unable to defeat the other nations, then it is natural that truly powerful warriors like I must replace them."), #Ceawlin
  ("npc11_fief_acceptance", "My! You'd grant me a title? There can be no greater sign of your love, can there? My, the strange turns life takes! Fancy this much-maligned virgin finding love and becoming a great peer of a realm. I am nobody's 'old maid' now!"), #Solveig
  ("npc12_fief_acceptance", "Well, my {reg59?Lady:Lord}, I have to remind you that I don't believe in the holding of land in fief to the king. Farmers and landholders should govern their own affairs under the protection of a distant sovereign. That being said, Englaland has seen far too much bloodshed for us to turn the social order on its head right now. Give me that land, and I'll endeavor to prepare it for a brighter future -- if not in this generation, than perhaps in the next."), #Asbjorn
  ("npc13_fief_acceptance", "You do me a great honor. I will serve faithfully under your banner and shall dedicate every day of my life to raise an organized army and to instill some discipline in our soldiers. Soon, with that army, we shall together submit all of world to your rule."), #Helgi
  ("npc14_fief_acceptance", "How generous and kind of you, my {reg59?Lady:Lord}. Allow me to express the utmost reverence for your wisdom in selecting me. Truly, your perspicacity exceeds that of King Solomon, who could read the entire nature of a man from a single hair of his head. Your judgment surpasses that of the emperor, Marcus Aurelius, to whom even the most prominent patricians submitted their disputes. Anyway, I accept."), #Ailchu
  ("npc15_fief_acceptance", "You do me a great honor, strategos. In Konstantinoupolis, a youngest son such as I am has no opportunity to possess a fief of his own, but here, there is still the chance for a man to win with his sword what was denied him by his birth! I shall hold {s17} as your vassal and build a corps of engineers to build your fortresses, palaces, and empire."), #aghatinos
  ("npc16_fief_acceptance", "You truly fear God and respect his will. This is good. {s17} will become a center of faith and truth. It will be a powerful beacon against the shadows of paganism and heresy that still haunt this land. May the peace of God be with you."), #Beda 
  
  ("npc1_woman_to_woman", "{!}."), #Caio
  ("npc2_woman_to_woman", "{!}."), #Aleifr
  ("npc3_woman_to_woman", "My lady, if you don't mind my saying, I think by now you have proven yourself to be one of the great warriors of this realm. Yet strangely, no king has come forward to offer you a fief. Perhaps it is because you are a woman. No matter -- I personally believe that you will take your place among the great lords of this realm, even if you have to fight twice as long and twice as hard to receive your due!"), #Brunhild
  ("npc4_woman_to_woman", "{!}."), #Donnchadh
  ("npc5_woman_to_woman", "{!}."), #Morgant
  ("npc6_woman_to_woman", "{!}."), #Bodo
  ("npc7_woman_to_woman", "Warlord, if you don't mind my saying, you have fought long and hard against every kind of warrior in the world. With their defeat, you brought great honor to yourself. You well deserve of a fief of your own. I suspect that if you were not a woman, a king would have offered you one by now. That is the way of the men in this sorry land: they let us stand in the front of the battle line to take the enemy's blows, but when it comes to a division of the spoils, they expect us to head to the rear."), #Dwywei
  ("npc8_woman_to_woman", "{!}."), #Reginhard
  ("npc9_woman_to_woman", "{!}."), #clovis
  ("npc10_woman_to_woman", "{!}."), #Ceawlin
  ("npc11_woman_to_woman", "My Pretty, I just can't help thinking to myself -- you've made quite a name for yourself, haven't you? Fighting and marching up and down the length of the land. Why, I suspect if you were a man, some king would have offered you a fief by now. Well, you may still get what you deserve! You'll just have to prove yourself a bit more, and I shall stay at your side to help you do it!"), #Solveig
  ("npc12_woman_to_woman", "{!}."), #Orosio
  ("npc13_woman_to_woman", "{!}."), #Helgi
  ("npc14_woman_to_woman", "{!}."), #Ailchu
  ("npc15_woman_to_woman", "{!}."), #Agasicles
  ("npc16_woman_to_woman", "{!}."), #Beda

  ("npc1_turn_against", "I'm sorry that we meet like this, warlord. There's no question that I owe my rise in life to you. You doubtless think me ungrateful. However, one has to follow one's destiny... Isn't that correct?"), #Caio
  ("npc2_turn_against", "This is a sad day. I never thought that I might meet my old warlord on the field of battle. Even if I triumph, it will bring me no joy."), #Egil
  ("npc3_turn_against", "Oh {playername}! What a tragic turn our lives have taken! I can only hope that the strange tides that have currently made us enemies will one day allow us to be friends once more."), #Brunhild
  ("npc4_turn_against", "Aye, well.... I'm not sure what to say. Let's get this fight over with."), #Donnchadh
  ("npc5_turn_against", "{playername}! It is a shame that we must now battle after so many glorious victories together. Anyway, today I come against you with my sword raised, but I hope that, one day, we instead will raise a glass together, to a friendship renewed."), #Morgant
  ("npc6_turn_against", "It grieves me, more than anything I can say, to meet you like this, {playername}. I shall not dwell on the circumstances that have led us to this point. I can only hope that we may one day be reconciled."), #Bodo
  ("npc7_turn_against", "Well, old leader. You made of me a great lady, and for that, I am grateful. However, you can never own me, and now the circumstances have caused our interests to clash. I meet you in battle with a clear conscience. Still, I hope someday that circumstances may change again. Even though you will now suffer defeat, I hope we may meet as friends again."), #Dwywei
  ("npc8_turn_against", "So, we meet now as enemies and may shortly face each other over the rims of our shields. A grim day this is. The spinners of fate have a dark sense of humor."), #Reginhard
  ("npc9_turn_against", "I will not accept fault for the circumstances that have led us to become enemies. I want you to know that my conscience is clear, although my heart is heavy."), #Clovis
  ("npc10_turn_against", "Well, it looks like the tides of fate have led me to make war on my old dryhten. Maybe things started to go wrong when you became my liege. I suppose I was never much suited to vassalage. Anyway, here we are now. Prepare to be defeated."), #Ceawlin
  ("npc11_turn_against", "Great Thor, my heart is now officially broken. So it looks like you and I are enemies. Didn't I always sing how life and love takes us on some very strange turns? The Norns play with us -- to turn love into hate so easily. Nevertheless, keep up your defenses, {reg59?my pretty:handsome}. I will not go easy on you, for all I will try not to mar that face of yours overly much!"), #Solveig
  ("npc12_turn_against", "So, it seems we must fight. I would have you know, {reg59?my lady:sir}, that I have not betrayed you. I had never served you as a man, but served the principles that I believed you upheld. As you no longer uphold them, I must do my best to thwart you, but I bear you no ill will. I hope that you will change again, so that we can meet again someday as friends."), #Asbjorn
  ("npc13_turn_against", "Well, {playername}. We meet as enemies. I confess that I have mixed feelings. It grieves me to make war on you, but if we meet in battle and I prevail, I will have defeated the worthiest foe. Then I will know that my mastery of the military art is complete!"), #Helgi
  ("npc14_turn_against", "It is sad to meet you as my enemy. On the other hand, to meet such a titan of the battlefield as you in combat is a rare privilege. Truly, the news of our contest today shall keep the bards and poets of these lands in mead and silver for months to come, don't you think?"), #Ailchu
  ("npc15_turn_against", "Ah... I have not been looking forward to this day. I just want to say that, in my view, if you'd kept your faith in me, things would never have come to this. But no doubt you see it differently."), #aghatinos
  ("npc16_turn_against", "I now see that, for the whole time we travelled together, you intended only to use and deceive me. Your soul belongs to the Devil, and the darkness of passion for the old gods lingers within your heart. For the cause of Christ, I must now defeat you in the field. Do not doubt that God is by my side today. Nothing but defeat is prepared for you right now."), #Beda  
...
("comment_intro_liege_affiliated", "I am told that you are pledged to one of the pretenders who dispute my claim to the crown, but we may still talk."),
...
("comment_intro_famous_cunning", "Ah, yes. At last we meet. You sound like a good {reg59?woman:man} to know. Let us speak together, from time to time."),
...
("comment_intro_noble_liege", "I see that you carry a {reg59?noble's:nobleman's} banner, although I do not recognize the device. Know that I am always looking for good {reg59?warriors:men} to fight for me, once they prove themselves to be worthy of my trust."),
("comment_intro_noble_martial", "I see that you carry a nobleman's banner, but I do not recognize the device. No matter -- a brave {reg59?warrior's:man's} home is all the world, or so they say!"),
...
("comment_intro_noble_cunning", "I see that you carry a nobleman's banner, but I do not recognize the device. Still, it is always worthwhile to make the acquaintance of {reg59?women:men} who may one day prove themselves to be great warriors."),
("comment_intro_noble_sadistic", "I see that you carry a nobleman's banner, but I do not recognize the device. Perhaps you are the bastard {reg59?daughter:son} of a puffed-up cattle thief? Or perhaps you stole it?"),
("comment_intro_noble_goodnatured", "I see that you carry a nobleman's banner, but I do not recognize the device. Forgive my ignorance, {reg59?my lady:sir}! It is good to make your acquaintance."),
("comment_intro_noble_upstanding", "I see that you carry a nobleman's banner, but I do not recognize the device. No doubt you have come to these lands in search of wealth and glory. If this indeed is the case, then I only ask that you show mercy to those poor souls caught in the path of war."),
...
("comment_intro_common_martial", "Perhaps you are not of gentle birth, but even a commoner, be {reg59?she:he} of sufficient valor, may make something of {reg59?herself:himself} someday."),
...
("comment_intro_common_cunning", "Well... I have not heard of you, but you have the look of a {reg59?woman:man} who might make something of {reg59?herself:himself}, someday."),
...
("comment_intro_female_famous_badtempered", "I've heard talk of you -- the woman who knows how to fight like a man."),
...
("comment_intro_female_noble_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields of these lands, but neither is it usual. I shall be most interested in your progress."),
("comment_intro_female_noble_sadistic", "You appear to be of noble rank, but I don't recognize your banner. Clearly, another foreigner come to our shores -- no doubt from a land where men are weak, and the women ride to war in their place like the Amazons of old!"),
...
("comment_intro_female_admiring_goodnatured", "My lady, if you are as skilled in arms as you are fair in countenance, then your enemies should indeed fear you!"),
...
("comment_intro_female_common_martial", "I must say, my lady -- do be careful, riding about this dangerous land. If you ever wish to seek a more... em... settled life, I'm sure I could find you a worthy husband from among my men."),
...
("comment_intro_female_common_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields of these lands, but neither is it usual. I shall be most interested in your progress."),
...
("rejoinder_intro_female_common_sadistic", "And you, sir, are no more manly than my horse."),
...
#Actions vis-a-vis civilians
  ...
  ("comment_you_stole_cattles_from_my_village_enemy_spiteful",      "I have heard that you have stolen cattle from my villagers living at {s51}, stealing my villager's property. You will pay results of this dishonorable act!"), 
  ("comment_you_stole_cattles_from_my_village_enemy_coldblooded",   "I have heard that you have stolen cattle from my villagers living at {s51}, stealing my villager's property. I will make you think twice before you disrupt my revenues like that again."),
  ("comment_you_stole_cattles_from_my_village_enemy",               "I have heard that you have stolen cattle from my villagers living at {s51}, stealing my villager's property. You will pay results of this dishonorable act!"), 
  ...
  ("comment_you_accosted_my_caravan_enemy",          "You have been accosting caravans under my protection. Your trail of brigandage will soon come to an end."),
...
###Add some variation to these
  ("comment_we_defeated_a_lord_unfriendly_spiteful",           "I suppose you will want to drink to the memory of our victory over {s54}. Well, save your mead -- it will take more than that to wipe out the stain of your earlier disgraces."), 
  ("comment_we_defeated_a_lord_unfriendly",                    "I will not forget how we fought together against {s54}, but also I cannot forget the other matters that lie between us."), 
  ...
  ("comment_we_fought_in_siege_unfriendly",                    "I will not forget how together we stormed {s51}, but also I cannot forget the other matters that lie between us."), 
  ...
  ("comment_we_fought_in_major_battle_unfriendly_spiteful",    "I suppose you will want to drink to the memory of our great victory near {s51}. Well, save your mead -- it will take more than that to wipe out the stain of your earlier disgraces."), 
  ...
  ("comment_you_defeated_a_lord_allied",                         "I heard that you fought and defeated {s54}. I wish you the joy of victory."), 
  ...
  ("comment_you_defeated_me_enemy",            "When last we met, {playername}, you had the better of me. I assure you that it will not happen again!"), 

  ("comment_I_defeated_you_enemy_spiteful",          "Back for more? Make me fight you again, and I'll feed your bowels to my hounds."), 
  ("comment_I_defeated_you_enemy_chivalrous",        "Come to test your valor against me again, eh {playername}?"), 
  ...
  ("comment_you_were_defeated_allied_spiteful",               "I heard that {s54} crushed you underfoot like an ant. Hah! Children should not play games made for grown-ups, little {reg59?girl:boy}!"), 
  ...
  ("comment_you_were_defeated_allied_unfriendly_upstanding",  "I heard that {s54} defeated you. Perhaps you should repent of any sins that might cause the Lord to rebuke you in this way."), 
  ...
  ("duplicate",             "I heard that {s54} defeated you. Look, try not to get too many of our men killed, will you?"), 
  ("duplicate",                        "I heard that {s54} defeated you. But take heart -- the tables will soon be turned!"), 
  ...
  ("comment_you_captured_a_lord_allied_friendly_spiteful",   "I heard that you captured {s54}. I hope that you squeezed him for every pening."), 
  ("comment_you_captured_a_lord_allied_unfriendly_spiteful", "I heard that you captured {s54}. Your coffers must be bloated with ransom by now. Such a pity that money cannot transform a low-born cur into a gentleman!"), 
  ("comment_you_captured_a_lord_allied_chivalrous",          "I heard that you captured {s54}. Well done. I assume, of course, that he has been treated with the honours due his rank."), 
...
#Internal faction events
  ...
  ("comment_pledged_allegiance_allied_goodnatured",                    "I heard that you have pledged allegiance to our lord, {s54}. Good {reg59?woman:man}! Our lord is a noble soul, and rewards loyalty and valor with kindness and generosity."),
  ...
  ("comment_you_renounced_your_alliegance_unfriendly_spiteful",        "I always had you figured for a traitor to {s54}, and now it seems I was right. I hope you are prepared to die a traitor's death!"),
...
#new political comments  
  ...
  ("comment_i_protested_marshal_appointment", "It is well known that I had protested {s54}'s decision to appoint {s51} as marshal."),
  ...
  ("comment_marriage_elopement_liege",   "I hear that you have eloped with {s50}, against her family's wishes. I am not pleased. Her relatives are among the great lords of my realm, and I do not like to see them made to look like fools."),
  ...
  ("surrender_offer_goodnatured",    "I yield! Congratulations on your victory, {reg59?madame:sir}!"),
  ...
  ("prisoner_released_default",       "You have my gratitude, {reg59?madame:sir}. I shall not forget your kindness."),
  ("prisoner_released_martial",       "You are indeed a {reg59?woman:man} of honour, {reg59?madame:sir}. I shall not forget this!"),
  ...
  ("prisoner_released_cunning",       "Am I? You are a good {reg59?woman:man}. I will try to find a way to repay you."),
  ...
  ("prisoner_released_goodnatured",   "You are indeed a {reg59?woman:man} of honour, {reg59?madame:sir}. I shall not forget this!"),
  ("prisoner_released_upstanding",    "You are indeed a {reg59?woman:man} of honour, {reg59?madame:sir}. I shall not forget this!"),

#Post 0907 changes begin
  ("enemy_meet_default",              "Who are you, that comes in arms against me?"),
  ("enemy_meet_martial",              "What is your name, {reg59?madame:sir}? If we come to blows, I would know whom I fight."),
  ...
  ("enemy_meet_goodnatured",          "What is your name, {reg59?madame:sir}? If we come to blows, I would know whom I fight."),
  ...
  ("battle_won_grudging_martial",     "{playername} -- you have shown yourself a worthy {reg59?woman:man} today, whatever your misdeeds in the past."),
  ("battle_won_grudging_quarrelsome", "Hmf. Yours is not a face that I normally like to see, but I suppose today I should thank you for your help."),
  ...
  ("unprovoked_attack_quarrelsome",           "You're making a big mistake, {reg59?girl:boy}. What do you think you're doing?"),
  ...
  ("unprovoked_attack_goodnatured",           "Why do you do this? We've got no quarrel, {reg59?madame:sir}."),
  ...
  ("unnecessary_attack_martial",               "I am eager to take you up on your challenge, {reg59?madame:sir}, although I will give you a moment to reconsider."),
  ...
  ("unnecessary_attack_goodnatured",           "I don't see what you have to gain by picking a fight, {reg59?madame:sir}. You can still ride away."),
  ("unnecessary_attack_upstanding",            "If a fight is what you wish, {reg59?madame:sir}, then you will have one, but I will yet offer you the chance to back down."),
  ...
  ("lord_mission_failed_martial",               "There is no honour in failing a quest that you endeavoured to take, but I will accept your word on it."),
  ...
  ("lord_follow_refusal_default",       "Follow you? You forget your station, {reg59?madame:sir}."),
  ...
  ("lord_follow_refusal_pitiless",      "Lords like me do not follow people like you, {reg59?madame:sir}."),
  ("lord_follow_refusal_cunning",       "First show me that you are the type of {reg59?woman:man} who will not lead me into disaster, and then perhaps I will follow you."),
  ("lord_follow_refusal_sadistic",      "I think not! Rather, you should follow me, as a whipped cur follows {reg59?her:his} master."),
  ...
  ("lord_insult_default",               "base varlet"),
  ...
  ("lord_derogatory_upstanding",            "stiff-necked and sanctimonious"),
  ...
  ("rebellion_dilemma_pitiless",                "Hmm. {s45} says {reg3?she:he} is the rightful heir to the throne. That is good; it absolves me of my oath to {s46}. However, I must still weigh my decision carefully."),
  ("rebellion_dilemma_cunning",                 "Hmm. I gave an oath of homage to {s46}, yet the powerful are not bound by their oaths as are ordinary people. Our duty is to our own ability to rule, to impose order and prevent the war of all against all."),
  ...
  ("rebellion_dilemma_upstanding",              "This is troublesome. It is a grave thing to declare my homage to {s46} to be null and void, and dissolve the bonds that keep our land from sinking into anarchy. Yet I am also pledged to support the legitimacy of the succession, and {s45} also has a valid claim to the throne."),
  ...
  ("rebellion_dilemma_2_cunning",               "{s46} has been challenged, and thus he will never be able to rule as strongly as one whose claim has never been questioned. However, if {s45} takes the throne by force, {reg3?she:he} will never be as secure as one who succeeds our current ruler legitimately."),
  ("rebellion_dilemma_2_sadistic",              "Perhaps if I join {s45} while {reg3?she:he} is still weak, {reg3?she:he} will enrich me. Or perhaps if I bring {s46} your head, he will give me an even greater reward."),
  ...
  ("rebellion_refuse_goodnatured",           "I am sorry. I don't feel right turning my back on {s46}. No hard feelings when we next meet on the battlefield, eh?"),
  ...
  ("gossip_about_character_selfrighteous",  "I heard that {s6} had a ranger executed because the unfortunate man killed a deer in his forest."), #chief cambiado
...
#steve lord recruitment changes begin
  ...
  ("changed_my_mind_pitiless",                  "But when you plead like that, I deign to reconsider."),
  ...
  ("changed_my_mind_goodnatured",               "However, you make a good case, so I'll try to keep an open mind."),
...
#new pretenders
  ("swadian_rebellion_pretender_intro",    "I am Thorgil of Ribe. I should be konungr of Danmark."), #from Ribe, he is a Jarl who wish be king, no rights really. 
  ("vaegir_rebellion_pretender_intro",     "I am Dungal, son of Fergusa, of the Cenel nLoairn. I should be Ard Ri of Eriu!"), #Bastard of current High King, hate his father and want his throne
  ("khergit_rebellion_pretender_intro",    "I am Uhtred son of Uhtred, rightful lord of Bebbanburg."), #Ealdorman from Norhumbria lost land for danish invasion and want to be King of the north. His Grandparent was  Aelle of Northumbria, who killed Ragnar lodbrok
  ("nord_rebellion_pretender_intro",       "I am Ceorl. I will soon rule over West Seaxe."), #From weessex, son of Aethelstan, eldest brother of Aethelred and former King of Cent
  ("rhodok_rebellion_pretender_intro",     "I am Bili, son of Brude and the next king of Alban!"), #A bandit who wish to be king
  ("sarranid_rebellion_pretender_intro",   "Hello, foreigner. I am Cadwallon. I stand before you as the last heir of the kings of Gwynedd."), #Claim be descend old Cadwallon of Brytenwalda. http://es.wikipedia.org/wiki/Cadwallon_ap_Cadfan
 
  ("swadian_rebellion_pretender_story_1",  "My father saved our people while that bastard, King Horik, was raiding abroad. He didn't think about what would happen if he left this land without any soldiers to protect it! My father was the one who did it!"),
  ("vaegir_rebellion_pretender_story_1",   "I had been the heir to my father's crown for 30 years, but last year that old mummy decided he wanted a new young lady to 'refresh' his life, if you know what I mean."),
  ("khergit_rebellion_pretender_story_1",  "My uncle Aelfric stole my lands and tried to have me murdered. I was raised by Danes, and I am ready to reclaim what is mine. Bebbanburg is mine."),
  ("nord_rebellion_pretender_story_1",     "My father was the king of Cent, the current king's brother. He honored his father, Aethelwulf, unlike his next brother, Aethelbald, who stole the throne and married his father's wife."),
  ("rhodok_rebellion_pretender_story_1",   "For the last fifteen years, I rode through this land with my boys giving protection to the villages just for a couple of coins and food. Just what we deserve."),
  ("sarranid_rebellion_pretender_story_1", "I am the namesake of my ancestor, who defeated Eadwine of Deria in the battle of Haethfelth Chase. After that, we were kicked from the throne, and my family had to live far from the crown... until now."),

  ("swadian_rebellion_pretender_story_2",  "When the king came back from his adventure with tons of silver and those odd crosses, he was afraid of us. My father had inspired much loyalty among those who were here when the bandits attacked. That coward kicked us out of our own homes! Just a few months later my father committed suicide, unable to live with the dishonor. Since then, I have been living with people loyal to our cause, those who knew that the real leader of our people was my father."),
  ("vaegir_rebellion_pretender_story_2",   "Unfortunately for me, that little Queen is really fertile, and they have had a child, with the king being 62 years old... After so many years of poisoning his wives in order to abort their legitimate heirs... now this! It appears that my father would rather have a child heir than a bastard adult heir."),
  ("khergit_rebellion_pretender_story_2",  "I will retake the whole of Northumbria and overthrow those who chose to give Aelfric protection. Those who kept me from what is mine by birth and right. I have been delayed until now, but no longer. Destiny is all."),
  ("nord_rebellion_pretender_story_2",     "Before all that, unfortunately, my father died defending the kingdom from the first invasion of the Danish under Ragnar Lodbrok sixteen years ago. The incestuous Aethelbald then enjoyed the fruits of my father's sacrifice, dying in peace nine years later. I was still considered too young to assume a throne, and my uncles Aethelbehrt and Aethelred ascended through the kingships of Cent and Wessex in turn."),
  ("rhodok_rebellion_pretender_story_2",   "Only the big cities have turned us down. They said the real danger was us, that we didn't give them protection, and that we were extortionists. But these are all lies, damned lies! The actual thieves are those who call themselves tiarna and the worst one is that son-of-a-usurper king."),
  ("sarranid_rebellion_pretender_story_2",  "The kingdom has suffered greatly the last few years with the usurpers at its helm. I think the masses have had enough. They would support me in a fight for the throne."),

  ("swadian_rebellion_pretender_story_3",  "The whole kingdom owes its existence to my father and those who fought next to him, people like my men and I. I have enough men to take the capital and defend it while another brave man like you can conquer and defend the other strongholds. Together, we can take back what King Horik owes me."),
  ("vaegir_rebellion_pretender_story_3",   "But his new dynasty is not going to survive long. The other members of our clan are already jostling for power. A strong king would keep them united against our enemies! I need your help to support my rights to the crown, for my father will never accept me over his last son. We need to fight for the future of the kingdom."),
  ("khergit_rebellion_pretender_story_3",  "You may join me if you wish. I do not ask this, you are free to do as you like. I will retake Bebbanburg either way. But if you join, you might have your own city as just reward."),
  ...
  ("rhodok_rebellion_pretender_story_3",   "We are planning to assault the thief's main castle and end his reign of fear. The people of this land will pay only us for protection; I will not tolerate any competition. Join me and my band, and I will bury you in so much silver that you will be able to swim in it. I will give you a collection commission!"),
  ("sarranid_rebellion_pretender_story_3", "I just need good captains for my armies and, if possible, good soldiers under them. Together we will revive my family's honor and obtain the position that I deserve. Come with me, gather your soldiers, and our names will never be forgotten. Swear by me, and you will never regret it."),
 
  ("swadian_rebellion_monarch_response_1", "That child again is pretending to be the true king over my lands... I should have sent him farther away when I had a chance. Without all the silver we brought, this kingdom would be nothing. If I had any idea that my lands would be razed by bandits, I would have never taken so many soldiers with me."),
  ("vaegir_rebellion_monarch_response_1",  "That young man will never understand his place in this world. He is a bastard. He will never have any rights except the ones he earns in service to his lord. He is my son, but he will never be king, not even if my little baby dies someday."),
  ("khergit_rebellion_monarch_response_1", "Who? A saxon slave? Do not waste my time with the ramblings of a deluded boy."),
  ("nord_rebellion_monarch_response_1",    "My nephew was a good knight some years ago. Then he started to associate with certain of his father's retainers and now believes only what they say. They've put notions in his head, thinking to regain positions of influence."),
  ("rhodok_rebellion_monarch_response_1",  "He is nothing but a bandit. For the last few years, he has been extorting silver from my villages. He pretends to be the protector of those villages from 'bandits,' when it is they who are the bandits!"),
  ("sarranid_rebellion_monarch_response_1", "It is true that we are going through tough times, but the people know it is because our merchants have been suffering under constant raids. Now that I know he is in my kingdom, I can say he is the one responsible for those attacks."),

  ("swadian_rebellion_monarch_response_2", "They can try to attack us, but they don't have enough men to take even one of my villages, ha! Take my advice. Ignore him. He will never be anything but a chatterbox."),
  ("vaegir_rebellion_monarch_response_2",  "Only if he came and knelt in front of me would I will be willing to forgive his faults and let him live somewhere far away from my legitimate son."),
  ("khergit_rebellion_monarch_response_2", "The old order is past, and those who stake claims had better have the means to enforce them. He does not."),
  ("nord_rebellion_monarch_response_2",    "I do not desire to bind his hands, but I have my mine full with the Danish and can't be on guard against a possible back stab. No one controls events, and the succession moves on. He never understood this."),
  ("rhodok_rebellion_monarch_response_2",  "They are going to suffer for the pain they have caused my people. Not one of them will survive."),
  ("sarranid_rebellion_monarch_response_2", "It is my duty to protect all of my people from any danger in my kingdom. I will capture him and we will have a 'talk.' This situation can't stay like this any longer."),
  #chief cambia termina
...
# #chief cambiado creditos
  
  ("credits_1", "©2010 TaleWorlds Entertainment. Mount & Blade: Warband^©2014 Brytenwalda S.L. Viking Conquest"),
  ("credits_2", "BRYTENWALDA S.L.^^Game Design^Alberto Fuentevilla^Matthias Grohmann^Michael 'Motomataru' Richter"),
  ("credits_3", "Programming^Alberto Fuentevilla^Matthias Grohmann^Michael 'Motomataru' Richter^Slawomir Libura^Michael Lyubchenko^^\
Special thanks for the Battle GUI^Alexander Souslov (Snowbird Studios)"),
  ("credits_4", "Scenes^Asbjorn Lindegaard Moller^^Models^Cesar Inarrea^Leyre Ramirez^Miguel Egana Silva^^2D Art^Yeyo Balbas^^Textures^Miguel Egana Silva^Sebastian Wunnicke"),
  ("credits_5", "Shaders^Marc Natta^^Animations^Slawomir Libura^^Concept Artist^Yeyo Balbas"),
  ("credits_6", "Script^Alberto Fuentevilla"),
  ("credits_7", "Music^Marcus Bressler - Viking Raid^CrystalMoors - Antiqvam Exqvirite Matrem, Nabia Orebia, The Unconquered Land^Juha-Matti Koppelomaki - Viking War Horns^Symphony of Specters - Day of War^Mike Sea - Go Vikes.^KlepatoDesign - The Ancients^\
Darius Sobolewski - Nordic Orchestra^Logan Epic Canto - Celtic Spirit^Allegro120 - Celtic^Cinemonia - Celtic Legend^^Tim Donovan - Solemn Funeral Pyre, Fallen Warrior^MrHumble - Ballad of a Hero.^^\
External support^Yughues Nobiax^Stephen Pollington"),
  ("credits_8", "Testers and contributions^^Kalarhan^Kraggrim^Hunta^Ragnarson^Takeda Shingen^YourStepDad^Nijis^Krisvk^Dowdpride^Arch3r^Kazzan^Rurin^Fredelios^Blivandefar^Cleric Johnson^AZAN^Mitchell^M^Ozan Celik^Reiksmarshal^Hrotha^^\
Very special thanks to the players and betatesters of the original Brytenwalda module for many years of valuable feedback, only a fraction of which we had time to implement.^^\
Marketing Assets^Miguel Egana Silva (KreativLandschaft)"),  
  ("credits_10", "TALEWORLDS ENTERTAINMENT^^Lead Programming^Cem Çimenbiçer^Şahin Serdar Koçdemir^^Programming^Mustafa Korkmaz^Gökhan Uras^Dündar Ünsal"),
  ("credits_11", "Lead Artist^Özgür Saral^^Artists^Andaç Bingöl^Deniz Köklü^Fatma Nadide Öcba^Fırat Murat Çebi^Gökalp Doğan^Oğuz Tunceli^Sten Oom"),
  ("credits_12", "TaleWorlds Management^^Founder/Chief Executive Officer^Armağan Yavuz^^Chief Operating Officer^Ali Erkin^^\
Producer/Business Development^Vishnu Vijayakumar^^PR/Community Manager^Frank Elliott"),
  ("credits_9", "Live Action Video^^Daniel Renger^Martin Unglert^Josef Becker^Jan Jaegers^Markus Beck^Jurgen Bonisch^Chris Czichowsky^Florian Dosch^Michael Exner^Fryzel Hans-Jurgen^Alexandra Gorner^Alexander Gorner^Franz Hauser^Jenna Klein^Claudia Klingner^Marcus Langer^Hans Lendorf^Markus Mickel^Patrick Mouka^Corinna Oppitz^Sibylle Oppitz^Bernd Rohde^Volker Schlott^Benjamin Schuler^Michael Schuler^Rebekka Schuler^Julia Schuster^Alexander Seufert^Susan Sumer^Johannes Werth^Bernd Wolfsteiner^Sabine Wudy^Sebastian Wudy^Stefan Wudy^^\
Location^Geschichtspark Barnau^^Logotype^Jason Brown^^Cover Art^Piotr Fox Wysocki^^Layout^Christian Sabe^Melina Grundel^^Poster^Piotr Fox Wysocki^^Concept Art^Ganbat Badamkhand^^Manual Editing & Digital Wordsmithing^Ryan Newman^Nick Stewart^^Web^Martin Ericsson^^Marketing Assets^2Coats^^Localization^S&H Entertainment Localization"),  

#multiplayer scene names
  ("multi_scene_1", "Saxon Village"),
  ("multi_scene_2", "Din Tagell"), #multiplayer chief
  ("multi_scene_3", "Dun Taruo"), #Castle 1 multiplayer chief
  ("multi_scene_4", "Hadrian's Wall"), #multiplayer chief
  ("multi_scene_5", "Ad Candida Casam"), #multiplayer chief
  ("multi_scene_6", "Hilltop Village"), #multiplayer chief
  ("multi_scene_7", "Din Arth"), #multiplayer chief
  ("multi_scene_8", "Duin Ollaigh"), #Castle 2  #multiplayer chief
  ("multi_scene_9", "Din Bych"), #multiplayer chief
  ("multi_scene_10", "Roman Fort"), #Castle 3  #multiplayer chief
  ("multi_scene_11", "Into The Trees"), #multiplayer chief
  ("multi_scene_12", "Crannog"), #siege Multiplayer chief
  ("multi_scene_13", "Saxon River Fort"), #siege Multiplayer chief
  ("multi_scene_14", "Seafarers"), #multiplayer chief
  ("multi_scene_15", "Saxon Duelling Field"), #multiplayer chief
  ("multi_scene_16", "Mynyw Fort"), #Castle 6 Multiplayer chief, es escene 16 
  ("multi_scene_17", "Abbercurnig"), #es scene 17 Multiplayer chief
  ("multi_scene_18", "Rival Strongholds"), #es escena 18 Multiplayer chief
  ("multi_scene_19", "Broch"), #es escena 19 Multiplayer chief
  #invasion
  ("multi_scene_inv_1", "Hadrian's Wall"),
  ("multi_scene_inv_2", "Saxon Fort"),
  ("multi_scene_inv_3", "Din Bych"),
  ("multi_scene_inv_4", "Mynyw Fort"),
  ("multi_scene_inv_5", "Broch"),
  #other
  ("multi_scene_20", "Random Plains"),
  ("multi_scene_21", "Random Forest"),
  ("multi_scene_22", "Random Snow"),
  ("multi_sea_1", "Calm Sea"),
  ("multi_sea_2", "Sea Storm"),
  ("multi_coast_1", "Port Assault"),
  ("multi_coast_2", "Port Assault (Thunderstorm)"),
...
#multiplayer game type names
  ...
  ("multi_game_type_4", "Siege"),
  ("multi_game_type_5", "Duel"),
  ("multi_game_type_6", "Naval Battle"), #naval battle
  ("multi_game_type_7", "Thor's Champion"),
  ("multi_game_type_8", "Viking Invasion"),#Draugr Invasion in future
  ("multi_game_type_9", "Warlords Battle"), #chief capitan
  ("multi_game_type_10", "Raid"),
  ("multi_game_types_end", "multi_game_types_end"),

#multiplayer game type descriptions
  ("multi_game_type_desc_1", "^Every man for himself!^^Earn silver and glory with every kill.^^"),
  ("multi_game_type_desc_2", "^Two teams; endless respawns.^^Earn silver and a point for your faction with every kill.^"),
  ("multi_game_type_desc_3", "^Two teams; no respawn.^^Here you must focus on keeping you and your teammates alive as well as on personal kills."),
  ("multi_game_type_desc_4", "^One team starts fortified, defending their flag against the clock and the other team. Respawns are slowed for the defender.^"),
  ("multi_game_type_desc_5", "^Find another player.^^Introduce yourself.^^Kill or be killed.^"),
  ("multi_game_type_desc_6", "^This is Battle mode, only afloat!^^^^"), #naval battle
  ("multi_game_type_desc_7", "^Find and kill the Champion to gain Thor's favour!^^You only gain point for killing Thor's Champions and for killing other players while being the Champion.^^^"),
  ("multi_game_type_desc_8", "^Team up with other players and defend against the hordes of enemies!^^^"),# the undead hordes of Draugrs!^^^^^"),
  ("multi_game_type_desc_9", "^This variant of Battle mode allows the player to purchase and lead armies of bots.^^"), #chief capitan
  ("multi_game_type_descs_end", "^^^              Specials^^\
- Banner: inspires nearby teammates 10%^^\
- Priest: heals nearby teammates^^\
- Horn (Attack Button): heals AND inspires teammates, at a distance^^\
- Berserk (Key B): temporarily increases melee capabilities^^\
- Shield Taunt (RMB + Key Q): displays your disdain for the enemy^^\
"),
  ...
  ("initial_gold_multiplier", "Starting silver (%):"),
  ("battle_earnings_multiplier", "Combat silver bonus (%):"),
  ("round_earnings_multiplier", "Round silver bonus (%):"),
  ...
  ("s1_won_round", "The {s1} team has won the round!"),
  ...
  ("mercenary_payment_from_s0", "Mercenary payment from the {s0}:"),
  ...
  ("starting_gold_ratio_is_reg0", "Starting silver ratio is {reg0}%."),
  ("combat_gold_bonus_ratio_is_reg0", "Combat silver bonus ratio is {reg0}%."),
  ("round_gold_bonus_ratio_is_reg0", "Round silver bonus ratio is {reg0}%."),
  ...
  ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of the {s56}.^:{s54} is a vassal of {s55} of the {s56}.^}}Renown: {reg5}. Controversy: {reg15}.^Religion: {s29}^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}^{s49}^Relation: {reg0}"),
  ("updating_faction_notes_for_s14_temp_=_reg4", "{!}Updating faction notes for {s14}, temp = {reg4}"),
  ("foreign_relations__", "Foreign relations: ^"),
  ("s21__the_s5_is_at_war_with_the_s14", "{s21}^^* At war with the {s14}."),
  ...
  ("s21__the_s5_is_bound_by_truce_not_to_attack_the_s14s18_the_truce_will_expire_in_reg1_days", "{s21}^^* Bound by truce not to attack the {s14}.{s18} The truce will expire in {reg1} days."),
#chief alliance
  ("s21__the_s5_is_bound_by_alliance_not_to_attack_the_s14s18_the_alliance_will_expire_in_reg1_days", "{s21}^^* The {s5} has an alliance with {s14}.{s18} The alliance will expire in {reg1} days."),
  ("alliance_durantion_days_expire", "{s21}^^* The {s5} has formalized an alliance with the {s14}.{s18} The alliance will expire in {reg1} days."),
###
...
#cambia chief para bajas realistas
...
#cambia chief bajas realistas acaba
  ...
  ("renown_change_of_reg4_reduced_to_reg5_because_of_high_existing_renown", "{!}Renown change of {reg4} reduced to {reg5}, because of high current renown"),
  ("s14", "{!}{s14}"),
  ...
  ("uncle", "uncle"),
  ("cousin", "cousin"),
  ("grandfather", "grandfather"),#Balance Mod added
  ("grandmother", "grandmother"),
  ("grandfatherinlaw", "grandfather-in-law"),
  ("grandmotherinlaw", "grandmother-in-law"),
  ("grandson", "grandson"),
  ("granddaughter", "granddaughter"),
  ("grandsoninlaw", "grandson-in-law"),
  ("granddaughterinlaw", "granddaughter-in-law"),
  ...
  #Trade explanations
  ("i_take_what_work_i_can_sirmadame_i_carry_water_or_help_the_merchants_with_their_loads_or_help_build_things_if_theres_things_to_be_built", "I take what work I can, {reg59?madame:sir}. I carry water, or help the merchants with their loads, or help build things, if there are things to be built."),
  ("dna_reg4_total_production_reg5_modula_reg7", "{!}DNA: {reg4}, total production: {reg5}, modula: {reg7}"),
  ("agent_produces_s9", "{!}Agent produces {s9}"),
  ("im_not_doing_anything_sirmadame_theres_no_work_to_be_had_around_here_these_days", "I'm not doing anything, {reg59?madame:sir}. There's no work to be had around here these days."),
  ("im_not_doing_anything_sirmadame_i_have_no_land_of_my_own_and_theres_no_work_to_be_had_around_here_these_days", "I'm not doing anything, {reg59?madame:sir}. I have no land of my own, and there's no work to be had around here these days."),
  ("why_im_still_living_off_of_your_kindness_and_goodness_sirmadame_hopefully_there_will_be_work_shortly", "Why, I'm still living off of your kindness and goodness, {reg59?madame:sir}. Hopefully there will be work, shortly."),
  ...
  ("trade_explanation_tools", "I work in a smithy, {reg59?madame:sir}, making all sorts of ironware -- knives, axes, pots, plough-blades, scythes, hammers, anvils, tongs, adzes, saws, nails, horseshoes, firesteel, braziers, and of course arms and armor for your excellencies."),
  ("trade_explanation_tar", "I work in a tar kiln, producing tar from pine wood brought in from the countryside. If you can afford it, our tar has a hundred uses – to waterproof sails and boats or to protect leather."),
  ("trade_explanation_linen", "I weave linen, using flax brought in from the surrounding countryside. It's makes a tough, light fabric, {reg59?madame:sir} -- good for summer clothing, sails for boats, and the like."),
  ...
  ("trade_explanation_mead", "I work in a mead factory, collecting honey from the beehives to put into barrels. I mix it with pure water, for fermenting. Mead is cheaper than wine and more renowned than beer. No feast can be held without it."),
  ...
  ("trade_explanation_barley", "I work in the barley fields, growing corn to feed the cattle and to make ale to quench the thirst of the commons."),
  ("trade_explanation_ivory", "I sail to the far north to hunt walrus on the remote beaches of the icy land beyond the ocean. These marine beast have two prominent tusks of fine ivory. Back home, carvers make a lot of precious objects with this hard, expensive and pure white material."),
  ("trade_explanation_leatherwork", "I work in the tanneries outside the walls, turning cured hides from the countryside into good, supple leather. It's foul work, and I come home stinking of urine, dung, and lime -- but that's where your boots, saddles, and bridles come from, {reg59?my lady:sir}."),
  ("trade_explanation_flax", "I sew and harvest linseed, and rot the stems to make flax fibers. That's the source of your fine linens, {reg59?my lady:sir} -- a rotting pit on the edge of a field."),
  ...
  ("duplicate", "I tend to a grove of date palms. We grow them using well water, and export the fruit far and wide, as they keep for many months when properly dried. As sweet as honey, and they grant the eater health and vigor."),
  ("trade_explanation_venison", "I hunt deer in the forest and work in a smokehouse, in which I smoke meat to preserve it for long periods. During the cold season, and even in summer, venison is the finest meal you can eat."),
...
###chief personality lords
  ("reputation_only_martial_", "As far as you know, his personality seems to be Martial^"),
  ("reputation_only_debauched_", "As far as you know, his personality seems to be Debauched^"),
  ("reputation_only_pitiless_", "As far as you know, his personality seems to be Pitiless^"),
  ("reputation_only_calculating_", "As far as you know, his personality seems to be Calculating^"),
  ("reputation_only_quarrelsome_", "As far as you know, his personality seems to be Quarrelsome^"),
  ("reputation_only_goodnatured_", "As far as you know, his personality seems to be Good-natured^"),
  ("reputation_only_upstanding_", "As far as you know, his personality seems to be Upstanding^"),
  ("reputation_only_conventional_", "As far as you know, his personality seems to be Conventional^"),
  ("reputation_only_adventurous_", "As far as you know, his personality seems to be Adventurous^"),
  ("reputation_only_romantic_", "As far as you know, his personality seems to be Romantic^"),
  ("reputation_only_moralist_", "As far as you know, his personality seems to be Moralist^"),
  ("reputation_only_ambitious_", "As far as you know, his personality seems to be Ambitious^"),
  ("reputation_only_reg11_", "{!}Reputation (cheat mode only): {reg11}^"),
####
  ...
  #Faction descriptors chief modificado
  ("swadians", "Britons"),
  ("vaegirs", "Vikings"),
  ("khergits", "Saxons"),
  ("nords", "Angles"),
  ...
  ("you_speak_of_unifying_calradia_well_youve_done_a_good_job_at_making_calradia_bend_its_knee_to_you_so_maybe_thats_not_just_talk", "You speak of unifying these lands. Well, you've done a good job at making this country bend its knee to you, so maybe that's not just talk."),
  ("you_speak_of_unifying_calradia_id_be_impressed_if_i_thought_you_could_do_it_but_unfortunately_you_dont", "You speak of unifying these lands. I'd be impressed if I you could do it, but unfortunately, you can't."),
  ...
  ("you_speak_of_unifying_calradia_but_right_now_yours_is_just_one_squabbling_faction_among_many", "You speak of unifying these lands, but right now, yours is but one squabbling faction among many."),
  ...
  ("s18_once_questioned_my_judgment_in_battle_by_heaven_would_he_have_us_shirk_our_duty_to_smite_our_sovereigns_foes", "{s18} once questioned advice I offered, and accused me of 'plotting'. What gives him the right to make such accusations?"),
  ...
  ("s18_is_a_crafty_weasel_and_i_dont_trust_him_one_bit", "{s18} is a crafty weasel. I don't trust him one bit."),
  ...
  ("s18_is_soft_and_weak_and_not_fit_to_govern_a_fief_and_i_have_always_detested_him", "{s18} is soft, weak, and not fit to govern lands or lead men in battle. I have always detested him."),
  ...
  ("s18_i_am_sorry_to_say_is_far_too_softhearted_a_man_to_be_given_any_kind_of_responsibility_his_chivalry_will_allow_the_enemy_to_flee_to_fight_another_day_and_will_cost_the_lives_of_my_own_faithful_men", "{s18}, I am sorry to say, is far too softhearted and weak. He plays the military leader well enough, but is unwilling to truly get the job done."),
  ("s18_seems_to_have_something_against_me_for_some_reason_i_dont_like_to_talk_ill_of_people_but_i_think_hes_can_be_a_bit_of_a_cad_sometimes", "{s18} can be a bit of a schemer. He has his uses, but I don't have to like the man."),
  ...
  ("s18_disappoints_me_i_once_scolded_for_his_rashness_in_battle_and_he_took_offense_i_do_not_care_to_apologize_for_my_efforts_to_save_his_life_and_the_lives_of_his_men", "{s18} disappoints me. There is always some hidden motive or advantage behind his words."),
  ...
  ("s18_i_have_heard_has_been_encouraging_seditious_ideas_among_the_peasantry__a_foolish_move_which_endangers_us_all", "{s18}, I have heard, has been encouraging seditious ideas among the peasantry -- a foolish move that endangers us all."),
  ...
  ("faction_marshal_s15_involved_in_defeat", "{!}Faction marshal {s15} involved in defeat"),
  ("player_faction_marshal_involved_in_defeat", "{!}Player faction marshal involved in defeat"),
  ...
  ("s14_protests_the_appointment_of_s15_as_marshal", "{!}{s14} protests the appointment of {s15} as marshal"),
  ...
  ("s3_feast_concludes_at_s4", "{!}The {s3} concludes its feast at {s4}"),
  ...
  ("our_realm_needs_my_support_there_is_enemy_raiding_one_of_our_villages_which_is_not_to_far_from_here_i_am_going_there", "Our realm needs my support. There enemy is raiding one of our villages which is not too far from here. I am going there."),
  ...
  ("s20_decided_to_attack_s21", "{!}The {s20} has decided to attack the {s21}."),
  ...
  ("there_is_a_feast_which_i_wish_to_attend", "There is a feast that I wish to attend."),
  ...
  ("the_circumstances_which_led_to_this_decision_no_longer_apply_so_we_should_stop_and_reconsider_shortly", "The circumstances that led to this decision no longer apply, so we should stop and reconsider shortly."),
  ...
  ("my_lady_you_are_a_woman_of_no_known_family_of_no_possessions__in_short_a_nobody_do_you_think_that_you_are_fit_to_marry_into_may_family", "My lady, you are a woman of no known family, of no possessions -- in short, a nobody. Do you think that you are fit to marry into my family?"),
  ("my_lady__forgive_me__the_quality_of_our_bond_is_not_of_the_sort_which_the_poets_tell_us_is_necessary_to_sustain_a_happy_marriage", "My lady -- forgive me -- the quality of our bond is not of the sort that the poets tell us is necessary to sustain a happy marriage."),
  ...
  ("the_saga_of_helgered_and_kara_how_could_a_woman_don_armor_and_carry_a_sword_how_could_a_man_love_so_ungentle_a_creature", "The Saga of Beowulf? Bah!"),
  ...
  ("s9_of_jewellery_which_is_essential_to_demonstrate_x_the_amount_is_s8_", "{s9} Of fine jewellery, which is essential to demonstrate our status by giving as gifts, the amount is {s8}."),
  ("s9_of_fur_which_we_shall_x_the_amount_is_s8", "{s9} Of furs, which we shall require to guarantee comfort, the amount is {s8}."),
  ...
  ("noble", "noble"),
  ("common", "common"),
  ("may_find_that_you_are_able_to_take_your_place_among_calradias_great_lords_relatively_quickly", "may find that you are able to take your place among the great lords of these lands relatively quickly"),
  ...
  ("s1_kais_and_layali_tragic", "{s1}^Orpheus and Calliope (Tragic)"), #chief cambiado
  ...
  ("s1_a_hearts_desire_mystic", "{s1}^Voyage of Bran (Mystic)"),
  ...
  ("diplomatic_embassy_to_s9", "Diplomatic embassy to the {s9}"),
  ...
  ("sfai_reg4", "{!}SFAI: {reg4}"),
  ("s9s10_current_state_s11_hours_at_current_state_reg3_current_strategic_thinking_s14_marshal_s12_since_the_last_offensive_ended_reg4_hours_since_the_decisive_event_reg10_hours_since_the_last_rest_reg9_hours_since_the_last_feast_ended_reg5_hours_percent_disgruntled_lords_reg7_percent_restless_lords_reg8__", "{s9}{s10}^^Current strategy: {s11}^Hours at current strategy: {reg3}^^Marshal: {s12}^^Since the last offensive ended: {reg4} hours^Since the decisive event: {reg10} hours^Since the last 18+ hour rest: {reg9} hours^Since the last feast ended: {reg5} hours^^Percent disgruntled lords: {reg7}%^Percent restless lords: {reg8}%^^"),
  ...
  ("_this_castle_is_temporarily_under_royal_control", " This fort is temporarily under royal control."),
  ("_this_castle_does_not_seem_to_be_under_anyones_control", " This fort does not seem to be under anyone's control."),
  ...
  ("_you_see_the_banner_of_your_wifehusband_s7_over_the_castle_gate", " You see the banner of your {reg59?husband:wife}, {s7}, over the castle gate."),
  ("_the_banner_of_your_wifehusband_s7_flies_over_the_town_gates", " The banner of your {reg59?husband:wife}, {s7}, flies over the town gates."),
  ...
  ("_however_you_have_sufficiently_distinguished_yourself_to_be_invited_to_attend_the_ongoing_feast_in_the_lords_castle", ". However, you have sufficiently distinguished yourself to be invited to attend the ongoing feast in the lord's hall."),
  ("s8_you_are_also_invited_to_attend_the_ongoing_feast_in_the_castle", "{s8}. You are also invited to attend the ongoing feast in the hall."),
  ("__hardship_index_reg0_avg_towns_reg1_avg_villages_reg2__", "{!}^^Hardship index: {reg0}, avg towns: {reg1}, avg villages: {reg2}^^"),
  ("__s3_price_=_reg4_calradian_average_reg6_capital_reg11_s4_base_reg1modified_by_raw_material_reg2modified_by_prosperity_reg3_calradian_average_production_base_reg5_total_reg12_consumed_reg7used_as_raw_material_reg8modified_total_reg9_calradian_consumption_base_reg10_total_reg13s1_", "{!}^^{s3}^Price = {reg4} (Brittonic average {reg6})^Capital: {reg11} {s4}^Base {reg1}/modified by raw material {reg2}/modified by prosperity {reg3}^(Brittonic average production, base {reg5}, total {reg12}).^Consumed {reg7}/used as raw material {reg8}/modified total {reg9}^(Brittonic consumption, base: {reg10}, total: {reg13}){s1}^"),
  ...
  ("due_to_the_loss_of_s10_your_court_has_been_relocated_to_s11", "Due to the loss of {s10}, your court has been relocated to {s11}"),
  ...
  ("seek_vassalhood", "seek vassalage"),
  ...
  ("mug_of_kvass", "mug of ale"), #chief cambia
  ...
  ("you_must_prove_yourself_a_great_warrior_before_men_will_follow_you_as_king", "You must prove yourself to be a great warrior before men will follow you as king."),
  ...
  ("indeed_but_a_man_must_also_prove_himself_a_great_warrior_before_men_will_follow_you_as_king", "Indeed, but you must also prove yourself a great warrior before men will follow you as king."),
  ("my_pigherd_can_declare_himself_king_if_he_takes_he_fancy_i_think_you_need_to_break_a_few_more_heads_on_tbe_battlefield_before_men_will_follow_you", "My swineherd can declare himself king, if he takes he fancy. I think you need to break a few more heads on the battlefield before men will follow you."),
  ...
  ("i_think_youre_a_good_man_but_im_worried_that_you_might_be_pushed_in_the_wrong_direction_by_some_of_those_around_you", "I think you're a good {reg59?woman:man}, but I'm worried that you might be pushed in the wrong direction by some of those around you."),
  ("i_am_loathe_to_fight_alongside_you_so_long_as_you_take_under_your_wing_varlots_and_base_men", "I am loathe to fight alongside you, so long as you take under your wing varlets and base men."),
  ...
  ("you_know_that_i_have_always_had_a_problem_with_some_of_our_companions", "You know that I have always had a problem with some of your companions."),
  ...
  ("you_plan_to_marry_s4_as_you_have_no_family_in_calradia_he_will_organize_the_wedding_feast", "You plan to marry {s4}. As you have no family in these lands, he will organize the wedding feast.^^You will have to wait for a feast to start, and then meet your betrothed inside that town or fort hall. After 30 days, you can also ask your betrothed to go to a nearby center."),
  ...
  ("s9_asked_you_to_attack_a_village_or_some_caravans_as_to_provoke_a_war_with_s13", "{s9} asked you to attack a village or some caravans as to provoke a war with the {s13}."),
  ...
  ("_has_been_asking_around_for_someone_who_might_want_work_id_watch_yourself_with_him_though", " has been asking around for someone who might want work. I'd watch myself with him, though."),
  ("town", "town"),
  ("castle", "fort"),
  ...
  ("they_say_that_s9_loves_to_hunt_and_ride_maybe_she_wishes_she_were_a_man_whoever_she_marries_will_have_a_tough_job_keeping_the_upper_hand_i_would_say", "They say that {s9} loves to hunt and ride. Maybe she wishes she were a man! Whomever she marries will have a tough job keeping the upper hand, I would say."),
  ...
  ("you_will_not_be_disappointed_sirmadam_you_will_not_find_better_warriors_in_all_calradia", "You will not be disappointed, {reg59?madame:sir}. You will not find better warriors in all this land."),
  ...
  ("who_do_you_wish_to_give_it_to", "Whom do you wish to give it to?"),
  ("sire_my_lady_we_have_taken_s1_s2", "{reg59?My Lady:Sire}, we have taken {s1}. {s2}"),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("duplicate", "Whereabouts unknown."),
  ("amber_riverbeds", "beaches and riverbeds with amber"),
  ("hunting_forests", "hunting forests and meat smokehouses"),
  ("acres_flax", "acres of flax fields"),
  ("enterprise_enemy_realm", "{reg59?Madame:Sir}, you are an enemy of this realm. We cannot allow you to buy land here."),
  ...
  ("you_intend_to_bring_gift_for_s14", "You intend to bring jewelry and furs to {s12}. Then, speak to {s14}, to see if {s12} was able to arrange a reconciliation."),
  ...
  ("we_shall_strike_at_the_heart_of_our_foe_and_seize_the_fortress_of_s14", "We intend to strike the blow that will do them the greatest damage."),
  ("we_shall_take_the_fortress_of_s14_which_appears_easily_defensible", "We aim to take a fortress that will be easy for us to defend."),
...
#fin cambios chief
  ...
  ("default_kingdom_name", "Kingdom of {s0}"),
  ...
  ("lord_indicted_player_faction", "By order of {s6}, {s4} of the {s5} has been indicted for treason. The lord has been stripped of all {reg4?her:his} properties, and has fled for {reg4?her:his} life. He wishes to join your kingdom. You may find him in your court, if you wish it."), #chief cambiado

  ("lord_indicted_dialog_approach", "Greetings, {reg59?my lady:my lord}. You may have heard of my ill treatment at the hands of {s10}. You have a reputation as one who treats {reg59?her:his} vassals well, and if you will have me, I would be honored to pledge myself as your vassal."),
  ...
  ("lord_indicted_dialog_rejected",    "Indeed? Well, perhaps your reputation is misleading. Good day, {reg59?my lady:my lord} -- I go to see if another ruler in these lands is more appreciative of my talents."), #chief cambia caraldia por britannia
  ...
  ("bandit_lair_quest_description", "Find and destroy {s9} and report back to {s11}."),
  ("reveal_ass", "Someone attempted to murder you. You can try to find out who wanted you dead by meeting the killers' contact in {s3}."),
  ("reveal_ass2", "The contact has given away the lord who ordered the assassination - it is {s9}. It's time to confront the lord directly."),
  ...
  ("bandit_hideout_success", "With their retreat cut off, the {s4} fall one by one to your determined attack. Their hideout, and their ill-gotten gains, is now yours."),
  ...
  ("political_explanation_self", "In the absence of any other clear candidate, I nominate myself."),
  ...
  ("quick_battle_scene_2", "Welsh Village"),
  ("quick_battle_scene_3", "Tulbuk's Pass"),
  ("quick_battle_scene_4", "Tom Tun Burh"),
  ("quick_battle_scene_5", "Skagerrak"),	#phaiak
  ("quick_battle_scene_6", "The North Sea"),
  ("quick_battle_scene_7", "Kennemer Port"),	#phaiak
  ("quick_battle_scene_8", "Battle Scene 6"),
  ("quick_battle_scene_9", "Battle Scene 7"),
  ("quick_battle_scene_10", "Battle Scene 8"),
  ("quick_battle_scene_11", "Battle Scene 9"),

  ("quick_battle_troop_1", "Bodo, servitor to the kings of Asturias, is on a secret mission to the lands of the north."),
  ("quick_battle_troop_2", "Sven, hersir in the service of Sigurd Snake-in-the-Eye, rides in the prow of his master's ship. He has a well deserved reputation for ruthlessness and cruelty, running slaves and demanding protection money from Friese to Alba."),
  ("quick_battle_troop_3", "Cerball mac Dunlainge, head of one of the larger petty kingdoms in Ireland, has won independence from Munster through capable arms and even more capable playing of the various Goidelic (Irish) and Viking factions against one another. Now that he possesses riches and mercenaries from the Viking settlement at Waterford, will he become overlord of Ireland?"),
  ("quick_battle_troop_4", "Artorius, a champion of Rhodri Mawr, helps his master to attempt once again to unify the factious Britons of Wales. It is not a project of expansion but survival against their ancient enemies, the Angles and Saxons, and now the new threat of Vikings."),
  ("quick_battle_troop_5", "Cinead is named after the chieftain who unified Alba after the old rival dynasties of the Picts and Dal Riata were virtually destroyed by Vikings in a three-way battle in 839. He is one of the few who retain the ancient tradition of horsemanship in these parts, fast disappearing as the Vikings displace his people from the low-lying areas to the southwest."),
  ("quick_battle_troop_6", "Oswald is a thegn in the Saxon levy, commanding a large group of ceorls who rent his lands. While the glory goes to the kings, it is the solid officers like him that actually protect West Seaxe."),
  ("quick_battle_troop_7", "Hildr comes from a persistent tradition among Germanic peoples of women fighters, called skjaldmo, or shield maidens, by the Danes. Her comrades accept her none too grudgingly, as it is whispered she has harnessed the power of runes from wizards in far-off Finland."), #Moto maybe you want adapt this character for Solveig or change Solveig for this character?
  ...
  ("tutorial_training_ground_intro_message", "Walk around the training field and speak with the fighters to practice various aspects of combat. You can use ASDW keys to move around. To talk to a character, approach him until his name appears on your screen and then press the F key. You can also use the F key to pick up items, open doors and interact with objects. Press the Tab key to exit the tutorial any time you like."),
  ("tutorial_doccinga_ground_intro_message", "Doccinga is a small fishing village on the coast of Friese. People here are hard working and still very prosperous, although foreigners no longer come as they did before the death of the old sorcerer. \
When you go into the village, you see a lot of activity around you. Apart from the busy villagers, some warriors swarm among the people, exercising the arts of war, perhaps preparing for an adventure beyond the sea. \
Maybe you can ask the warriors for practice in the various aspects of combat... \
(Remember: ASDW keys to move around. To talk to a character, approach him until his name appears on your screen and then press the F key. You can also use the F key to pick up items, open doors and interact with objects. Press the Tab key to exit Doccinga.)"),
  ...
  ("player", "Player"),
  ("enemy", "Enemy"),
  ("faction", "Culture"), #custom battle pres
  ...
  ("center_is_looted_or_raided_already", "has already been laid waste."),
  ...
  ("center_value_justifies_the_difficulty_of_capture", "can be taken, and it is of sufficient value to justify an attack."),
  ...
  ("tutorial_training_ground_ammo_refill", "Your missiles are refilled for the training."),
  ...
  ("please_sir_my_lady_go_find_some_volunteers_i_do_not_know_how_much_time_we_have", "{reg59?My lady:Sir} -- if you want to justify the trust which I have placed in you, then make a bit of haste. Go find some volunteers. I'm not sure how much time we have."),
  ...
  ("do_not_waste_time_go_and_learn_where_my_brother_is", "Look, {reg59?my lady:sir}. Time is at a bit of premium, here. Now, if you could go find out where they are hiding my brother, that would be appreciated."),
  
  ("start_up_quest_message_1", "{s9} told me that I could find answers in {s1}. I need to ask the village elder there, Thonkrik."), #chief cambia intro VC
  ("start_up_quest_message_2", "Thonkrik told me that the jarl of Kennemer, a settlement near Doccinga, might know where Sven Bull Neck is."),
  ("start_up_quest_message_3", "Rescue the merchant's brother from the robber's hideout located near {s9}."),
  ("start_up_first_quest", "You have taken your first quest. You may view your quest log by pressing 'Q' anytime in the game.^^To leave this (and any other) scene, press the TAB key."),
  ...
  ("before_going_offensive_we_should_protect_our_lands_if_there_is_any_threat_so_this_can_be_reason_marshal_choosed_defending_s4", "Before taking the offensive, we should protect our lands against any threat. This can be the reason why the marshal chose to defend {s4}."),
  
  ("are_you_all_right", "Ah -- you're awake. It's good to see that you can still walk. You're lucky, foreigner! Some god has watched over you. When they brought you here, you were more dead than alive."), #chief cambia
  ("you_are_awake", "Ah -- you're awake. It's good to see that you can still walk. You're lucky, foreigner! Some god has watched over you. When they brought you here, you were more dead than alive."), #chief cambia para VC intro
  ...
  ("you_fought_well_at_town_fight", "Ah! You're awake. You took quite a blow, there, but good news! We defeated them, and you did them some real damage before you went down. If you hadn't been here, it could have gone very badly. I'm grateful to you..."), 
  ...
  ("unfortunately_reg0_civilians_wounded_during_fight_more", " Unfortunately, about {reg0} of my lads got themselves wounded. I should go look on them."),
...
#these are for resetting old {!} party names for the spawnpoints chief cambia
...
("the_coast", "the coast"),
  ...
  ("retrieve_garrison_warning", "^(Troops might not be retrievable if this fortress is awarded to someone else)"),

  ("s12s15_declared_war_to_control_calradia", "{s12}{s15} may attack {s16} without pretext, as a bid to extend control over all of these lands."),
  ...
  ("s21_the_s8_declared_war_as_part_of_a_bid_to_conquer_all_calradia", "{s21}. The {s8} declared war with very little pretext, as part of a bid to conquer all of these lands."),
  ("master_vinter", "Master vintner"),
  ...
  ("ale_site", "brewery"),
  ("tar_kiln", "tar kiln"),
  ("wine_cellar", "cellar with wine imported from Frankia"),
  ("tool_site", "ironworks"),
  ("leather_site", "tannery"),
  ("linen_site", "linen weavery"),
  ("wool_cloth_site", "wool weavery"),
  ("velvet_site", "dye works"),

  ("under_sequestration", "Under sequestration"),
  ("describe_secondary_input", " In addition, you will also need to purchase {s11} worth {reg10} peningas."),
  ("profit", "profit"),
  ("loss", "loss"),
  ...
  ("you_are_a_lord_lady_of_s8_s9", "{reg59?Lady:Lord} of the {s8}.^{s9}"),
  ("you_are_king_queen_of_s8_s9", "Kingdom: {s8}.^{s9}"),
  ("you_are_a_lord_lady_of_s18_s19", "{reg59?Lady:Lord} of the {s18}.^{s19}"), #chief
  ("you_are_king_queen_of_s18_s19", "Kingdom: {s18}.^{s19}"), #chief faction screen
  ("for_s4", " for {s4}"),
...
#chief sea battles
 ...
 ("numberofships", "{reg60}"),
  ...
  ("retreat_from_fortress", "You order your troops to disengage.^Everyone moves out of bow shot of the fortress walls, and the enemy destroys the siege ladders.^Your troops are upset by this; after all the effort it took to get into position and prepare the attack, they are unhappy about leaving the fortress in the enemy's hands."),
  ...
  ##retirada campo batalla chief acaba
# #somebody chief reclutar ciudades
  # ("recruit_town",   "Recruit a young nobleman ({s11}) ({reg1})"),
# #patrullas somebody chief
  # ("player_50",   "Captain's Party"),
  # ("custom_reinforce", "{reg0} {s1} have arrived for {s2}"),
  ###########grueso chief acaba##########
#Religion chief
  ("s7_scouts", "Pictish Scouts"),
  ("s7_foragers", "Foraging Party"),
  ("s7_northern_picts", "Northern Pictish Raiding Party"),

  ("raise_relation_with_village_tavern_built", "Villagers of {s1} are happy! The building of the mead hall increased their loyalty."),

    ("the_sun_rises", "The sun rises."),
  ("the_sun_sets", "The sun sets."),  
  ("it_is_noon", "It is noon."),  
  ("it_is_midnight", "It is midnight."),

  ("iniau_the_banished", "A man known to the name of Iniau has insulted king Rhoedd. He used to be a member of Rhoedd's teulu, and he is a skilled fighter. Rhoedd wants you to find out Iniau and slay him. As a proof, you must bring back his horn to Rhoedd. Iniau has taken refuge in the land of Llan Heledd."),

##    # names: forest_bandit_leader
##  ("bandit_name_10", "Aedelred Strong Bear"),
##  ("bandit_name_11", "Sigeberht"),
##  ("bandit_name_12", "Tiny Oswine"),
##  ("bandit_name_13", "Wulfric"),
##  ("bandit_name_14", "Godric"),
##  ("bandit_name_15", "Eadwine Man-Eater"),
##  ("bandit_name_16", "Cerdic Half Angle"),
##  ("bandit_name_17", "Aeldred"),
##  ("bandit_name_18", "Ecgberht"),
##  ("bandit_name_19", "Hrodgar the Black"),
##  
##  # names: taiga_bandit_leader
##  ("bandit_name_20", "Mildgyd Sheep Rustler"),
##  ("bandit_name_21", "Baidagnas"),
##  ("bandit_name_22", "Uargal Love Lass"),
##  ("bandit_name_23", "Turtoualdus"),
##  ("bandit_name_24", "Gennovevs"),
##  ("bandit_name_25", "Three-Legged Adiuni"),
##  ("bandit_name_26", "Bodognous the Goatherd"),
##  ("bandit_name_27", "Budnouen"),
##  ("bandit_name_28", "Cu Allaid"),
##  ("bandit_name_29", "Leofric"),
##  
##  # names: steppe_bandit_leader
##  ("bandit_name_30", "Biracas"),
##  ("bandit_name_31", "Pastor Colomagnas"),
##  ("bandit_name_32", "Covagnas"),
##  ("bandit_name_33", "Cunavalas"),
##  ("bandit_name_34", "One-Eye Qenilocas"),
##  ("bandit_name_35", "Sagragnas"),
##  ("bandit_name_36", "Totavalas the Fierce"),
##  ("bandit_name_37", "Oengus"),
##  ("bandit_name_38", "Amalgaid the Bloodthirsty"),
##  ("bandit_name_39", "Riaguil the Cautious"),
##  
##  # names: sea_raider_leader
##  ("bandit_name_40", "Lothar Franksbane"),
##  ("bandit_name_41", "Childebert"),
##  ("bandit_name_42", "Clovis"),
##  ("bandit_name_43", "Theuderic"),
##  ("bandit_name_44", "Merovech"),
##  ("bandit_name_45", "Dagobert"),
##  ("bandit_name_46", "Grimoald"),
##  ("bandit_name_47", "Walker Theudebald"),  #Nickname usually given to Vikings too fat to ride a horse! Ganger Hrolf, for example...
##  ("bandit_name_48", "Gunthar"),
##  ("bandit_name_49", "Charibert the Pale"),
##
##  # names: sea_raider_leader2
##  ("bandit_name_50", "Long-Armed Wiglaf"),
##  ("bandit_name_51", "Heardred"),
##  ("bandit_name_52", "Ecgtheow the Deepminded"),
##  ("bandit_name_53", "Unferth"),
##  ("bandit_name_54", "Breca"),
##  ("bandit_name_55", "Crazy Aeschere"),
##  ("bandit_name_56", "Asbjorn"),
##  ("bandit_name_57", "Bjorn Butt Ugly"),
##  ("bandit_name_58", "Hans"),
##  ("bandit_name_59", "Oxe the Dena Pirate"),
##
##  # names: mountain_bandit_leader
##  ("bandit_name_60", "Conbrit the Tall"),
##  ("bandit_name_61", "Felix"),
##  ("bandit_name_62", "Gallmau"),
##  ("bandit_name_63", "Heranal the Bandit"),
##  ("bandit_name_64", "Harenbil"),
##  ("bandit_name_65", "Iocilin"),
##  ("bandit_name_66", "Maonirn Wave Ruler"),
##  ("bandit_name_67", "Riocus"),
##  ("bandit_name_68", "Uenomail"),
##  ("bandit_name_69", "Uormuin"),
##
##  # names: desert_bandit_leader
##  ("bandit_name_70", "Breth the Lazy"),
##  ("bandit_name_71", "Cimoiod"),
##  ("bandit_name_72", "Denbecan the Pict"),
##  ("bandit_name_73", "Domelch"),
##  ("bandit_name_74", "Eddarrnonn"),
##  ("bandit_name_75", "Morleo Thief-Over-the-Wives"),
##  ("bandit_name_76", "Uvan"),
##  ("bandit_name_77", "Nectanos"),
##  ("bandit_name_78", "Nechtan"),
##  ("bandit_name_79", "Drest Still Pagan"),
########
  ### PHAIAK chief begin
  ("busse", "Busse"),
  ("skeid", "Skeid"),
...
#phaiak acaba chief
#moto chief diplomacy
  ("s12s15_dominates_its_weaker_neighbor_s16", "{s12}{s15} attempts to dominate {reg4?her:his} weaker neighbor {s16}."),	#MOTO for new diplomatic result
  ("s12s15_acts_to_drive_the_people_of_s16_and_their_like_out_of_the_Isles", "{s12}{s15} acts to drive the people of {s16} and their like out of the Isles!"),	#MOTO for new diplomatic result

#otros chief
  	("none", "None"),

	("camp_pillage"," Enemy in Camp! "),	
	("camp_pillage2"," The enemy is in the camp and has accessed your treasure chest. They are looting your money!^{s4} peningas was lost."),

  #chief capitan
  ("capitan_mode_started", "Reconnaissance Round: Explore the terrain and kill enemy champions. In the next round, your troops will come!"),  
  ("capitan_mode_started2", "Battle Round! Lead your troops to victory!"),  
  ("armamento_pesado", "Buy heavy armour. This will allow you to choose medium and heavy infantry from the inventory menu."),
  ("acceso_caballeria", "Buy horses. This will allow you to choose medium and heavy cavalry from the inventory menu."),
  ("buy_tropas", "My lord, choose your army:"),
  ("nopuedes_comprar", "You are not a lord or captain,^so you may not choose troops."),
  ("numero_hombres", "Number of warriors to hire:"),
  ("initial_gold_multiplierboth", "Basic silver both teams (%):"),
  ("initial_gold_multipliert1", "Team 1 Extra silver for troop wages (%):"),
  ("initial_gold_multipliert2", "Team 2 Extra silver for troop wages (%):"),
  # ("choose_a_captain", "Choose a troop class:^^\
# Captains and lords represent the leaders of armies. They have^\
# access to armies and quality weapons. Those who choose to be^\
# leaders should appoint a king to lead them in battle.^^\
# Elite warriors represent the most prestigious army troops.^\
# Choosing this allows you to be a standard bearer, musician,^\
# scout, messenger, adviser or bodyguard, among other things.^\
# ---------------------------------------------"),
  ("choose_a_captain", "Choose a troop class:"),
  ("lords_battle_explanation", "Press ESC to start game.^^In this game, you will be able to choose one of two types of troops:^^\
Lords represent the leaders of armies. They have access to armies as well as quality weapons. If you are a lord, then money that you don't spend on equipment will buy troops.^^\
Elite warriors represent the most prestigious army troops. Choosing this allows you to be a standard-bearer, musician, scout, messenger, adviser or bodyguard, among other things. \
If you are an elite troop, there is no need to worry about recruiting troops. Spend all your money equipping the best gear. \
Also, if the lords fall, the task of leading the troops will fall upon you."), #chief capitan
  ...
  ("s9_wants_you_to_meet_with_s11", "{s9} wants you to meet with {s11} in their camp north of {s3} and help him as much as you can. Meanwhile, {s9} will investigate the betrayal of Sven Bull Neck."),

  ##Invasion command strings
  ("inv_command_class_all", "Select All"),
  ("inv_command_class_0", "Infantry: {reg1}"),
  ("inv_command_class_1", "Archers: {reg1}"),
  ("inv_command_class_2", "Cavalry: {reg1}"),
  ("inv_command_class_deselect", "Deselect"),
  ("inv_command_order_charge", "Charge"),
  ("inv_command_order_move", "Move to..."),
  ("inv_command_order_use_any", "Use Any Weapon"),
  ("inv_command_order_use_melee", "Use Melee Weapons"),
  ("inv_command_order_use_ranged", "Use Ranged Weapons"),
  
  #alternate troop descriptions for MP
  ("norse_slave", "Leysingja Levy Auxillary"),
  ("norse_bowman", "Gestr Bowman"),
  ("norse_level0_landed", "Bondi Levy Back"),
  ("norse_level1_landed", "Drengr Levy 3rd Rank"),
  ("norse_level2_landed", "Thegn Levy 2nd Rank"),
  ("norse_level3_landed", "Hersi Levy 1st Rank"),
  ("norse_level0_companion", "Hirdmann Hird Back"),
  ("norse_level1_companion", "Rekkr Hird Mid"),
  ("norse_level2_companion", "Huskarl Hird Front"),
  ("norse_elitearcher", "Heimthegi Elite Archer"),
  ("briton_slave", "Aillt Auxillary"),
  ("briton_bowman", "Bweydd Bowman"),
  ("briton_marksman", "Saethydd Marksman"),
  ("briton_level0_landed", "Bonheddwr Levy Back"),
  ("briton_level1_landed", "Pedyt Levy 3rd Rank"),
  ("briton_level2_landed", "Gwrda Levy 2nd Rank"),
  ("briton_level3_landed", "Uchelwr Levy 1st Rank"),
  ("briton_level0_companion", "Cadwr Companion Back"),
  ("briton_level1_companion", "Campiwr Companion Mid"),
  ("briton_level2_companion", "Teulu Companion Front"),
  ("briton_horseman", "Marchoc Horseman"),
  ("saxon_slave", "Gebur Auxillary"),
  ("saxon_bowman", "Sceotand Bowman"),
  ("saxon_level0_landed", "Kotsetla Fyrd Back"),
  ("saxon_level1_landed", "Geoguth Fyrd 3rd Rank"),
  ("saxon_level2_landed", "Duguth Fyrd 2nd Rank"),
  ("saxon_level3_landed", "Thegn Fyrd 1st Rank"),
  ("saxon_level0_companion", "Geneata Companion Back"),
  ("saxon_level1_companion", "Gesith Companion Mid"),
  ("saxon_level2_companion", "Hearthweru Companion Front"),
  ("saxon_horseman", "Ridwiga Horseman"),
  ("scotch_peasant", "Petta Auxillary"),
  ("scotch_bowman", "Fuidir Skirmisher"),
  ("scotch_level0_skirmisher", "Saiogdear Skirmisher"),
  ("scotch_level1_skirmisher", "Cruithne Skirmisher"),
  ("scotch_level0_landed", "Bothach Levy Back"),
  ("scotch_level1_landed", "Octhingern Levy Mid"),
  ("scotch_level2_landed", "Diuberr Levy Mid"),
  ("scotch_level0_companion", "Creach Sluach Companion Back"),
  ("scotch_level1_companion", "Bruide Companion Back"),
  ("scotch_level2_companion", "Gaisgidh Companion Front"),
  ("scotch_horseman", "Each Raidh Horseman"),
  ("scotch_knight", "Toisech Knight"),
  ("angle_slave", "Gebur Auxillary"),
  ("angle_bowman", "Sceotand Bowman"),
  ("angle_level0_landed", "otsetla Fyrd Back"),
  ("angle_level1_landed", "Geoguth Fyrd 3rd Rank"),
  ("angle_level2_landed", "Duguth Fyrd 2nd Rank"),
  ("angle_level3_landed", "Thegn Fyrd 1st Rank"),
  ("angle_level0_companion", "Geneata Companion Back"),
  ("angle_level1_companion", "Gesith Companion Mid"),
  ("angle_level2_companion", "Hearthweru Companion Front"),
  ("angle_horseman", "Ridwiga Horseman"),
  ("irish_slave", "Senchleithe Auxillary"),
  ("irish_bowman", "Fer Midboth Skirmisher"),
  ("irish_level0_skirmisher", "Ceitherne Skirmisher"),
  ("irish_level1_skirmisher", "Fian Skirmisher"),
  ("irish_level0_landed", "Bothach Levy Back"),
  ("irish_level1_landed", "Ocaire Levy 3rd Rank"),
  ("irish_level2_landed", "Boaire Levy 2nd Rank"),
  ("irish_level3_landed", "Airig Levy 1st Rank"),
  ("irish_level0_companion", "Cliarthaire Companion"),
  ("irish_level1_companion", "Curraidh Companion"),
  ("irish_horseman", "Marcach Horseman"),
  ("irish_knight", "Deaisbard Knight"),
  
  #item standard mesh strings for item init, indexed as usual
  ("standard_dragon1", "{!}standard_dragon1"),
  ("standard_dragon2", "{!}standard_dragon2"),
  ("standard_dragon3", "{!}standard_dragon3"),
  ("standard_dragon4", "{!}standard_dragon4"),
  ("standard_dragon5", "{!}standard_dragon5"),
  ("standard_dragon6", "{!}standard_dragon6"),
  ("standard_dragon7", "{!}standard_dragon7"),
  ("standard_dragon8", "{!}standard_dragon8"),
  
  ("standard_extra01", "{!}standard_extra01"),
  ("standard_extra02", "{!}standard_extra02"),
  ("standard_extra03", "{!}standard_extra03"),
  ("standard_extra04", "{!}standard_extra04"),
  ("standard_extra05", "{!}standard_extra05"),
  ("standard_extra06", "{!}standard_extra06"),
  ("standard_extra07", "{!}standard_extra07"),
  ("standard_extra08", "{!}standard_extra08"),
  ("standard_extra09", "{!}standard_extra09"),
  ("standard_extra10", "{!}standard_extra10"),
  ("standard_extra11", "{!}standard_extra11"),
  ("standard_extra12", "{!}standard_extra12"),
  ("standard_extra13", "{!}standard_extra13"),
  ("standard_extra14", "{!}standard_extra14"),
  ("standard_extra15", "{!}standard_extra15"),
  ("standard_extra16", "{!}standard_extra16"),
  ("standard_extra17", "{!}standard_extra17"),
  ("standard_extra18", "{!}standard_extra18"),
  ("standard_extra19", "{!}standard_extra19"),
  ("standard_extra20", "{!}standard_extra20"),
  ("standard_extra21", "{!}standard_extra21"),
  ("standard_extra201", "{!}standard_extra201"),
  ("standard_extra202", "{!}standard_extra202"),
  ("standard_extra203", "{!}standard_extra203"),
  ("standard_extra204", "{!}standard_extra204"),
  ("standard_extra205", "{!}standard_extra205"),
  ("standard_extra206", "{!}standard_extra206"),
  # ("standard_extra207", "{!}standard_extra207"), reserved for default banner
  ("standard_extra208", "{!}standard_extra208"),
  ("standard_extra209", "{!}standard_extra209"),
  ("standard_extra210", "{!}standard_extra210"),
  ("standard_extra211", "{!}standard_extra211"),
  # ("standard_extra212", "{!}standard_extra212"),
  # ("standard_extra213", "{!}standard_extra213"),
  # ("standard_extra214", "{!}standard_extra214"),
  # ("standard_extra215", "{!}standard_extra215"),
  # ("standard_extra216", "{!}standard_extra216"),
  # ("standard_extra217", "{!}standard_extra217"),
  # ("standard_extra218", "{!}standard_extra218"),
  # ("standard_extra219", "{!}standard_extra219"),
  # ("standard_extra220", "{!}standard_extra220"),
  # ("standard_extra221", "{!}standard_extra221"),
  ("standard_anglosaxon01", "{!}standard_anglosaxon01"),
  ("standard_anglosaxon02", "{!}standard_anglosaxon02"),
  ("standard_anglosaxon03", "{!}standard_anglosaxon03"),
  ("standard_anglosaxon04", "{!}standard_anglosaxon04"),
  ("standard_anglosaxon05", "{!}standard_anglosaxon05"),
  ("standard_anglosaxon06", "{!}standard_anglosaxon06"),
  ("standard_anglosaxon07", "{!}standard_anglosaxon07"),
  ("standard_anglosaxon08", "{!}standard_anglosaxon08"),
  ("standard_anglosaxon09", "{!}standard_anglosaxon09"),
  ("standard_anglosaxon10", "{!}standard_anglosaxon10"),
  ("standard_anglosaxon11", "{!}standard_anglosaxon11"),
  ("standard_anglosaxon12", "{!}standard_anglosaxon12"),
  ("standard_anglosaxon13", "{!}standard_anglosaxon13"),
  ("standard_anglosaxon14", "{!}standard_anglosaxon14"),
  ("standard_anglosaxon15", "{!}standard_anglosaxon15"),
  ("standard_anglosaxon16", "{!}standard_anglosaxon16"),
  ("standard_anglosaxon17", "{!}standard_anglosaxon17"),
  ("standard_anglosaxon18", "{!}standard_anglosaxon18"),
  ("standard_anglosaxon19", "{!}standard_anglosaxon19"),
  ("standard_anglosaxon20", "{!}standard_anglosaxon20"),
  ("standard_anglosaxon21", "{!}standard_anglosaxon21"),
  ("standard_anglosaxon201", "{!}standard_anglosaxon201"),
  ("standard_anglosaxon202", "{!}standard_anglosaxon202"),
  ("standard_anglosaxon203", "{!}standard_anglosaxon203"),
  ("standard_anglosaxon204", "{!}standard_anglosaxon204"),
  # ("standard_anglosaxon205", "{!}standard_anglosaxon205"),
  # ("standard_anglosaxon206", "{!}standard_anglosaxon206"),
  # ("standard_anglosaxon207", "{!}standard_anglosaxon207"),
  # ("standard_anglosaxon208", "{!}standard_anglosaxon208"),
  # ("standard_anglosaxon209", "{!}standard_anglosaxon209"),
  # ("standard_anglosaxon210", "{!}standard_anglosaxon210"),
  # ("standard_anglosaxon211", "{!}standard_anglosaxon211"),
  # ("standard_anglosaxon212", "{!}standard_anglosaxon212"),
  # ("standard_anglosaxon213", "{!}standard_anglosaxon213"),
  # ("standard_anglosaxon214", "{!}standard_anglosaxon214"),
  # ("standard_anglosaxon215", "{!}standard_anglosaxon215"),
  # ("standard_anglosaxon216", "{!}standard_anglosaxon216"),
  # ("standard_anglosaxon217", "{!}standard_anglosaxon217"),
  # ("standard_anglosaxon218", "{!}standard_anglosaxon218"),
  # ("standard_anglosaxon219", "{!}standard_anglosaxon219"),
  # ("standard_anglosaxon220", "{!}standard_anglosaxon220"),
  # ("standard_anglosaxon221", "{!}standard_anglosaxon221"),
  ("standard_briton01", "{!}standard_briton01"),
  ("standard_briton02", "{!}standard_briton02"),
  ("standard_briton03", "{!}standard_briton03"),
  ("standard_briton04", "{!}standard_briton04"),
  ("standard_briton05", "{!}standard_briton05"),
  ("standard_briton06", "{!}standard_briton06"),
  ("standard_briton07", "{!}standard_briton07"),
  ("standard_briton08", "{!}standard_briton08"),
  ("standard_briton09", "{!}standard_briton09"),
  ("standard_briton10", "{!}standard_briton10"),
  ("standard_briton11", "{!}standard_briton11"),
  ("standard_briton12", "{!}standard_briton12"),
  ("standard_briton13", "{!}standard_briton13"),
  ("standard_briton14", "{!}standard_briton14"),
  ("standard_briton15", "{!}standard_briton15"),
  ("standard_briton16", "{!}standard_briton16"),
  ("standard_briton17", "{!}standard_briton17"),
  ("standard_briton18", "{!}standard_briton18"),
  ("standard_briton19", "{!}standard_briton19"),
  ("standard_briton20", "{!}standard_briton20"),
  ("standard_briton21", "{!}standard_briton21"),
  ("standard_briton201", "{!}standard_briton201"),
  ("standard_briton202", "{!}standard_briton202"),
  ("standard_briton203", "{!}standard_briton203"),
  ("standard_briton204", "{!}standard_briton204"),
  ("standard_briton205", "{!}standard_briton205"),
  ("standard_briton206", "{!}standard_briton206"),
  ("standard_briton207", "{!}standard_briton207"),
  ("standard_briton208", "{!}standard_briton208"),
  ("standard_briton209", "{!}standard_briton209"),
  ("standard_briton210", "{!}standard_briton210"),
  ("standard_briton211", "{!}standard_briton211"),
  ("standard_briton212", "{!}standard_briton212"),
  ("standard_briton213", "{!}standard_briton213"),
  ("standard_briton214", "{!}standard_briton214"),
  ("standard_briton215", "{!}standard_briton215"),
  ("standard_briton216", "{!}standard_briton216"),
  ("standard_briton217", "{!}standard_briton217"),
  ("standard_briton218", "{!}standard_briton218"),
  ("standard_briton219", "{!}standard_briton219"),
  ("standard_briton220", "{!}standard_briton220"),
  ("standard_briton221", "{!}standard_briton221"),
  ("standard_irish01", "{!}standard_irish01"),
  ("standard_irish02", "{!}standard_irish02"),
  ("standard_irish03", "{!}standard_irish03"),
  ("standard_irish04", "{!}standard_irish04"),
  ("standard_irish05", "{!}standard_irish05"),
  ("standard_irish06", "{!}standard_irish06"),
  ("standard_irish07", "{!}standard_irish07"),
  ("standard_irish08", "{!}standard_irish08"),
  ("standard_irish09", "{!}standard_irish09"),
  ("standard_irish10", "{!}standard_irish10"),
  ("standard_irish11", "{!}standard_irish11"),
  ("standard_irish12", "{!}standard_irish12"),
  ("standard_irish13", "{!}standard_irish13"),
  ("standard_irish14", "{!}standard_irish14"),
  ("standard_irish15", "{!}standard_irish15"),
  ("standard_irish16", "{!}standard_irish16"),
  ("standard_irish17", "{!}standard_irish17"),
  ("standard_irish18", "{!}standard_irish18"),
  ("standard_irish19", "{!}standard_irish19"),
  ("standard_irish20", "{!}standard_irish20"),
  ("standard_irish21", "{!}standard_irish21"),
  ("standard_irish201", "{!}standard_irish201"),
  ("standard_irish202", "{!}standard_irish202"),
  ("standard_irish203", "{!}standard_irish203"),
  ("standard_irish204", "{!}standard_irish204"),
  ("standard_irish205", "{!}standard_irish205"),
  ("standard_irish206", "{!}standard_irish206"),
  ("standard_irish207", "{!}standard_irish207"),
  ("standard_irish208", "{!}standard_irish208"),
  ("standard_irish209", "{!}standard_irish209"),
  ("standard_irish210", "{!}standard_irish210"),
  ("standard_irish211", "{!}standard_irish211"),
  ("standard_irish212", "{!}standard_irish212"),
  ("standard_irish213", "{!}standard_irish213"),
  # ("standard_irish214", "{!}standard_irish214"),
  # ("standard_irish215", "{!}standard_irish215"),
  # ("standard_irish216", "{!}standard_irish216"),
  # ("standard_irish217", "{!}standard_irish217"),
  # ("standard_irish218", "{!}standard_irish218"),
  # ("standard_irish219", "{!}standard_irish219"),
  # ("standard_irish220", "{!}standard_irish220"),
  # ("standard_irish221", "{!}standard_irish221"),
  ("standard_pict01", "{!}standard_pict01"),
  ("standard_pict02", "{!}standard_pict02"),
  ("standard_pict03", "{!}standard_pict03"),
  ("standard_pict04", "{!}standard_pict04"),
  ("standard_pict05", "{!}standard_pict05"),
  ("standard_pict06", "{!}standard_pict06"),
  ("standard_pict07", "{!}standard_pict07"),
  ("standard_pict08", "{!}standard_pict08"),
  # ("standard_pict09", "{!}standard_pict09"),
  # ("standard_pict10", "{!}standard_pict10"),
  # ("standard_pict11", "{!}standard_pict11"),
  # ("standard_pict12", "{!}standard_pict12"),
  # ("standard_pict13", "{!}standard_pict13"),
  # ("standard_pict14", "{!}standard_pict14"),
  # ("standard_pict15", "{!}standard_pict15"),
  # ("standard_pict16", "{!}standard_pict16"),
  # ("standard_pict17", "{!}standard_pict17"),
  # ("standard_pict18", "{!}standard_pict18"),
  # ("standard_pict19", "{!}standard_pict19"),
  # ("standard_pict20", "{!}standard_pict20"),
  # ("standard_pict21", "{!}standard_pict21"),
  ("standard_viking01", "{!}standard_viking01"),
  ("standard_viking02", "{!}standard_viking02"),
  ("standard_viking03", "{!}standard_viking03"),
  ("standard_viking04", "{!}standard_viking04"),
  ("standard_viking05", "{!}standard_viking05"),
  ("standard_viking06", "{!}standard_viking06"),
  ("standard_viking07", "{!}standard_viking07"),
  ("standard_viking08", "{!}standard_viking08"),
  ("standard_viking09", "{!}standard_viking09"),
  ("standard_viking10", "{!}standard_viking10"),
  ("standard_viking11", "{!}standard_viking11"),
  ("standard_viking12", "{!}standard_viking12"),
  ("standard_viking13", "{!}standard_viking13"),
  ("standard_viking14", "{!}standard_viking14"),
  ("standard_viking15", "{!}standard_viking15"),
  ("standard_viking16", "{!}standard_viking16"),
  ("standard_viking17", "{!}standard_viking17"),
  ("standard_viking18", "{!}standard_viking18"),
  ("standard_viking19", "{!}standard_viking19"),
  ("standard_viking20", "{!}standard_viking20"),
  ("standard_viking21", "{!}standard_viking21"),
  ("standard_viking201", "{!}standard_viking201"),
  ("standard_viking202", "{!}standard_viking202"),
  ("standard_viking203", "{!}standard_viking203"),
  ("standard_viking204", "{!}standard_viking204"),
  ("standard_viking205", "{!}standard_viking205"),
  ("standard_viking206", "{!}standard_viking206"),
  ("standard_viking207", "{!}standard_viking207"),
  ("standard_viking208", "{!}standard_viking208"),
  ("standard_viking209", "{!}standard_viking209"),
  ("standard_viking210", "{!}standard_viking210"),
  ("standard_viking211", "{!}standard_viking211"),
  ("standard_viking212", "{!}standard_viking212"),
  ("standard_viking213", "{!}standard_viking213"),
  ("standard_viking214", "{!}standard_viking214"),
  ("standard_viking215", "{!}standard_viking215"),
  ("standard_viking216", "{!}standard_viking216"),
  # ("standard_viking217", "{!}standard_viking217"),
  # ("standard_viking218", "{!}standard_viking218"),
  # ("standard_viking219", "{!}standard_viking219"),
  # ("standard_viking220", "{!}standard_viking220"),
  # ("standard_viking221", "{!}standard_viking221"),
  ("standard_kingdom_a", "{!}standard_kingdom_a"),
  ("standard_kingdom_b", "{!}standard_kingdom_b"),
  ("standard_kingdom_c", "{!}standard_kingdom_c"),
  ("standard_kingdom_d", "{!}standard_kingdom_d"),
  ("standard_kingdom_e", "{!}standard_kingdom_e"),
  ("standard_kingdom_f", "{!}standard_kingdom_f"),
  ("standard_kingdom_g", "{!}standard_kingdom_g"),
  ("standard_kingdom_h", "{!}standard_kingdom_h"),
  ("standard_kingdom_i", "{!}standard_kingdom_i"),
  ("standard_kingdom_j", "{!}standard_kingdom_j"),
  ("standard_kingdom_k", "{!}standard_kingdom_k"),
  ("standard_kingdom_l", "{!}standard_kingdom_l"),
  ("standard_kingdom_ll", "{!}standard_kingdom_ll"),
  ("standard_kingdom_m", "{!}standard_kingdom_m"),
  ("standard_kingdom_n", "{!}standard_kingdom_n"),
  ("standard_kingdom_o", "{!}standard_kingdom_o"),
  ("standard_kingdom_p", "{!}standard_kingdom_p"),
  ("standard_kingdom_q", "{!}standard_kingdom_q"),
  ("standard_kingdom_r", "{!}standard_kingdom_r"),
  ("standard_kingdom_s", "{!}standard_kingdom_s"),
  ("standard_kingdom_t", "{!}standard_kingdom_t"),
  # ("standard_kingdom_u", "{!}standard_kingdom_u"),
  # ("standard_kingdom_v", "{!}standard_kingdom_v"),
  # ("standard_kingdom_w", "{!}standard_kingdom_w"),
  # ("standard_kingdom_x", "{!}standard_kingdom_x"),
  # ("standard_kingdom_y", "{!}standard_kingdom_y"),
  # ("standard_kingdom_z", "{!}standard_kingdom_z"),
  ("standard_default", "{!}standard_extra207"),
  
##Addon map names
  ("multi_scene_coast", "Coast"),
  ("multi_scene_fjord", "Fjord"),
  ("multi_scene_islands", "Islands"),
  ("mp_addon_scene_end", "{!}end"),
##

## Presentations
  ("set_goal_start", "{!}start"),
  ("set_goal_custom", "my own"),
  ("set_goal_raider", "Infamous Raider"),
  ("set_goal_warrior", "Famous Warrior"),
  ("set_goal_lord", "Powerful Lord"),
  ("set_goal_king", "Strong King"),
  ("set_goal_expand", "Stable Kingdom"),
  ("set_goal_start_hint", "{!}start"),  
  ("set_goal_custom_hint", "You have chosen your own path."),

  ("set_goal_raider_hint", "Raid towns. Hunt down villagers. \
No one will be safe from you. \
Use fast ships to travel to distant lands \
and your refuge to have a safe home."),

  ("set_goal_warrior_hint","You wish to be known as a great warrior. \
Fight in tournaments. Protect villagers. \
Attack bandits and escort caravans. \
You will find plenty of work in towns \
and villages, but never forget that your \
glory is born on the fields of battle."),

  ("set_goal_lord_hint","The common life is not for you. \
You wish to become a nobleman, \
lead great armies and to be known \
as lord and master of your own \
lands."),

  ("set_goal_king_hint","There is no limit to your ambitions. \
Fight for glory, power and gold. \
You will make many enemies \
and must be ready to face threats \
from all four corners of the land!"),

  ("set_goal_expand_hint","A small fort on a hill is not enough \
for you. You desire to be known as the \
High King. Sharpen your sword and gather \
your troops, for war is coming!"), 

  ("view_goal_hint_renown", 
    "Renown: you desire fame above all. \
Win battles and competitions. Complete \
quests. As your renown grows, you will \
be able to command more troops, \
gain the respect of the nobility \
and hire better mercenaries!^"),

  ("view_goal_hint_reputation",
   "Reputation: be a hero or a villain. \
Your actions in the world will influence \
how people see you. It will influence your \
relation with other factions and even your \
chances of marriage.^"),

  ("view_goal_hint_army", 
"Army: you wish to balance your \
troops. Better troops are also more \
expensive to train and keep. Try to \
form a army with 25% heavies (high \
level units).^"),

  ("view_goal_hint_marry",
"Marriage brings the possibility \
of feasts, competitions and a \
extra helpful hand with kingdom management. \
It will also boost your right to rule!^"),

  ("view_goal_hint_right_to_rule",
"Right to rule is very important for \
kings. It will influence the way other \
factions will see you and your diplomatic \
relations.^"),

  ("view_goal_hint_wealth", "Wealth: war is expensive. Wages, food, training, new equipment, healers, wine...^be ready for it!^"),

  ("set_goal_trigger_new_game",
"A new world full of adventure awaits you!^^\
If this is your first time playing^Viking Conquest Sandbox^\
then check out the SET A GOAL presentation^to learn more about the game^\
and to see what you can do next!^^(Open Character Report,^Statistics, Choose a Goal)"),
  ("set_goal_already_completed", "(You already completed this goal!)"),
  ("set_goal_you_are_a_noble", "(You are a noble or mercenary, and^you can't abandon your oath!)"),
  ("set_goal_open_button_label", "Choose a Goal"),
  ("set_goal_open_button_label2", "View your Goal"),
  ("set_goal_complete_goal", "You have achieved your goal!^^No task was too big for you!^^^Rejoice in your accomplishment^and get ready for what comes next!"),
  ("set_goal_half_way_there", "You still have many tasks to complete your goal!"),
  ("set_goal_almost_there", "You are very close to completing your goal!"),
  ("set_goal_custom_reward", "Custom goal completed: no special rewards!"),
  ("set_goal_raider_reward", "Raider goal completed: mercenary troops have joined you!"),
  ("set_goal_warrior_reward", "Warrior goal completed: your skill with a blade has improved!"),
  ("set_goal_lord_reward", "Lord goal completed: \
friendly lords of your faction are impressed with you, \
a {reg0?gothi:priest} has joined your warband and \
you have won a cow that will let our men make some delicious butter!"),
  ("set_goal_king_reward", "King goal completed: mercenary troops have joined you and \
you have won a special book!"),
  ("set_goal_expand_reward", "Stable Kingdom goal completed: \
friendly kingdoms are impressed with you and \
you have won a rare sword!"),
## Companions presentation
  ("com_companions", "Companions:_"),
  ("com_view_companions", "View Companions"),
  ("com_s0", "{s0}"),
  ("com_debug_1", "Char picture for npc = {s0}, id = "),
  ("com_debug_2", "Click for troop: {s1}, id = "),
  ("com_heroes", "  Heroes  "),
  ("com_morale_reg0", "{s1}^^Morale: {reg0}"),
  ("com_relation_reg12", "{s1}^^Relation: {reg12}"),
  ("com_catholic", "{s1}^^Religion: Christianity"),
...
#item debug
  ("item_class_debug","{!}WARNING!!! Item {reg1} ({s1}) assigned to troop {reg0} ({s0}) has no class!"),
  
  ("welcome_to_beta", "{!}Welcome to the Viking Conquest Reforged Edition Open Beta.^^\
Please report any issue in the forums at the Taleworlds or Steam web sites.^^\
Performance may be affected by testing scripts during this beta.^^\
After quitting a campaign game, a special log will be added at the end of rgl_log.txt, \
which is located in the warband folder. If you want to help to balance this game, then please share the log as described in the log.^\
Thank you!"),
  ("log_created", "A log has been created. Please check the rgl_log.txt!"),
  ("debug_log_print1", "{!}^^\
#####################################################################################^\
## IF YOU WANT TO HELP BALANCING THIS GAME THEN PLEASE SHARE THE FOLLOWING LOG ON: ##^\
##            http://forums.taleworlds.com/index.php/topic,333383.0.html           ##^\
##                                   THANK YOU!                                    ##^\
#####################################################################################^^\
LOG:^\
Randomized ID, WB Version, VC Version, Start, Campaign, R, L, W, Track^\
({reg1},{reg2},{reg3},{reg4},{reg5},{reg6},{reg7},{reg8},"),
  ("debug_log_print2", "{s30}^End of LOG."),
  ("print_player_trade", "{reg1} goods for {reg2} and {reg3} other items for {reg4}"),
  ("debug_log_1_header", "{!}({s30}))^"),
  ("debug_log_3_header","{!}^---Player Troops---^Size | % light/medium | % heavies | T1 | T2 | T3 | T4 | T5 | Str{s31}"),  
  ("debug_log_4_header","{!} ^---Bandits---^center,numBanditsNearby;/Templates:ptid,numParties,created,destroyed^{s32}"),
##additional MULTI game type descriptions
  ("multi_game_type_desc_10", "^Peasants try to defend their home against raiders!^^Villagers have numerical advantage but raiders are much better equipped.^"),
##additional MULTI game type descriptions end
...
# vc options
  ...
  ("gore", "Gore:"),
  ("disable_scenic_menu", "Disable scenic menu:"),
  ...
  ("music_in_battles", "Replace music in battles:"),
  ...
  #tutorial
  ("game_concepts_tutorial", "^^I hope you are enjoying Viking Conquest Balance Mod.^^Balance Mod alters vanilla VC extensively, and with thousands of changes, the best advice I can give to players is this: roleplay. For example, if you are a Pagan player, recruit your hunting parties in Denmark or Norway, or do quests for the Christian locals to earn their trust. If you are Christian, visit monasteries and donate money to establish your good name, and to seek divine favor, not as a means of maxing a relations score. Roleplaying will guide you better than scouring 50 pages of my changelogs to find that I polarized religious difference, added extra bonuses for donations, or so forth, and the same applies to any of the hundreds of other altered mechanics.^^If you have questions, stop by the Hooded Horse Discord server and ask. Just Google 'Hooded Horse' and you'll find our website with a Discord link at the bottom."),

  #new options
  ("wounds", "Wounds:"),
  ("blood_loss", "Blood loss:"),
  ("quantity_bandit_parties", "Bandit Parties:"),
  
  ("game_difficulty_warning", "Balance Mod Difficulty Notes"),
  ("game_difficulty_warning_desc", "Campaign AI difficulty effects are heavily modded in Balance Mod. Click camp, then options, and position your cursor over difficulty settings to read what each does. Balance Mod Recommended Settings are also available as a difficulty type from the drop-down menu on the left.^^Note that you will gain attributes faster in Balance Mod (every 2 levels), but skillpoints start much lower (you get about 30 less at character creation)."),
  
  ("player_division", "Player division:"),
  
  
  ("poll_cooldown", "Delay between polls (seconds)"),
  ("polls_disabled_for_reg1", "Polls are disabled for {reg1} seconds."),
  ("poll_cooldown_is_now_reg1", "Delay between polls is now set to {reg1} seconds."),
  ("poll_change_gametype", "{s0} started a poll to change game type to {s1}."),
  ("poll_to_change_gametype", "Poll to change game type to {s1}: 1 = Accept, 2 = Decline"),
  ("make_gametype_voteable", "Allow polls to change game type"),
  
  ("changing_gametype_is_voteable", "Changing gametype is voteable."),
  ("changing_gametype_is_not_voteable", "Changing gametype is not voteable."),
