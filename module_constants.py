...
alliance_time       = 365 # days #Really Alliances were more long (even generations), in fact we use affinities in factions.py relations
#alliance expire to truce time
truce_time       = 120 # days #Truce. 1 month of peace. Generally peace was "buying" per a year until vikings back next year
...
slot_troop_original_faction2    = 15 # link to Native's six strings
...
minimum_ranged_ammo = 6	#below this not considered ranged type troop
...
reinforcement_cost_easy = 900
reinforcement_cost_moderate = 900
reinforcement_cost_hard = 900

merchant_toll_duration        = 72 #Tolls are valid for 72 hours

hero_escape_after_defeat_chance = TWEAK_ESCAPE_CHANCE_ENEMY_LORDS #Chief back high number, more easy to escape
...
##
##kingdom_troops_begin = "trp_norse_slave"
...
pagan_troops_begin = "trp_mercenary_horseman"
...
phase_out            = 3 * max_spawn_party_size / 4  #point at which generally only ONE party per spawn point (game spawns parties up to 30% over limit), turning this off
...
arena_tier1_opponents_to_beat = 10
arena_tier1_prize = 10
arena_tier2_opponents_to_beat = 20
arena_tier2_prize = 20
arena_tier3_opponents_to_beat = 30
arena_tier3_prize = 30
arena_tier4_opponents_to_beat = 39
arena_tier4_prize = 39
arena_grand_prize = 100
