...
################################################################################
   ...
   # https://forums.taleworlds.com/index.php/topic,324874.0.html
   #
...
mission_tpl_are_all_agents_spawned           = 1943  # (mission_tpl_are_all_agents_spawned), 
                                                     # agents >300 may keep spawning after ti_after_mission_start (still fires .1 second too early)
...
set_physics_delta_time       = 58 # (set_physics_delta_time, <fixed_value>), #Default is 0.025 (40 fps). Was deprecated on VC.
################################################################################
# [ Z26 ] HARDCODED COMPILER-RELATED CODE
################################################################################
...
get_startup_ground_ambient_light, agent_ai_get_num_cached_enemies, agent_ai_get_cached_enemy, agent_get_damage_modifier, agent_get_accuracy_modifier, agent_get_speed_modifier, agent_get_reload_speed_modifier,
...
item_has_property, item_has_capability, item_has_modifier, item_has_faction, cast_ray, mission_tpl_are_all_agents_spawned, ]
