...
info_pages = [
 ("armies_size", "Balance Mod 13", "For the latest patches to Balance Mod 13 (including 13.1 when it is ready), or for optional add-ons like Happy Companions or the Dark Age compatibility patch, stop by the Discord Server.^^\
Search for 'Hooded Horse' on google, and you will find our studio webpage with an invite link to the Discord server, or you can also find invite links at ModDB and Nexus.^^\
Patches are only released at the Discord, in order to keep the workload of updating Balance Mod manageable."),
...
("traits","Traits", "When you reach level 13, you are given a trait, and are also allowed to seek out a master to train in one of three advanced skills:^^\
Inspiring: This is the default skill, and will give a minor boost to the speed and damage of your men.^^\
Berserker: Going berserk will give you lasting improved speed and strength in the heat of the battle. This brutal ferocity will make your vision turn red. You will not suffer penalties when it wears off, it simply requires waiting to reactivate.^^\
Tough: This skill will make your troops move faster in battle.^^\
Strong: This skill will make your troops do greater damage in battle.^^\
Use key T to activate these traits on the battlefield."),
("recruitment", "Recruitment", "Recruitment in Viking Conquest is not automatic but depends on a number of factors, the most significant of which is religion.^^Firstly, in order to recruit in a village, fort or town, you need to obtain the permission of its lord. To do this, you'll need to have enough renown (150+) and be on good terms with the lord and his faction.^^\
...
Other options are available. You may be able to find some desperate refugees in monasteries. There is always a chance to find fellows looking for work at farmsteads."),
