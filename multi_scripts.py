...
multi_scripts = [
  ...
  ("berserk_trigger", [
      (try_begin),
        ...
        (else_try),
          ...
          (assign,"$berserk_cooldown",600),#once per 3 min
       ...
       #   (agent_set_accuracy_modifier,":agent",100),
        #  (agent_set_reload_speed_modifier,":agent",100),
          (agent_set_slot,":agent",slot_agent_berserk_cooldown,600),
  ...
  ("berserk_cooldown_trigger", [##SP only
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            (eq,":cooldown",420),#is tired
            (agent_set_damage_modifier,":agent",100),
            (call_script, "script_advanced_agent_set_speed_modifier",":agent",100),
            (display_message,"@You feel your strength return to normal.",0xff3333),
            (assign,"$is_berserk",-1),
      ...
      #      (agent_set_accuracy_modifier,":agent",100),
       #     (agent_set_reload_speed_modifier,":agent",100),
            (display_message,"@You are once again able to enter a battle rage.",0x88FF88),
            (assign,"$is_berserk",0),
            (mission_cam_animate_to_screen_color, 0x00000000, 2000),
          (try_end),
        (try_end),
  ...
  ("set_items_for_tournament_by_factions",[
      ...
      (try_begin),#                                        0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_1"),#  denmark    Horse  Shield       Spear 2HAxe 2HSword ShortAxe Sword Axe 				  Javelins chance  
        (call_script,"script_set_items_for_tournament_new",  0,    100,      0,    25,    0,    0,   75,   100, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_2"),#  norway       Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      25,    50,    0,    0,   75,   100, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_3"),#  Laithind      Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      50,    0,    0,    0,   100,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_4"),#  frisia       Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      34,    0,    0,    0,   67,   100, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_5"),#wessex        Horse  Shield      Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      100,    0,    0,    0,   0,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_6"),#east engle     Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    0,      0,    0,    0,    0,   100,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_7"),#mercia         Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      0,    0,    0,    0,   50,   100, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_8"),#northumbria    Horse  Shield     Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      20,    40,    0,    60,   80,   100, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_9"),#gwynedd        Horse  Shield     Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      50,    65,    0,    0,   85,   100, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_10"),#Brych       Horse  Shield      Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      0,    0,    0,    0,   100,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_11"),#alt clut     Horse  Shield      Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  100,    0,      100,    0,    0,    0,   0,   0, "itm_tourney_helm_red", 100),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_12"),#Cornubia      Horse  Shield      Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      0,    34,    0,    67,   0,   100, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_13"),# Glywyssing    Horse  Shield       Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  100,    100,      0,    0,    0,    0,   100,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_14"),#Uladh      Horse  Shield       Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    0,      0,    0,    100,    0,   0,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_15"),#Laigin        Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      0,    0,    100,    0,   0,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_16"),#Mumain        Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  100,    100,  100,    0,    0,    0,   0,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_17"),#Connachta       Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      50,    75,    100,    0,   0,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_18"),#Aileach     Horse  Shield        Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      0,    0,   0,    100,   0,   0, "itm_tourney_helm_red", 100),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_19"),#Meath         Horse  Shield      Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      0,    33,    100,    0,   0,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_20"),# Alban        Horse  Shield       Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  100,    100,      50,    0,    0,    0,   100,   0, "itm_tourney_helm_red", 0),
      (else_try),#                                         0-100%  0-100%    <-------------- 0-100% ----------->
        (eq,":faction","fac_kingdom_21"),#Osrige         Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      20,    40,    60,    0,   80,   100, "itm_tourney_helm_red", 0),
      (else_try),
        #                                               0-100%  0-100%    <-------------- 0-100% ----------->
        #                                               Horse  Shield    Spear 2HAxe 2HSword ShortAxe Sword Axe				  Javelins chance
        (call_script,"script_set_items_for_tournament_new",  0,    100,      50,    60,    0,    0,   80,   100, "itm_tourney_helm_red", 0),
  ...
  ("set_items_for_tournament_new",[
      ...
      (try_for_range, ":i_ep", 0, 32),
        ...
        (try_begin),
		  ...
		  (try_begin),
		    (lt,":r",49),
            (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep", "itm_common_horse2"),
          (else_try),
		    (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep", "itm_common_horse"),
          (try_end),
        (try_end),
        (store_random_in_range,":r",0,99),
        (try_begin),
          (lt,":r",":javelins_chance"),
          (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep","itm_javelin_skirmishes"),
        (try_end),
        
        (store_random_in_range,":r",1,100),
        (store_random_in_range,":r_shield",0,100),
        
        (try_begin),
          (le, ":r", ":club_chance"),
          (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep","itm_war_spear1"),
          (try_begin),#shield
        ...
        (else_try),
          (le, ":r", ":staff_chance"),
          (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep","itm_axe_3"),
          (try_begin),#shield
            (lt,":r_shield",":shield_chance"),
            (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep",":cur_shield_item"),
          (try_end),
        (else_try),
          (le, ":r", ":seax_chance"),
          (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep","itm_championsword1"),
          (try_begin),#shield
            (lt,":r_shield",":shield_chance"),
            (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep",":cur_shield_item"),
          (try_end),
        (else_try),
          (le, ":r", ":spear_chance"),
          (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep","itm_axe_7"),
          (try_begin),#shield
            (lt,":r_shield",":shield_chance"),
            (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep",":cur_shield_item"),
          (try_end),
        (else_try),
          (le, ":r", ":sword_chance"),
          (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep","itm_old_swordv"),
          (try_begin),#shield
            (lt,":r_shield",":shield_chance"),
            (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep",":cur_shield_item"),
          (try_end),
        (else_try),
          (le, ":r", ":axe_chance"),
          (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep","itm_axe_5"),
          (try_begin),#shield
            (lt,":r_shield",":shield_chance"),
            (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":i_ep",":cur_shield_item"),
          (try_end),
 ...
 #       (agent_set_damage_modifier,":agent",115),
  ...
  ("mp_assign_troop_equipment",[
      ...
      (item_set_slot, "itm_bodkin_arrows", slot_item_multiplayer_item_class, multi_item_class_type_bow),
      (item_set_slot, "itm_barbed_arrows", slot_item_multiplayer_item_class, multi_item_class_type_bow),
      #norse
      ...
      (call_script,"script_mp_assign_6_equipment","itm_longseax6","itm_sword_5","itm_spatha","itm_spatha_7","itm_noble_sword_2",0),#"itm_longseax7"#"itm_sword_6"
      ...
      (call_script,"script_mp_assign_6_equipment","itm_phrygian1","itm_phrygian2","itm_phrygian3","itm_vikingold_helm15","itm_viking_helm15","itm_viking_helm16"),
      #cavalry
      ...
      (call_script,"script_mp_assign_6_equipment","itm_seax_1","itm_longseax6",0,0,"itm_sword_5","itm_spatha"),#"itm_longseax7"#"itm_sword_6"
      (call_script,"script_mp_assign_6_equipment","itm_wooden_stick","itm_axe_3","itm_hand_axe","itm_one_handed_war_axe_a",0,0),#"itm_axe_4"
      #(call_script,"script_mp_assign_6_equipment","itm_carbatinae_14qs","itm_carbatinae_vc1v","itm_carbatinae_2s","itm_carbatinae_6v","itm_carbatinae_5",0),
      (call_script,"script_mp_assign_6_equipment","itm_carbatinae_6","itm_carbatinae_vc1",0,"itm_carbatinae_vc1v","itm_carbatinae_5","itm_carbatinae_14qs"),
      (call_script,"script_mp_assign_6_equipment","itm_leather_gloves",0,0,0,0,0),
      ...
      (call_script,"script_mp_assign_6_equipment","itm_wooden_stick","itm_one_handed_war_axe_b","itm_axe","itm_spatha_7","itm_noble_sword","itm_noble_sword_3"),
      ...
      (call_script,"script_mp_assign_6_equipment","itm_stones","itm_javelin_skirmishes","itm_throwing_spears","itm_long_bow","itm_arrows","itm_barbed_arrows"),
      (call_script,"script_mp_assign_6_equipment","itm_phrygian4","itm_phrygian5","itm_phrygian6",0,0,0),
      #cavalry
      (assign,"$temp","trp_mp_saxon_cavalry"),
      (call_script,"script_mp_assign_6_equipment","itm_horn_multi","itm_standard","itm_standard_dragon",0,0,0),
      (call_script,"script_mp_assign_6_equipment","itm_wooden_stick","itm_seax_2","itm_axe","itm_one_handed_war_axe_b","itm_spatha","itm_noble_sword"),
      (call_script,"script_mp_assign_6_equipment","itm_light_spear2","itm_war_spear2","itm_heavy_spear2","itm_long_light_spear2","itm_long_war_spear2","itm_long_heavy_spear2"),
      #(call_script,"script_mp_assign_6_equipment","itm_carbatinae_11qs","itm_carbatinae_12qs","itm_carbatinae_13qs","itm_carbatinae_14qs","itm_carbatinae_5",0),
      (call_script,"script_mp_assign_6_equipment","itm_carbatinae_4s",0,"itm_carbatinae_vc6","itm_carbatinae_vc2s","itm_carbatinae_5","itm_carbatinae_13qs"),
      (call_script,"script_mp_assign_6_equipment","itm_leather_gloves",0,0,0,0,0),
      ...
      (call_script,"script_mp_assign_6_equipment","itm_wooden_stick","itm_axe",0,0,0,"itm_quarter_staff"),
      ...
      (call_script,"script_mp_assign_6_equipment","itm_long_bow","itm_arrows","itm_barbed_arrows","itm_bodkin_arrows",0,0),
      (call_script,"script_mp_assign_6_equipment","itm_phrygian1","itm_phrygian2","itm_phrygian3","itm_briton_helm","itm_briton_helm19","itm_briton_helm22"),
      #cavalry
      ...
      (call_script,"script_mp_assign_6_equipment","itm_seax_1","itm_knife4","itm_irish_short_sword2","itm_irish_long_sword7","itm_irish_long_sword2",0),
      (call_script,"script_mp_assign_6_equipment","itm_wooden_stick","itm_pictish_hatchet8",0,"itm_pictish_hatchet15","itm_pictish_hatchet7","itm_pictish_hatchet10"),
      ...
      (call_script,"script_mp_assign_6_equipment","itm_phrygian8","itm_phrygian11","itm_phrygian15","itm_angle_helmet5","itm_angle_helmet3","itm_angle_helmet2"),
      #cavalry
      ...
      # (call_script,"script_mp_assign_6_equipment","itm_pictish_hatchet5","itm_pictish_hatchet8","itm_pictish_hatchet6","itm_pictish_hatchet9","itm_pictish_hatchet7","itm_pictish_hatchet10"),
      (call_script,"script_mp_assign_6_equipment","itm_seax_1","itm_knife4","itm_irish_short_sword2","itm_irish_long_sword7","itm_irish_long_sword2",0),
      (call_script,"script_mp_assign_6_equipment","itm_wooden_stick","itm_pictish_hatchet8",0,0,"itm_pictish_hatchet7","itm_pictish_hatchet10"),
      (call_script,"script_mp_assign_6_equipment","itm_quarter_staff","itm_long_light_spear1","itm_long_light_spear2",0,0,0),
      (call_script,"script_mp_assign_6_equipment","itm_just_man_boots_medium","itm_just_man_boots_light","itm_bare_foot_man","itm_just_man_boots_dark","itm_carbatinae_12q",0),
      (call_script,"script_mp_assign_6_equipment","itm_leather_gloves",0,0,0,0,0),
      (call_script,"script_mp_assign_6_equipment","itm_picts_hoodtunic_15","itm_picts_hoodtunic_16","itm_picts_hoodtunic_14","itm_picts_hoodtunic_17",0,0),#hood tunic
