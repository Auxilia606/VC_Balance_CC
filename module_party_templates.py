...
# Ryan BEGIN
  ("looters","Thieves",icon_warriors_3|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_looter_leader2,0,1),(trp_desert_bandit,0,2),(trp_mountain_bandit,0,8),(trp_bandit,1,40),(trp_looter,3,120)]), #chief cambiado
# Ryan END
...
#  ("black_khergit_raiders","Black Khergit Raiders",icon_khergit_horseman_b|carries_goods(2),0,fac_black_khergits,bandit_personality,[(trp_black_khergit_guard,1,10),(trp_elite_viking,5,5)]),
  ...
  ("steppe_bandits","Northmenn",icon_warriors_2|carries_goods(2),0,fac_mountain_bandits,raider_personality,[(trp_sea_raider_leader2,1,2),(trp_steppe_bandit,2,43),(trp_looter_leader,0,2),(trp_taiga_bandit,1,64)]),  #
  ("taiga_bandits","Swedish Vikingarnir",icon_warriors_2|carries_goods(2),0,fac_mountain_bandits,raider_personality,[(trp_sea_raider_leader2,1,3),(trp_elite_viking_2,1,24),(trp_taiga_bandit,1,84)]),
  ...
  ("sea_raiders2","Danish Vikingarnir",icon_warriors_8|carries_goods(2),0,fac_mountain_bandits,raider_personality,[(trp_sea_raider_leader2,1,2),(trp_elite_viking,1,20),(trp_taiga_bandit,1,38),(trp_sea_raider_leader,0,2)]),  #
  ("fianna","Renegade Fianna",icon_warriors_2|carries_goods(2),0,fac_outlaws,raider_personality,[(trp_looter_leader2,1,3),(trp_irish_level2_skirmisher,1,10),(trp_irish_level1_skirmisher,2,36),(trp_irish_level0_companion,1,48)]),
#2 new bandits for Frisia and Denmark
  ("frank_looters_1","Thieving Franks",icon_warriors_3|carries_goods(2),0,fac_outlaws,bandit_personality,[(trp_desert_bandit,0,9),(trp_mountain_bandit,2,150)]),
  ("frank_looters_2","Raiding Franks",icon_warriors_3|carries_goods(2),0,fac_outlaws,raider_personality,[(trp_mercenary_cavalry,0,28),(trp_caravan_guard,6,68),(trp_mercenary_swordsman,2,14)]),
  ...
  ("village_farmers","Village Farmers",icon_peasant|pf_civilian,0,fac_innocents,merchant_personality,[(trp_farmer,5,20),(trp_peasant_woman,3,16),(trp_watchman,5,11)]),
...
# Reinforcements
  ...
  # less-modernised templates are generally includes 7-14 troops in total, VC 20-30  Balance Mod 15
  # med-modernised templates are generally includes 5-10 troops in total, VC 10-20   Balance Mod 12
  # high-modernised templates are generally includes 3-5 troops in total VC 8-16     Balance Mod 9
  ...
  ("norse_reinforcements_a", "{!}norse_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_norse_level0_landed,5,5),(trp_norse_bowman,2,2),(trp_norse_level1_landed,4,4),(trp_norse_level0_companion,2,2),(trp_norse_elitearcher,2,2)]),#23
  ("norse_reinforcements_b", "{!}norse_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_norse_level1_landed,3,3),(trp_norse_level0_companion,3,3),(trp_norse_level2_landed,3,3),(trp_norse_level1_companion,2,2),(trp_norse_level3_landed,1,1)]),#20x2
  ("norse_reinforcements_c", "{!}norse_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_norse_level1_companion,3,3),(trp_norse_level2_companion,5,5),(trp_sea_raider_leader,1,1),(trp_norse_standard_bearer,1,1),(trp_todos_cuerno,1,1),(trp_norse_priest,1,1)]),#16x4

  ("saxon_reinforcements_a", "{!}saxon_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_saxon_level0_landed,10,10),(trp_saxon_bowman,1,1),(trp_saxon_level1_landed,4,4)]),
  ("saxon_reinforcements_b", "{!}saxon_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_saxon_level1_landed,4,4),(trp_saxon_level2_landed,5,5),(trp_saxon_level3_landed,1,1),(trp_saxon_level0_companion,2,2)]),
  ("saxon_reinforcements_c", "{!}saxon_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_saxon_level1_companion,3,3),(trp_saxon_level2_companion,2,2),(trp_saxon_standard_bearer,1,1),(trp_saxon_horseman,1,1),(trp_todos_cuerno,1,1),(trp_saxon_priest,1,1)]),
  
  ("angle_reinforcements_a", "{!}angle_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_angle_level0_landed,10,10),(trp_angle_bowman,1,1),(trp_angle_slave,2,2),(trp_angle_level1_landed,2,2)]),
  ("angle_reinforcements_b", "{!}angle_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_angle_level1_landed,5,5),(trp_angle_level2_landed,3,3),(trp_angle_level3_landed,1,1),(trp_angle_level0_companion,3,3)]),
  ("angle_reinforcements_c", "{!}angle_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_angle_level1_companion,3,3),(trp_angle_level2_companion,2,2),(trp_angle_standard_bearer,1,1),(trp_angle_horseman,1,1),(trp_todos_cuerno,1,1),(trp_angle_priest,1,1)]),
  
  ("welsh_reinforcements_a", "{!}welsh_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_briton_level0_landed,10,10),(trp_briton_slave,2,2),(trp_briton_bowman,3,3)]),
  ("welsh_reinforcements_b", "{!}welsh_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_briton_level1_landed,3,3),(trp_briton_level2_landed,2,2),(trp_briton_level3_landed,1,1),(trp_briton_level0_companion,3,3),(trp_briton_marksman,3,3)]),
  ("welsh_reinforcements_c", "{!}welsh_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_briton_level1_companion,4,4),(trp_briton_level2_companion,1,1),(trp_briton_standard_bearer,1,1),(trp_briton_horseman,5,5),(trp_todos_cuerno,1,1),(trp_briton_priest,1,1)]),

  ("scotch_reinforcements_a", "{!}scotch_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_scotch_level0_landed,7,7),(trp_scotch_peasant,2,2),(trp_scotch_bowman,4,4),(trp_scotch_level0_skirmisher,2,2)]),
  ("scotch_reinforcements_b", "{!}scotch_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_scotch_level1_companion,2,2),(trp_scotch_level2_companion,1,1),(trp_scotch_level1_landed,2,2),(trp_scotch_level2_landed,1,1),(trp_scotch_level0_companion,4,4),(trp_scotch_level1_skirmisher,2,2)]),
  ("scotch_reinforcements_c", "{!}scotch_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_scotch_knight,2,2),(trp_scotch_horseman,4,4),(trp_scotch_standard_bearer,1,1),(trp_scotch_musician,1,1),(trp_scotch_priest,1,1)]),

  ("irish_reinforcements_a", "{!}irish_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_irish_level0_landed,8,8),(trp_irish_slave,2,2),(trp_irish_bowman,3,3),(trp_irish_level0_skirmisher,2,2)]),
  ("irish_reinforcements_b", "{!}irish_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_irish_level1_landed,1,1),(trp_irish_level2_landed,1,1),(trp_irish_level0_companion,4,4),(trp_irish_level1_companion,1,1),(trp_irish_horseman,4,4),(trp_irish_level1_skirmisher,1,1)]),
  ("irish_reinforcements_c", "{!}irish_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_irish_level3_landed,3,3),(trp_irish_knight,3,3),(trp_irish_standard_bearer,1,1),(trp_todos_cuerno,1,1),(trp_irish_priest,1,1)]),

  #special treatment Frisa
  ("kingdom_4_reinforcements_a", "{!}kingdom_4_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_norse_level0_landed,4,4),(trp_frisian_mid,9,9),(trp_norse_bowman,1,1),(trp_frisian_basic,2,2),(trp_norse_elitearcher,1,1)]), #17
  ("kingdom_4_reinforcements_b", "{!}kingdom_4_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_norse_level1_landed,4,4),(trp_norse_level0_companion,2,2),(trp_norse_level2_landed,3,3),(trp_norse_level1_companion,2,2),(trp_norse_level3_landed,1,1)]),#20x2
  ("kingdom_4_reinforcements_c", "{!}kingdom_4_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_norse_level2_landed,5,5),(trp_todos_cuerno,1,1),(trp_norse_level2_companion,4,4),(trp_norse_standard_bearer,1,1),(trp_frisian_cav,4,4),(trp_norse_priest,1,1)]),#15x4
  #special treatment Northanhymbre
  ("kingdom_8_reinforcements_a", "{!}kingdom_8_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_norse_level0_landed,1,1),(trp_angle_level0_landed,8,8),(trp_angle_level1_landed,2,2),(trp_angle_level0_companion,1,1),(trp_angle_bowman,1,1),(trp_norse_elitearcher,2,2)]), #20
  ("kingdom_8_reinforcements_b", "{!}kingdom_8_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_angle_level2_landed,1,1),(trp_norse_level1_landed,2,2),(trp_norse_level0_companion,4,4),(trp_norse_level2_landed,2,2),(trp_norse_level1_companion,2,2),(trp_norse_level3_landed,1,1)]),#24x2 (then minus two tier 4)
  ("kingdom_8_reinforcements_c", "{!}kingdom_8_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_norse_level2_companion,3,3),(trp_norse_standard_bearer,1,1),(trp_todos_cuerno,1,1),(trp_norse_axe,5,5),(trp_angle_level1_companion,2,2),(trp_norse_priest,1,1)]),#14x4
  #special treatment Osrige
  ("kingdom_21_reinforcements_a", "{!}kingdom_21_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_irish_level0_landed,12,12),(trp_irish_bowman,2,2),(trp_irish_level0_skirmisher,1,1)]),
  ("kingdom_21_reinforcements_b", "{!}kingdom_21_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_irish_level1_landed,3,3),(trp_irish_level2_landed,1,1),(trp_irish_level3_landed,1,1),(trp_irish_level0_companion,5,5),(trp_irish_level05_companion,4,4),(trp_irish_level1_skirmisher,2,2)]),
  ("kingdom_21_reinforcements_c", "{!}kingdom_21_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_todos_cuerno,1,1),(trp_steppe_bandit,7,7),(trp_elite_viking,5,5),(trp_taiga_bandit,11,11),(trp_irish_standard_bearer,1,1),(trp_irish_priest,1,1)]), #Cerball often hired Viking mercenaries from Waterford
...
#chief sacerdotes party religion
  ...
  ("sea_raiders_ships" ,"Frankish Raiders",			icon_ship|pf_is_ship|carries_goods(2),0,fac_outlaws,raider_personality,[(trp_sea_raider_leader2, 1, 4), (trp_sea_raider, 14, 59), (trp_regular_sailors, 10, 39), (trp_mercenary_arqueros, 4, 20)]),
  ("sea_raiders_ships2","Danish Vikingr",	icon_ship|pf_is_ship|carries_goods(2),0,fac_mountain_bandits,raider_personality,[(trp_elite_viking, 7, 20),(trp_taiga_bandit, 24, 69),(trp_sea_raider_leader,0,2)]),  #one berserk easily worth 30 men right now
  ("sea_raiders_ships3","Vikingr",			icon_ship|pf_is_ship|carries_goods(2),0,fac_mountain_bandits,raider_personality,[(trp_sea_raider_leader,0,2), (trp_taiga_bandit, 28, 88)]),  #one berserk easily worth 30 men right now
  ("sea_raiders_ships4","Norwegian Vikingr",icon_ship|pf_is_ship|carries_goods(2),0,fac_mountain_bandits,raider_personality,[(trp_steppe_bandit, 14, 44), (trp_sea_raider_leader,0,2),(trp_taiga_bandit, 14, 44)]),  #one berserk easily worth 30 men right now
  ("sea_raiders_ships5","Swedish Vikingr",	icon_ship|pf_is_ship|carries_goods(2),0,fac_mountain_bandits,raider_personality,[(trp_sea_raider_leader2, 1, 4),(trp_elite_viking_2, 9, 29),(trp_taiga_bandit, 18, 58)]),
  ...
  ("viking_raider","Viking Raider",icon_ship|carries_goods(3)|pf_is_ship,0,fac_mountain_bandits,raider_personality,[(trp_elite_viking,25,90)]),	#deprecated
  # Phaiak end
#otras chief
